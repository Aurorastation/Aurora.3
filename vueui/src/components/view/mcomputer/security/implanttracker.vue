  ...
  <div>
    ...
    <table class="table border">
      ...
      <tr v-for="chem in chem_implants" class="item border" :key="chem.ref">
        ...
        <td>
          <vui-button :params="{ inject1: chem.ref }">Inject 1u</vui-button>
          <vui-button :params="{ inject5: chem.ref }">Inject 5u</vui-button>
          <vui-button :params="{ inject5: chem.ref }">Inject 10u</vui-button>
        </td>
      </tr>
    </table>
