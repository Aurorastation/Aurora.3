<template>
  <div>
    <i
      >Welcome to the NanoTrasen™ computer configuration utility. Please consult your system administrator if you have
      any questions about your device.</i
    >
    <hr />
    <h2>Power Supply</h2>
    ...
    <vui-item label="Registered ID:">
      <vui-button :params="{ PC_register: 1 }" :disabled="!card_slot">{{
