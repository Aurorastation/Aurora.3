    ...
    <vui-group>
      ...
      <vui-group-item label="Release Pressure:">
        ...
        <div style="clear: both; padding-top: 4px;">
          <vui-input-numeric width="5em" v-model="releasePressure" :button-count="4" :min="minReleasePressure" :max="maxReleasePressure" @input="$atc({pressure_set : releasePressure})">{{releasePressure}} kPa&nbsp;</vui-input-numeric>
        </div>
      </vui-group-item>
