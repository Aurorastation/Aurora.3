  ...
  <div>
    ...
    <div v-if="is_towing">
      ...
      <div v-if="has_proper_trolley">
        ...
        <div>
          Vacuum Capacity Remaining: <vui-progress :value="vacuum_capacity" :max="max_vacuum_capacity" :min="0">{{ vacuum_capacity }}</vui-progress> <vui-button :disabled="vacuum_capacity >= max_vacuum_capacity" :params="{ empty_hoover: 1}">Empty</vui-button>
        </div>
        <div v-if="is_mopping">
        ...
        <div v-if="has_bucket">
          ...
          <div>
            Container Reagents Remaining: <vui-progress :value="bucket_capacity" :max="max_bucket_capacity" :min="0">{{ bucket_capacity }}u</vui-progress>
          </div>
        </div>
        <div v-else>
