<template>
  <div>
    <vui-button v-if="minButton" :disabled="val<=min" @click="UpdateValue(min+1)">Min</vui-button>
    ...
    <vui-button v-if="maxButton" :disabled="val>=max" @click="UpdateValue(max)">Max</vui-button>
  </div>
</template>
