...
import { Button, Section, Box, NoticeBox, LabeledList } from '../components';
...
export const ShuttleControlConsoleMultiExploreAutopilot = (props, context) => {
  const { act, data } =
    ...
    <Window resizable>
      <Window.Content scrollable>
        ...
        <Section title="This shuttle is controlled by autopilot.">
          <NoticeBox warning>
            Please select a destination from the list and press &#34;Launch
            Shuttle&#34;. Ensure all personnel aboard are properly seated before
            launching.
          </NoticeBox>
        </Section>
