...
export type GravityGeneratorData = {
  breaker: BooleanLike;
  charge_count: number;
  charging_state: BooleanLike;
  on: BooleanLike;
...
export const GravityGenerator = (props) => {
  ...
  return (
    <Window width={400} height={155}>
      <Window.Content>
        {!data.operational && <NoticeBox>No data available</NoticeBox>}
        {!!data.operational && <GravityGeneratorContent />}
      </Window.Content>
    </Window>
  );
};
