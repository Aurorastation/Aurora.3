...
export declare type WithOptionalExecutionContext<R> =
  | R
  | WithExecutionContext<R>;
export declare type DependsOn = WithOptionalExecutionContext<
  (Target | BooleanLike)[]
>;
...
export declare type FileIo = WithOptionalExecutionContext<
  (string | BooleanLike)[]
>;
...
export declare const chalk: _chalk.Chalk &
  _chalk.ChalkFunction & {
