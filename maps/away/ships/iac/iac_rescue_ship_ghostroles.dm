...
/datum/ghostspawner/teshari/iac_volunteer
...
/datum/outfit/admin/iac_volunteer/post_equip(mob/living/carbon/teshari/H, visualsOnly = FALSE)
	. = ..()
	if(isvaurca(H))
...
/datum/ghostspawner/teshari/iac_volunteer/technician
...
/datum/ghostspawner/teshari/iac_volunteer/coordinator
