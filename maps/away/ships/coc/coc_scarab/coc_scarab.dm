/datum/map_template/ruin/away_site/coc_scarab
	...
	sectors = list(SECTOR_COALITION, SECTOR_WEEPING_STARS, SECTOR_ARUSHA, SECTOR_LIBERTYS_CRADLE, SECTOR_VALLEY_HALE, SECTOR_BADLANDS, ALL_CRESCENT_EXPANSE_SECTORS)
	spawn_weight = 1
	ship_cost = 1
	id = "coc_scarab"
