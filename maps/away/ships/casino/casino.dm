/datum/map_template/ruin/away_site/casino
	...
	sectors = list(SECTOR_ROMANOVICH, SECTOR_TAU_CETI, SECTOR_CORP_ZONE, SECTOR_VALLEY_HALE, SECTOR_BADLANDS, SECTOR_NEW_ANKARA, SECTOR_AEMAQ, SECTOR_SRANDMARR, SECTOR_NRRAHRAHUL, SECTOR_GAKAL, SECTOR_UUEOAESA, SECTOR_WEEPING_STARS)
	spawn_weight = 1
	spawn_cost = 1
	id = "awaysite_casino"
