/datum/map_template/ruin/away_site/ox_freighter
	...
	id = "ox_freighter"
	description = "The XYZ-class freighter is a standardized container carrier ship, with the carrying capacity of eight medium size containers."
...
/obj/effect/overmap/visitable/ship/ox_freighter
	name = "Orion Express Freighter"
	class = "OEV"
	desc = "The XYZ-class freighter is a standardized container carrier ship, with the carrying capacity of eight medium size containers."
	icon_state = "ship"
