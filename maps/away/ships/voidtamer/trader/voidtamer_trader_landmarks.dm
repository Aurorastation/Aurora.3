...
/obj/effect/shuttle_landmark/voidtamer_trader/hangar
	...
	docking_controller = "voidtamer_shuttle_dock"
	base_area = /area/voidtamer/trader/dock
	base_turf = /turf/simulated/floor/plating
	movable_flags = MOVABLE_FLAG_EFFECTMOVE
	landmark_tag = "nav_voidtamer_shuttle_dock"

/obj/effect/map_effect/marker/airlock/docking/voidtamer_trader/shuttle_hangar
	name = "Voidtamer Trader Hangar"
	landmark_tag = "dock_voidtamer_shuttle_dock"
	master_tag = "voidtamer_shuttle_dock"
