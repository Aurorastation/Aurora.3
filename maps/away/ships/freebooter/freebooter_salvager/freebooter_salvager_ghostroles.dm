/datum/ghostspawner/human/freebooter_altered_crew
	short_name = "freebooter_altered_crew"
	name = "Freebooter Salvager Crewman"
	...
	spawnpoints = list("freebooter_altered_crew")
	max_count = 4
...
/obj/outfit/admin/freebooter_altered_crew/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE) // make this a subtype
	. = ..()
	if(isvaurca(H))
...
/obj/outfit/admin/freebooter_altered_crew/get_id_access() // make this a subtype
	return list(ACCESS_EXTERNAL_AIRLOCKS)

/datum/ghostspawner/human/freebooter_altered_crew/captain
	short_name = "freebooter_altered_crew_captain"
	name = "Freebooter Salvager Captain"
	desc = "Captain the freebooter ship. You like to think of yourself as an adventurer and a businessman. Others, though, would call you a pirate, a bandit, a smuggler, a thug, a thief and a knave. It doesn't matter to you what they say: you're here to make money, by any means necessary. Just don't let the law catch up to you."

	spawnpoints = list("freebooter_altered_crew_captain")
	max_count = 1
