...
/obj/effect/overmap/visitable/sector/first_aurora
	name = "space station derelict"
	desc = "A massive abandoned space structure. Debris are strewn about the area, making approach difficult and outright dangerous for anything larger than a shuttle. Some elements of its architecture matches archived NanoTrasen blueprints."
