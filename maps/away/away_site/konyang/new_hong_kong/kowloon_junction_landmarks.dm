/obj/effect/shuttle_landmark/kowloon_junction
	landmark_flags = SLANDMARK_FLAG_AUTOSET

/obj/effect/shuttle_landmark/kowloon_junction/spaceport_intrepid
	name = "Kowloon Junction, Spaceport Landing Pad A (Intrepid)"
	landmark_tag = "nav_point_kowloon_junction_intrepid"

/obj/effect/shuttle_landmark/kowloon_junction/spaceport_spark
	name = "Kowloon Junction, Spaceport Landing Pad B (Spark)"
	landmark_tag = "nav_point_kowloon_junction_spark"

/obj/effect/shuttle_landmark/kowloon_junction/spaceport_canary
