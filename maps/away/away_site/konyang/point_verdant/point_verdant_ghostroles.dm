...
/obj/outfit/admin/konyang/zh/get_id_access()
	return list(/datum/access/portofcall_corporate::id)
...
/obj/outfit/admin/konyang/army_response/get_id_access()
	return list(/datum/access/distress::id, /datum/access/portofcall_police::id, /datum/access/portofcall_corporate::id, /datum/access/portofcall_police::id, /datum/access/external_airlocks::id)
...
/obj/outfit/admin/corporate_solutions/get_id_access()
	return list(/datum/access/cent_specops::id, /datum/access/portofcall_corporate::id, /datum/access/external_airlocks::id)
