/datum/map_template/ruin/away_site/crystal_planet_outpost
	...
	sectors_blacklist = list(SECTOR_BURZSIA, SECTOR_HANEUNIM, SECTOR_SRANDMARR, SECTOR_TAU_CETI, SECTOR_UUEOAESA) //it's a whole planet, shouldn't have it in predefined sectors
