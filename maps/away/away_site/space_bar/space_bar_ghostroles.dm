/datum/ghostspawner/teshari/space_bar_bartender
...
/datum/outfit/admin/space_bar_bartender/post_equip(mob/living/carbon/teshari/H, visualsOnly = FALSE)
	. = ..()
	if(isvaurca(H))
...
/datum/ghostspawner/teshari/space_bar_chef
...
/datum/outfit/admin/space_bar_chef/post_equip(mob/living/carbon/teshari/H, visualsOnly = FALSE)
	. = ..()
	if(isvaurca(H))
		H.equip_to_slot_or_del(new /obj/item/clothing/mask/breath/vaurca/filter(H), slot_wear_mask)
		var/obj/item/organ/internal/vaurca/preserve/preserve = H.internal_organs_by_name[BP_PHORON_RESERVE]
...
/datum/ghostspawner/teshari/space_bar_patron
...
/datum/outfit/admin/random/space_bar_patron/post_equip(mob/living/carbon/teshari/H, visualsOnly = FALSE)
...
/datum/outfit/admin/random/space_bar_patron/vaurca/post_equip(mob/living/carbon/teshari/H, visualsOnly = FALSE)
	. = ..()
	var/obj/item/organ/internal/vaurca/preserve/preserve = H.internal_organs_by_name[BP_PHORON_RESERVE]
	H.internal = preserve
	H.internals.icon_state = "internal1"
