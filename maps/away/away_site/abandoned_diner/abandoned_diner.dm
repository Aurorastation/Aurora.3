...
/obj/effect/overmap/visitable/sector/abandoned_diner//This is the actual overmap object that spawns at roundstart
	...
	desc = "A former space diner once operated by Starjack, a chain of rest stops and diners on space stations throughout the Spur, partially owned by NanoTrasen. The company went bankrupt in 2457, forcing its over 60 stations to be vacated in a hurry. \
