...
/turf/simulated/lava/tret //i should really make delicious and sulfurous versions of all the turfs i'm using for this site, but i can't be fucked so they get air
	initial_gas = list("sulfur dioxide" = MOLES_O2STANDARD)
