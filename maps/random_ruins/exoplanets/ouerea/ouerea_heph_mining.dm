/datum/map_template/ruin/exoplanet/ouerea_heph_mining
	...
	suffixes = list("ouerea/ouerea_heph_mining.dmm")
	ban_ruins = list(/datum/map_template/ruin/exoplanet/ouerea_guild_mining, /datum/map_template/ruin/exoplanet/moghes_guild_mining, /datum/map_template/ruin/exoplanet/heph_mining_station, /datum/map_template/ruin/exoplanet/miners_guild_outpost, /datum/map_template/ruin/away_site/cyclops_mining_vessel)
