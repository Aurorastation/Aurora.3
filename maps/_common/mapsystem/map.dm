/datum/map
	...
	var/meteors_detected_message = "A meteor storm has been detected on collision course with the vessel. Estimated three minutes until impact, please activate station shields, and seek shelter in the central ring."
	...
	var/ship_meteor_end_message = "The last of the ship debris has hit or passed by the vessel, it is now safe to commence repairs."

	var/dust_detected_message = "A belt of space dust is approaching the vessel."
	var/dust_contact_message = "The vessel is now passing through a belt of space dust."
	var/dust_end_message = "The vessel has now passed through the belt of space dust."

	var/radiation_detected_message = "High levels of radiation detected near the vessel. Please evacuate into one of the shielded maintenance tunnels."
	var/radiation_contact_message = "The vessel has entered the radiation belt. Please remain in a sheltered area until we have passed the radiation belt."
	var/radiation_end_message = "The vessel has passed the radiation belt. Please report to medbay if you experience any unusual symptoms. Maintenance will lose all-access again shortly."
