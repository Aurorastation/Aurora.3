...
ALTER TABLE `ss13_characters`
	...
	CHANGE COLUMN `all_underwear` `all_underwear` VARCHAR(32) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci' AFTER `eyes_colour`,
	CHANGE COLUMN `all_underwear_metadata` `all_underwear_metadata` VARCHAR(32) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci' AFTER `all_underwear`,
