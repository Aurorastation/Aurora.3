...
ALTER TABLE `ss13_characters`
	...
	CHANGE COLUMN `eco_stat` `eco_stat` MEDIUMTEXT NULL COLLATE 'utf8mb4_unicode_ci' AFTER `religion`,
	CHANGE COLUMN `uplink_location` `uplink_location` MEDIUMTEXT NULL COLLATE 'utf8mb4_unicode_ci' AFTER `eco_stat`,
