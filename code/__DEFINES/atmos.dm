...
#define MOLES_H2OSTANDARD     (MOLES_CELLSTANDARD * H2OSTANDARD)
...
// Amount of air needed before passing out/suffocation commences.
...
#define LOW_PRESSURE_DAMAGE 0.6
...
#define FLOOR_HEAT_TRANSFER_COEFFICIENT 0.4  // Currently NOT IN USE.
#define WALL_HEAT_TRANSFER_COEFFICIENT  0.0
#define DOOR_HEAT_TRANSFER_COEFFICIENT  0.0
// A hack to partly simulate radiative heat.
#define SPACE_HEAT_TRANSFER_COEFFICIENT 0.2  // Currently NOT IN USE.
#define OPEN_HEAT_TRANSFER_COEFFICIENT  0.4
// A hack for now.
#define WINDOW_HEAT_TRANSFER_COEFFICIENT 0.1 // Currently NOT IN USE.
...
// Autoignite temperature in tanks and canisters - enclosed environments I guess
#define PHORON_MINIMUM_BURN_TEMPERATURE    (T0C +  126) // 400 K
// Autoignite temperature in air if that ever gets implemented.
#define PHORON_FLASHPOINT                  (T0C +  246) // 519 K

// Hydrogen fire properties.
// Autoignite temperature in tanks and canisters
#define HYDROGEN_MINIMUM_BURN_TEMPERATURE   (T0C + 268) // 541 K
// Autoignite temperature in air
#define HYDROGEN_FLASHPOINT                 (T0C + 536) // 809 K
...
// +1 for each SCALE kPa above threshold. Was 2 atm.
...
// 15000 kPa of pressure.
#define MAX_VENT_PRESSURE 15000
// 1000 kPa of pressure. Allows for easier searchability.
#define PRESSURE_ONE_THOUSAND 1000
// 200 kPa of pressure.
#define PRESSURE_EXERTED 200
...
#define GAS_PURBLE              "purble"
#define GAS_TEEL                "teel"
