...
#define ALL_SPECIFIC_SECTORS	list(SECTOR_TAU_CETI, SECTOR_SRRANDMAR, SECTOR_HANEUNIM, SECTOR_BURZSIA, SECTOR_UUEOAESA, SECTOR_NEW_ANKARA, SECTOR_AEMAQ, SECTOR_NRRAHRAHUL, SECTOR_GAKAL)
