...
//#define MODEFLAG_ATMOSPHERIC BITFLAG(6) Doesn't work well with ZAS, uncomment once ZAS is gone.
#define MODEFLAG_HULL BITFLAG(6)
#define MODEFLAG_MODULATE BITFLAG(7)
#define MODEFLAG_OVERCHARGE BITFLAG(8)
