...
//#define QUIRK_MOODLET_BASED (1<<3) ---LACKING MOOD ATM---
/// This quirk shouldn't be shown by health analyzers and hud, perhaps as considering it a medical condition is a far stretch.
