...
/// From /datum/element/light_eater/proc/table_buffet: (list/light_queue, datum/light_eater)
#define COMSIG_LIGHT_EATER_QUEUE "light_eater_queue"
/// From /datum/element/light_eater/proc/devour: (datum/light_eater)
...
/// From /datum/element/light_eater/proc/devour: (atom/eaten_light)
