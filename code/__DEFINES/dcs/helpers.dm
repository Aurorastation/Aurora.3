 ...
 */
#define EnsureComponent(target, component_type, component_var, arguments...) var component_type/component_var = target._LoadComponent(list(component_type{dupe_mode = COMPONENT_DUPE_UNIQUE}, ##arguments))
