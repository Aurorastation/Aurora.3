...
#define GAME_PLANE -6
	...
	//FLY_LAYER 5
	#define INTERIOR_DOOR_INSIDE_LAYER 5.01
	#define INTERIOR_WALL_SOUTH_LAYER 5.02
	#define INTERIOR_DOOR_LAYER 5.03
	#define INTERIOR_WALLMOUNT_LAYER 5.04
	#define INTERIOR_ROOF_LAYER 5.05
	//OBSERVER
