...
#define DEFAULT_PLANE 1
	...
	#define ABOVE_TABLE_LAYER 2.23
	#define BELOW_OBJ_LAYER 2.24
	#define STRUCTURE_LAYER 2.25
	//OBJ_LAYER 3
	...
	#define SIDE_WINDOW_LAYER 3.02
	#define FULL_WINDOW_LAYER 3.03
	#define ABOVE_WINDOW_LAYER 3.04
	#define CLOSED_DOOR_LAYER 3.05
	#define ABOVE_DOOR_LAYER 3.06
