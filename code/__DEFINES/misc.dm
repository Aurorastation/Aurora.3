...
#define PROGRAM_SILICON_AI BITFLAG(4)
#define PROGRAM_WRISTBOUND BITFLAG(5)
#define PROGRAM_SILICON_ROBOT BITFLAG(6)
#define PROGRAM_SILICON_PAI BITFLAG(7)
#define PROGRAM_COMMUNICATOR BITFLAG(8)

#define PROGRAM_ALL (PROGRAM_CONSOLE | PROGRAM_LAPTOP | PROGRAM_TABLET | PROGRAM_WRISTBOUND | PROGRAM_TELESCREEN | PROGRAM_SILICON_AI | PROGRAM_SILICON_ROBOT | PROGRAM_SILICON_PAI | PROGRAM_COMMUNICATOR)
