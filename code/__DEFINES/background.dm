...
#define RELIGION_RASKARA "Raskariim (Ma'ta'ke)"
...
#define ACCENT_GIBSON "New Gibsonite"
...
#define RELIGIONS_ADHOMAI list(RELIGION_TWINSUNS, RELIGION_MATAKE, RELIGION_RASKARA, RELIGION_RASKARA_ALT, RELIGION_NONE, RELIGION_OTHER)
#define CITIZENSHIPS_ADHOMAI list(CITIZENSHIP_PRA, CITIZENSHIP_DPRA, CITIZENSHIP_NKA, CITIZENSHIP_BIESEL)
