...
/datum/hud/proc/morph_hud()
	...
	mov_intent.icon = 'icons/hud/mob/morph.dmi'
	mov_intent.icon_state = (mymob.m_intent == M_RUN ? "running" : "walking")
	move_intent = mov_intent

	mymob.healths = new /atom/movable/screen()
	mymob.healths.name = "health"
	mymob.healths.icon = 'icons/hud/mob/morph.dmi'
	mymob.healths.icon_state = "health0"
	mymob.healths.screen_loc = ui_alien_health

	mymob.zone_sel = new /atom/movable/screen/zone_sel()
	mymob.zone_sel.icon = 'icons/hud/mob/morph.dmi'
	...
	resist.name = "resist"
	resist.icon = 'icons/hud/mob/morph.dmi'
