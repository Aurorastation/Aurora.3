...
/obj/structure/closet/secure_closet/scientist/fill()
	...
	new /obj/item/clothing/under/rank/scientist/white(src)
	new /obj/item/clothing/under/rank/scientist/white/jeans(src)
	new /obj/item/clothing/under/rank/scientist/white/jeans/female(src)
	new /obj/item/clothing/under/rank/scientist/shirt(src)
...
/obj/structure/closet/secure_closet/RD2/fill()
	...
	new /obj/item/clothing/under/rank/research_director/rdalt(src)
	new /obj/item/clothing/under/rank/research_director/dress_rd(src)
	new /obj/item/clothing/under/rank/research_director/old(src)
	new /obj/item/clothing/under/rank/research_director/old/dress(src)
	new /obj/item/clothing/suit/storage/toggle/labcoat(src)
	new /obj/item/clothing/shoes/science(src)
	new /obj/item/clothing/shoes/laceup/brown(src)
	new /obj/item/clothing/gloves/latex/nitrile(src)
