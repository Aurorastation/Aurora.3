...
/obj/structure/closet/secure_closet/CMO/fill()
	...
	new /obj/item/clothing/under/rank/chief_medical_officer/alt/skirt(src)
	new /obj/item/clothing/under/rank/chief_medical_officer/alt/jeans(src)
	new /obj/item/clothing/under/rank/chief_medical_officer/alt/jeans/female(src)
