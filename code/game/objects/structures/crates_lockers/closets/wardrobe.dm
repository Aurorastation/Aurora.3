...
/obj/structure/closet/wardrobe/yellow/fill()
	...
	new /obj/item/clothing/under/color/yellow(src)
	new /obj/item/clothing/under/color/yellow(src)
	new /obj/item/clothing/under/color/orange_nonprisoner(src)
	new /obj/item/clothing/shoes/orange(src)
	new /obj/item/clothing/shoes/orange(src)
	new /obj/item/clothing/shoes/orange(src)
	return
...
/obj/structure/closet/wardrobe/atmospherics_yellow/fill()
	...
	new /obj/item/clothing/under/rank/atmospheric_technician(src)
	new /obj/item/clothing/under/rank/atmospheric_technician(src)
	new /obj/item/clothing/under/rank/atmospheric_technician/alt(src)
	new /obj/item/clothing/under/rank/atmospheric_technician/alt(src)
	new /obj/item/clothing/under/rank/atmospheric_technician/alt(src)
	new /obj/item/clothing/under/rank/atmospheric_technician/alt/jeans(src)
	new /obj/item/clothing/under/rank/atmospheric_technician/alt/jeans(src)
	new /obj/item/clothing/under/rank/atmospheric_technician/alt/jeans(src)
	new /obj/item/clothing/under/rank/atmospheric_technician/alt/jeans/female(src)
	new /obj/item/clothing/under/rank/atmospheric_technician/alt/jeans/female(src)
	new /obj/item/clothing/under/rank/atmospheric_technician/alt/jeans/female(src)
	new /obj/item/clothing/shoes/black(src)
	new /obj/item/clothing/shoes/black(src)
...
/obj/structure/closet/wardrobe/engineering_yellow/fill()
	...
	new /obj/item/clothing/under/rank/engineer/alt(src)
	new /obj/item/clothing/under/rank/engineer/alt(src)
	new /obj/item/clothing/under/rank/engineer/alt/jeans(src)
	new /obj/item/clothing/under/rank/engineer/alt/jeans(src)
	new /obj/item/clothing/under/rank/engineer/alt/jeans(src)
	new /obj/item/clothing/under/rank/engineer/alt/jeans/female(src)
	new /obj/item/clothing/under/rank/engineer/alt/jeans/female(src)
	new /obj/item/clothing/under/rank/engineer/alt/jeans/female(src)
	new /obj/item/clothing/under/rank/engineer/apprentice(src)
	new /obj/item/clothing/under/rank/engineer/apprentice(src)
	new /obj/item/clothing/under/rank/engineer/apprentice/hazard(src)
	new /obj/item/clothing/under/rank/engineer/apprentice/hazard(src)
	new /obj/item/clothing/shoes/orange(src)
	new /obj/item/clothing/shoes/orange(src)
	new /obj/item/clothing/shoes/orange(src)
...
/obj/structure/closet/wardrobe/robotics_black/fill()
	...
	new /obj/item/clothing/under/rank/roboticist(src)
	new /obj/item/clothing/under/rank/roboticist/black(src)
	new /obj/item/clothing/under/rank/roboticist/black(src)
	new /obj/item/clothing/under/rank/roboticist/black/alt(src)
	new /obj/item/clothing/under/rank/roboticist/black/alt(src)
	new /obj/item/clothing/suit/storage/toggle/labcoat(src)
	new /obj/item/clothing/suit/storage/toggle/labcoat(src)
	new /obj/item/clothing/shoes/black(src)
...
/obj/structure/closet/wardrobe/pharmacy_white/fill()
	...
	new /obj/item/clothing/under/rank/pharmacist(src)
	new /obj/item/clothing/under/rank/pharmacist/alt(src)
	new /obj/item/clothing/under/rank/pharmacist/alt(src)
	new /obj/item/clothing/under/rank/pharmacist/alt/jeans(src)
	new /obj/item/clothing/under/rank/pharmacist/alt/jeans(src)
	new /obj/item/clothing/under/rank/pharmacist/alt/jeans/female(src)
	new /obj/item/clothing/under/rank/pharmacist/alt/jeans/female(src)
	new /obj/item/clothing/under/rank/pharmacist/shirt(src)
	new /obj/item/clothing/under/rank/pharmacist/shirt(src)
...
/obj/structure/closet/wardrobe/medic_white/fill()
	...
	new /obj/item/clothing/under/rank/medical(src)
	new /obj/item/clothing/under/rank/medical/alt(src)
	new /obj/item/clothing/under/rank/medical/alt(src)
