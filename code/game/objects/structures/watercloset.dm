...
/obj/structure/toilet/attackby(obj/item/I as obj, mob/living/user as mob)
	if(I.iscrowbar())
		...
		if(do_after(user, 30/I.toolspeed - 30/I.toolspeed * skill_time_reduction("construction", 0.1, user)))
...
/obj/structure/sink/attack_hand(mob/user as mob)
	...
	busy = 1
	if(!do_after(user, 40 - 40 * skill_time_reduction("sanitation", 0.1, user), src))
		busy = 0
		return TRUE
	busy = 0
