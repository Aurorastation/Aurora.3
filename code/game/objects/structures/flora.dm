...
/obj/structure/flora/pottedplant/attackby(obj/item/W, mob/user)
	...
	user.visible_message("<b>[user]</b> begins digging around inside of \the [src].", "You begin digging around in \the [src], trying to hide \the [W].")
...
/obj/structure/flora/pottedplant/attack_hand(mob/user)
	user.visible_message("<b>[user]</b> begins digging around inside of \the [src].", "You begin digging around in \the [src], searching it.")
	playsound(loc, 'sound/effects/plantshake.ogg', 50, 1)
