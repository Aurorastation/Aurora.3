...
ABSTRACT_TYPE(/obj/structure/machinery/computer/access_terminal)
...
/obj/structure/machinery/computer/access_terminal/Destroy()
	if (held_card)
...
/obj/structure/machinery/computer/access_terminal/proc/get_available_accesses()
	. = list()

/obj/structure/machinery/computer/access_terminal/attackby(obj/item/attacking_item, mob/user)
...
/obj/structure/machinery/computer/access_terminal/attack_hand(mob/user)
	. = ..()
	ui_interact(user)

/obj/structure/machinery/computer/access_terminal/ui_interact(mob/user, datum/tgui/ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "AccessTerminal", "Self-Service Access Terminal", 550, 650)
		ui.open()

/obj/structure/machinery/computer/access_terminal/ui_data(mob/user)
	var/list/data = list()
...
/obj/structure/machinery/computer/access_terminal/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
...
/obj/structure/machinery/computer/access_terminal/odyssey
	name = "self-service actor access terminal"

/// Returns a list of paths of type `/datum/access/`.
/obj/structure/machinery/computer/access_terminal/odyssey/get_available_accesses()
...
/obj/structure/machinery/computer/access_terminal/static_access
	var/list/datum/access/available_accesses = list()

/obj/structure/machinery/computer/access_terminal/static_access/get_available_accesses()
	. = available_accesses
