...
/obj/structure/machinery/computer/robotics/attack_ai(mob/user)
...
/obj/structure/machinery/computer/robotics/ui_data(mob/user)
	return list(
...
/obj/structure/machinery/computer/robotics/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
	var/mob/user = usr
 ...
 */
/obj/structure/machinery/computer/robotics/proc/get_cyborgs(mob/operator)
...
/obj/structure/machinery/computer/robotics/proc/get_cyborg_by_name(name)
	if(!name)
		return
	for(var/mob/living/silicon/robot/cyborg in GLOB.mob_list)
		if(cyborg.name == name)
