...
/obj/random/weapon_and_ammo
	...
	var/list/Common = list(
		...
		/obj/item/gun/projectile/automatic/pattern6 = 1,
		/obj/item/gun/projectile/automatic/wt550/lethal = 0.5,
		/obj/item/gun/projectile/pattern5 = 0.5,
		/obj/item/gun/projectile/pattern5/super = 1,
		...
		/obj/item/gun/projectile/mk58/lethal= 0.5,
