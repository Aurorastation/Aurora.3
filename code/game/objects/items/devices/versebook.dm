/obj/item/device/versebook
	...
	desc_lore = "No, seriously. Make a issue request"
	item_icons = list(
...
/obj/item/device/versebook/tribunal
	...
	desc_lore = "An almost mandatory possession for any Dominian household, containing a list of edicts, litanies, and rituals."
	icon_state = "dominiabook"
	item_state = "dominia"
...
/obj/item/device/versebook/gadpathur
	...
	desc_lore = "Manufactured using recycled paper and canvas. The wisdom within the text is based on the collected speeches of Commander Patvardhan and her assorted councillors."
...
/obj/item/device/versebook/biesel
	...
	desc_lore = "This book has the Republic of Biesel's iconic symbol etched on the cover, the text within details the structure of the Federal Democracy the Republic is today."
