...
/obj/item/device/multitool
	...
	desc_mechanics = "You can use this on airlocks or APCs to try to hack them without cutting wires. You can also use it to wire circuits, and track APCs by using it in-hand."
