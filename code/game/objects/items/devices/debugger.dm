...
/obj/item/device/debugger
	...
	desc_mechanics = "The debugger can be used on vending machines to identify and resolve any viral infections, or on upgradeable machinery to identify the component parts it contains."
