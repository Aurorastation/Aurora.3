...
/obj/item/voidsuit_modkit_multi/sol_warlord
	...
	suit_options = list(
		...
		"Solarian People's Liberation Front" = /obj/item/clothing/suit/space/void/sol/ssmd
	)
	helmet_options = list(
		...
		"Solarian People's Liberation Front" = /obj/item/clothing/head/helmet/space/void/sol/ssmd
	)
