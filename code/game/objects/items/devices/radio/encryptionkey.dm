...
/obj/item/device/encryptionkey/syndicate
	...
	desc_antag = "An encryption key that allows you to intercept comms and speak on private non-facility channels. Use :t to access the private channel."
	syndie = TRUE
...
/obj/item/device/encryptionkey/rev
	...
	additional_channels = list(CHANNEL_RAIDER = TRUE)
	origin_tech = list(TECH_ILLEGAL = 2)
	desc_antag = "An encryption key that allows you to speak on private non-facility channels. Use :x to access the private channel."
