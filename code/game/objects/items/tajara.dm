/obj/item/storage/box/fancy/cigarettes/pra
	...
	desc_lore = "Imported from the People's Republic of Adhomai."
...
/obj/item/storage/box/fancy/cigarettes/dpra
	...
	desc_lore = "Imported from the Democratic People's Republic of Adhomai."
...
/obj/item/storage/box/fancy/cigarettes/nka
	...
	desc_lore = "Imported from the New Kingdom of Adhomai."
...
/obj/item/tajcard/proc/set_card(var/figure)
	...
	switch(figure)
		...
		if("hadii")
			...
			desc_lore = "Njadrasanukii Hadii was born in 2402 to the noble Njarir'Akhran Hadii line. He got involved with the military at an early age, becoming a cadet for the \
		...
		if("headmaster")
			...
			desc_lore = "Harrrdanim was born in 2411 to an M'sai line. He entered military service at a young age. His high intelligence and robust health soon had him successfully \
		...
		if("almanq")
			...
			desc_lore = "Rikdar was born on 2429 the noble Njarir'Akhran Bayan line in Nal'Tor. However, his parents were disappeared by Republic secret police in one of the \
		...
		if("yasmin")
			...
			desc_lore = "Yasmin Piaf, was born in 2434 in the suburbs of Nal'tor to a particularly well off Njarir'Akhran family. Even from her young age, \
		...
		if("andrey")
			...
			desc_lore = "Born in 2416 to aline of M'sai warriors, Andrey was not even two years old before humanity stumbled across Adhomai and lit the flame that ignited the \
		...
		if("paratrooper")
			...
			desc_lore = "Following the end of the first revolution, many veterans especially of the Ha'narr Corps had become hardened warriors with exceptional abilities. \
		...
		if("scout")
			...
			desc_lore = "Originally formed in 2421 during the first revolution, the Ha'narr Corps served as a reconnaissance, scouting and special operations unit for the \
...
/obj/item/pocketwatch/adhomai
	...
	desc_lore = "Baltoris a fortress founded during the Gunpowder Age; it was the landing site of the royal armies during the Suns'wars. Baltor plays a strategic role in controlling the \
...
/obj/item/storage/pill_bottle/dice/tajara
	...
	icon = 'icons/obj/tajara_items.dmi'
	desc_lore = "Suns and Moon is a very common dice game. It is played by all, though the lower classes have the tendency to gamble whereas upper classes play it just for fun. The ease and universality \
