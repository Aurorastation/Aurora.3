...
/obj/item/storage/box/flares/signal
	name = "signal flares box"
	desc = "A box full of signal flares."
	icon_state = "signalflarebox"
	starts_with = list(
		/obj/item/device/flashlight/flare/signal = 6
	)
