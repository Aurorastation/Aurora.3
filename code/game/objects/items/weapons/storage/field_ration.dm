/obj/item/storage/field_ration
	...
	icon_state = "ration"
	desc_lore = "The republican army is the best equipped among the warring factions of Adhomai, being supplied by NanoTrasen and other outworld supporters. Canned goods and \
...
/obj/item/storage/field_ration/nka
	icon_state = "bigbox"
	desc_lore = "The early Alam'ardii forces relied on the landed nobility to provide them food, with the resources being taken from the private properties of their contractors. \
...
/obj/item/storage/field_ration/dpra
	icon_state = "bigbox"
	desc_lore = "The Adhomai Liberation army, being an amalgamation of regular army units, militia groups, and undercover agents, does not have any standard set when the subject is \
