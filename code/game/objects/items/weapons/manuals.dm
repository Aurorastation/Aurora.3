...
/obj/item/weapon/book/manual/evaguide
	...
	dat = {"<html>
				...
				These suits generally only fit one species. Nanotarsen's are usually human-fitting by default, but there's equipment that can make modifications to the voidsuits to fit them to other species.<BR><BR>
