/obj/item/weapon/cloaking_device
	...
	description_info = "The default power cell will last a decent amount of time of continuous usage. It can be removed and recharged or replaced with a better one using a screwdriver.\
