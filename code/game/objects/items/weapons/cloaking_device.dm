/obj/item/cloaking_device
	...
	desc_mechanics = "The default power cell will last for five minutes of continuous usage. It can be removed and recharged or replaced with a better one using a screwdriver.\
