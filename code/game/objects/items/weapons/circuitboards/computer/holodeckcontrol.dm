/obj/item/circuitboard/holodeckcontrol
	...
	build_path = /obj/structure/machinery/computer/holodeck_control
...
/obj/item/circuitboard/holodeckcontrol/construct(var/obj/structure/machinery/computer/holodeck_control/HC)
	if (..(HC))
...
/obj/item/circuitboard/holodeckcontrol/deconstruct(var/obj/structure/machinery/computer/holodeck_control/HC)
	if (..(HC))
