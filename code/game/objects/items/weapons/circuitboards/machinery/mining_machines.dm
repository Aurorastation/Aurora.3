/obj/item/circuitboard/refiner
	...
	build_path = /obj/structure/machinery/mineral/processing_unit
...
/obj/item/circuitboard/redemption_console
	...
	build_path = /obj/structure/machinery/mineral/processing_unit_console
	origin_tech = list(TECH_MAGNET = 2, TECH_ENGINEERING = 2)
	board_type = BOARD_MACHINE
	req_components = list(
		"/obj/item/stock_parts/scanning_module" = 1,
...
/obj/item/circuitboard/redemption_console/construct(obj/structure/machinery/M)
	. = ..()
	switch(M.dir)
		if(NORTH)
			M.pixel_y = 32
...
/obj/item/circuitboard/unloading_machine
	...
	build_path = /obj/structure/machinery/mineral/unloading_machine
	origin_tech = list(TECH_MAGNET = 2, TECH_ENGINEERING = 2)
	board_type = BOARD_MACHINE
	req_components = list(
...
/obj/item/circuitboard/stacking_machine
	...
	build_path = /obj/structure/machinery/mineral/stacking_machine
	origin_tech = list(TECH_MAGNET = 2, TECH_ENGINEERING = 2)
	board_type = BOARD_MACHINE
	req_components = list(
		"/obj/item/stock_parts/manipulator" = 2
...
/obj/item/circuitboard/stacking_console
	...
	build_path = /obj/structure/machinery/mineral/stacking_unit_console
	origin_tech = list(TECH_MAGNET = 2, TECH_ENGINEERING = 2)
	board_type = BOARD_MACHINE
	req_components = list(
		"/obj/item/stock_parts/scanning_module" = 1,
...
/obj/item/circuitboard/stacking_console/construct(obj/structure/machinery/M)
	. = ..()
	switch(M.dir)
		if(NORTH)
			M.pixel_y = 32
