...
/obj/item/circuitboard/sleeper
	...
	build_path = /obj/structure/machinery/sleeper
...
/obj/item/circuitboard/stasis_bed
	...
	build_path = /obj/structure/machinery/stasis_bed
...
/obj/item/circuitboard/cryotube
	...
	build_path = /obj/structure/machinery/atmospherics/unary/cryo_cell
...
/obj/item/circuitboard/bodyscanner
	...
	build_path = /obj/structure/machinery/bodyscanner
	origin_tech = list(TECH_MAGNET = 2, TECH_ENGINEERING = 2)
	board_type = BOARD_MACHINE
	req_components = list(
...
/obj/item/circuitboard/bodyscannerconsole
	...
	build_path = /obj/structure/machinery/body_scanconsole
...
/obj/item/circuitboard/requestconsole
	...
	desc = "The circuitboard for a body scanner console."
	build_path = /obj/structure/machinery/requests_console
...
/obj/item/circuitboard/optable
	...
	build_path = /obj/structure/machinery/optable
...
/obj/item/circuitboard/smartfridge
	...
	build_path = /obj/structure/machinery/smartfridge
...
/obj/item/circuitboard/oven
	...
	build_path = /obj/structure/machinery/appliance/cooker/oven
	origin_tech = list(TECH_MAGNET = 2, TECH_ENGINEERING = 2)
	board_type = BOARD_MACHINE
	req_components = list(
...
/obj/item/circuitboard/fryer
	...
	build_path = /obj/structure/machinery/appliance/cooker/fryer
	origin_tech = list(TECH_MAGNET = 2, TECH_ENGINEERING = 2)
	board_type = BOARD_MACHINE
	req_components = list(
							"/obj/item/stock_parts/capacitor" = 3,
...
/obj/item/circuitboard/stove
	...
	build_path = /obj/structure/machinery/appliance/cooker/stove
	origin_tech = list(TECH_MAGNET = 2, TECH_ENGINEERING = 2)
	board_type = BOARD_MACHINE
	req_components = list(
							"/obj/item/stock_parts/capacitor" = 3,
...
/obj/item/circuitboard/cerealmaker
	...
	build_path = /obj/structure/machinery/appliance/mixer/cereal
	origin_tech = list(TECH_MAGNET = 2, TECH_ENGINEERING = 2)
	board_type = BOARD_MACHINE
	req_components = list(
							"/obj/item/stock_parts/capacitor" = 3,
...
/obj/item/circuitboard/grill
	...
	build_path = /obj/structure/machinery/appliance/cooker/grill
	origin_tech = list(TECH_MAGNET = 2, TECH_ENGINEERING = 3)
	board_type = BOARD_MACHINE
	req_components = list(
			"/obj/item/stock_parts/capacitor" = 2,
...
/obj/item/circuitboard/candymachine
	...
	build_path = /obj/structure/machinery/appliance/mixer/candy
	origin_tech = list(TECH_MAGNET = 2, TECH_ENGINEERING = 2)
	board_type = BOARD_MACHINE
	req_components = list(
							"/obj/item/stock_parts/capacitor" = 3,
...
/obj/item/circuitboard/holopad
	...
	build_path = /obj/structure/machinery/hologram/holopad
...
/obj/item/circuitboard/weapons_analyzer
	...
	build_path = /obj/structure/machinery/r_n_d/weapons_analyzer
...
/obj/item/circuitboard/oxyregenerator
	...
	build_path = /obj/structure/machinery/atmospherics/binary/oxyregenerator
	board_type = BOARD_MACHINE
	origin_tech = list(TECH_MAGNET = 2, TECH_ENGINEERING = 2)
	req_components = list(
		"/obj/item/stock_parts/micro_laser" = 1,
