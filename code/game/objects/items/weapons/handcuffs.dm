...
/obj/item/weapon/handcuffs/proc/place_handcuffs(var/mob/living/carbon/target, var/mob/user)
	...
	msg_admin_attack(text="[key_name(user)] attempted to handcuff [key_name(H)] (<A HREF='?_src_=holder;adminplayerobservecoodjump=1;X=[user.x];Y=[user.y];Z=[user.z]'>JMP</a>)",ckey=key_name(user),ckey_target=key_name(H))
...
/mob/living/carbon/human/RestrainedClickOn(var/atom/A)
	...
	log_attack(text="[s] ([H.ckey])",ckey=key_name(H))
