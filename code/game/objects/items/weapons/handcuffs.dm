...
/obj/item/handcuffs/proc/place_handcuffs(var/mob/living/carbon/target, var/mob/user, var/instant)
	...
	if(user)
		H.log_message("Has been handcuffed (attempt) by [user.name] ([user.ckey])", LOG_VICTIM, log_globally = FALSE)
		user.log_message("Attempted to handcuff [H.name] ([H.ckey])", LOG_ATTACK, log_globally = FALSE)
...
/mob/living/carbon/human/RestrainedClickOn(var/atom/A)
	...
	H.log_message("[s] ([H.ckey])", LOG_ATTACK, log_globally = FALSE)
	log_attack("[s] ([H.ckey])")
