...
/obj/effect/portal/spawner
	...
	desc_mechanics = "This portal is a spawner portal. You cannot enter it to teleport, but it will periodically spawn things."
	does_teleport = FALSE
	has_lifespan = FALSE
...
/obj/effect/portal/revenant
	name = "bluespace rift"
	desc = "A bluespace tear in space, reaching directly to another point within this region. This one looks like a one-way portal to here, don't come too close."
	desc_mechanics = "This is a bluespace rift. It is a node wherein revenants can seep into this locale. To destroy it, you must bring a bluespace neutralizer near it."
	icon_state = "portal_g"
