...
/turf/baseturf_skipover/shuttle_ceiling
	name = "Shuttle ceiling baseturf skipover"
	desc = "Acts as the bottom of the shuttle ceiling, if this isn't here the shuttle ceiling is broken through."
