...
/turf/space/ChangeTurf(var/turf/N, var/tell_universe=TRUE, var/force_lighting_update = FALSE, mapload = FALSE, keep_air = FALSE)
	return ..(N, tell_universe, TRUE, mapload, keep_air)
