...
/turf/space/transit/bluespace/ChangeTurf(N, tell_universe, force_lighting_update, ignore_override, mapload, keep_air)
	return ..(N, tell_universe, TRUE, ignore_override, mapload, keep_air)
