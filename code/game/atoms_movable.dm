/atom/movable
	...
	*
	* Set in `/atom/movable/proc/buckle` when the atom's layer is adjusted.
	*
...
/**
 * Buckles an `/atom/movable` to this atom/movable, performed by a `/mob`
 *
 ...
 */
/atom/movable/proc/buckle(atom/movable/buckling_atom, mob/user)
...
/atom/movable/proc/post_buckle(atom/movable/MA)
	return

/atom/movable/proc/user_buckle(atom/movable/MA, mob/user)
	if(!ROUND_IS_STARTED)
...
/atom/movable/proc/user_unbuckle(mob/user)
