...
/obj/mecha/working/hoverpod/combatpod/New()
	..()
	var/obj/item/mecha_parts/mecha_equipment/ME = new /obj/item/mecha_parts/mecha_equipment/energy/laser
	ME.attach(src)
	ME = new /obj/item/mecha_parts/mecha_equipment/ballistic/missile_rack/explosive
	ME.attach(src)
