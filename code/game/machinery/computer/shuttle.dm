/obj/machinery/computer/shuttle
	...
	attackby(var/obj/item/card/W as obj, var/mob/user as mob)
		...
		if (istype(W, /obj/item/card/id)||istype(W, /obj/item/device/pda))
			...
			var/choice = alert(user, "Would you like to (de)authorize a shortened launch time? [src.auth_need - src.authorized.len] authorization\s are still needed. Use abort to cancel all authorizations.", "Shuttle Launch", "Authorize", "Repeal", "Abort")
