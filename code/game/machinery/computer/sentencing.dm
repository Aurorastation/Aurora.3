/obj/machinery/computer/sentencing
	...
	desc = "A console that allows registered security personnel to create incident reports for various on-ship crimes. It produces an encrypted report that can be used to automatically set a brig timer."
