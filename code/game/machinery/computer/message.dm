...
/obj/machinery/computer/message_monitor/attack_hand(var/mob/living/user as mob)
	...
	if(auth)
		dat += "<h4><dd><A href='?src=\ref[src];auth=1'>&#09;<span class='good'>\[Authenticated\]</span></a>&#09;/"
		dat += " Server Power: <A href='?src=\ref[src];active=1'>[src.linkedServer && src.linkedServer.active ? "<span class='good'>\[On\]</span>":"<span class='warning'>\[Off\]</span>"]</a></h4>"
	else
		dat += "<h4><dd><A href='?src=\ref[src];auth=1'>&#09;<span class='warning'>\[Unauthenticated\]</span></a>&#09;/"
		dat += " Server Power: <u>[src.linkedServer && src.linkedServer.active ? "<span class='good'>\[On\]</span>":"<span class='warning'>\[Off\]</span>"]</u></h4>"
