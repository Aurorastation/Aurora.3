...
/obj/machinery/computer/arcade/battle/Topic(href, href_list)
	...
	if (!src.blocked && !src.gameover)
		if (href_list["attack"])
			...
			playsound(loc, 'sound/arcade/hit.ogg', 25, 1, extrarange = -3, falloff = 10)
			src.updateUsrDialog()
			if(turtle > 0)
				turtle--
			...
			playsound(loc, 'sound/arcade/heal.ogg', 25, 1, extrarange = -3, falloff = 10)
			src.updateUsrDialog()
			turtle++
			...
			playsound(loc, 'sound/arcade/mana.ogg', 25, 1, extrarange = -3, falloff = 10)
...
/obj/machinery/computer/arcade/battle/proc/arcade_action()
	if ((src.enemy_mp <= 0) || (src.enemy_hp <= 0))
		if(!gameover)
			...
			playsound(loc, 'sound/arcade/win.ogg', 25, 1, extrarange = -3, falloff = 10)
		...
		playsound(loc, 'sound/arcade/boom.ogg', 25, 1, extrarange = -3, falloff = 10)
		src.player_hp -= boomamt

	else if ((src.enemy_mp <= 5) && (prob(70)))
		var/stealamt = rand(2,3)
		src.temp = "[src.enemy_name] steals [stealamt] of your power!"
		playsound(loc, 'sound/arcade/steal.ogg', 25, 1, extrarange = -3, falloff = 10)
	...
	if ((src.player_mp <= 0) || (src.player_hp <= 0))
		...
		playsound(loc, 'sound/arcade/lose.ogg', 25, 1, extrarange = -3, falloff = 10)
		if(emagged)
