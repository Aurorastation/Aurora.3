	...
	switch(view)
		if(ORION_VIEW_MAIN)
			if(event == ORION_TRAIL_START) //new game? New game.
				playsound(loc, 'sound/arcade/Ori_begin.ogg', 25, 1, extrarange = -3, falloff = 10)
			...
			switch(event)
				if(ORION_TRAIL_GAMEOVER)
					playsound(loc, 'sound/arcade/Ori_fail.ogg', 25, 1, extrarange = -3, falloff = 10)
					event_info = ""
				...
				if(ORION_TRAIL_FLUX)
					playsound(loc, 'sound/arcade/explo.ogg', 25, 1, extrarange = -3, falloff = 10)
...
/obj/machinery/computer/arcade/orion_trail/Topic(href,href_list)
	...
	if(href_list["buy"])
		...
		playsound(loc, 'sound/arcade/get_fuel.ogg', 25, 1, extrarange = -3, falloff = 10)
	...
	if(href_list["sell"])
		...
		playsound(loc, 'sound/arcade/lose_fuel.ogg', 25, 1, extrarange = -3, falloff = 10)
	...
	if(href_list["kill"])
		...
		playsound(loc, 'sound/arcade/kill_crew.ogg', 25, 1, extrarange = -3, falloff = 10)
		remove_settler(item)

	if(href_list["attack"])
		supply_cost = list()
		playsound(loc, 'sound/arcade/raid.ogg', 25, 1, extrarange = -3, falloff = 10)
...
/obj/machinery/computer/arcade/orion_trail/proc/win()
	...
	playsound(loc, 'sound/arcade/Ori_win.ogg', 25, 1, extrarange = -3, falloff = 10)
	if(emagged)
