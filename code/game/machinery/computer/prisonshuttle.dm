...
/obj/machinery/computer/prison_shuttle
	...
	attack_hand(var/mob/user as mob)
		...
		if (src.temp)
			...
			\nLocation: [prison_shuttle_moving_to_station || prison_shuttle_moving_to_prison ? "Moving to [current_map.station_type] ([prison_shuttle_timeleft] Secs.)":prison_shuttle_at_station ? "[current_map.station_type]":"Dock"]<BR>
