...
/obj/machinery/portable_atmospherics/canister/attackby(var/obj/item/weapon/W as obj, var/mob/user as mob)
	if(!iswrench(W) && !istype(W, /obj/item/weapon/tank) && !istype(W, /obj/item/device/analyzer) && !istype(W, /obj/item/device/pda))
		visible_message("<span class='warning'>\The [user] hits \the [src] with \a [W]!</span>", "<span class='warning'>You hit \the [src] with \a [W]!</span>", "<span class='warning'>You hear something being hit.</span>" )
		src.health -= W.force
