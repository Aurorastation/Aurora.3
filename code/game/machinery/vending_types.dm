...
/obj/machinery/vending/cigarette
	...
	vend_id = "smokes"
	products = list(
		/obj/item/storage/fancy/cigarettes/rugged = 8,
		...
		/obj/item/storage/chewables/tobacco/fine = 6,
	...
	prices = list(
		...
		/obj/item/storage/fancy/cigarettes/pra = 25,
		...
		/obj/item/storage/fancy/chewables/tobacco/nico = 30,
		/obj/item/storage/box/matches = 12,
		/obj/item/flame/lighter/random = 12,
		/obj/item/storage/cigfilters = 10,
		/obj/item/storage/fancy/cigpaper = 10,
		/obj/item/storage/fancy/cigpaper/fine = 25,
