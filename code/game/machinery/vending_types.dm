...
/obj/machinery/vending/cigarette
	...
	products = list(
		...
		/obj/item/storage/fancy/cigarettes/pra = 4,
	...
	prices = list(
		...
		/obj/item/storage/fancy/cigarettes/pra = 30,
		...
		/obj/item/storage/chewables/tobacco = 20,
		/obj/item/storage/chewables/tobacco/fine = 30,
		/obj/item/storage/fancy/chewables/tobacco/nico = 40,
