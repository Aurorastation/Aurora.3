...
/obj/machinery/vending/cigarette
	...
	prices = list(
		/obj/item/storage/fancy/cigarettes/rugged = 27,
		/obj/item/storage/fancy/cigarettes = 36,
		/obj/item/storage/fancy/cigarettes/dromedaryco = 42,
		/obj/item/storage/fancy/cigarettes/nicotine = 49,
		/obj/item/storage/fancy/cigarettes/pra = 39,
		/obj/item/storage/chewables/rollable/bad = 16,
		/obj/item/storage/chewables/rollable = 23,
		/obj/item/storage/chewables/rollable/fine = 29,
		/obj/item/storage/chewables/rollable/nico = 46,
		/obj/item/storage/chewables/tobacco/bad = 15,
		/obj/item/storage/chewables/tobacco = 34,
		/obj/item/storage/chewables/tobacco/fine = 46,
		/obj/item/storage/fancy/chewables/tobacco/nico = 51,
		/obj/item/storage/box/matches = 4,
		/obj/item/flame/lighter/random = 4,
		/obj/item/storage/cigfilters = 13,
		/obj/item/storage/fancy/cigpaper = 25,
		/obj/item/storage/fancy/cigpaper/fine = 38,
