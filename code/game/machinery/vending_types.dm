...
/obj/machinery/vending/cigarette
	...
	vend_id = "smokes"
	products = list(
		/obj/item/storage/fancy/cigarettes/rugged = 4,
		...
		/obj/item/storage/chewables/rollable/fine = 4,
		/obj/item/storage/chewables/rollable/nico = 4,
		/obj/item/storage/chewables/tobacco/bad = 8,
		/obj/item/storage/chewables/tobacco = 6,
		/obj/item/storage/chewables/tobacco/fine = 4,
		/obj/item/storage/fancy/chewables/tobacco/nico = 4,
		/obj/item/storage/cigfilters = 10,
		/obj/item/storage/fancy/cigpaper = 8,
		/obj/item/storage/fancy/cigpaper/fine = 6,
	...
	prices = list(
		...
		/obj/item/storage/fancy/cigarettes/nicotine = 30,
		/obj/item/storage/chewables/rollable/bad = 5,
		/obj/item/storage/chewables/rollable = 10,
		/obj/item/storage/chewables/rollable/fine = 15,
		/obj/item/storage/chewables/rollable/nico = 20,
		/obj/item/storage/chewables/tobacco/bad = 20,
		/obj/item/storage/chewables/tobacco = 25,
		/obj/item/storage/chewables/tobacco/fine = 40,
		/obj/item/storage/fancy/chewables/tobacco/nico = 15,
		/obj/item/storage/box/matches = 12,
		/obj/item/flame/lighter/random = 12,
		/obj/item/storage/cigfilters = 5,
		/obj/item/storage/fancy/cigpaper = 5,
		/obj/item/storage/fancy/cigpaper/fine = 15,
