...
/obj/machinery/bioprinter
	...
	var/list/products = list(
		BP_HEART =   list(/obj/item/organ/heart,  50),
		BP_LUNGS =   list(/obj/item/organ/lungs,  40),
		BP_KIDNEYS = list(/obj/item/organ/kidneys,20),
		BP_EYES =    list(/obj/item/organ/eyes,   30),
		BP_LIVER =   list(/obj/item/organ/liver,  50)
		)
