...
/obj/machinery/nuclearbomb/proc/explode()
	...
	if(SSticker.mode)
		...
		if(off_station == 1)
			to_world("<b>A nuclear device was set off, but the explosion was out of reach of the ship!</b>")
		else if(off_station == 2)
			to_world("<b>A nuclear device was set off, but the device was not on the ship!</b>")
		else
			to_world("<b>The ship was destroyed by the nuclear blast!</b>")
