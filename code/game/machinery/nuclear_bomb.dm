...
/obj/machinery/nuclearbomb/proc/explode()
	...
	if(SSticker.mode)
		...
		if(off_station == 1)
			to_world("<b>A nuclear device was set off, but the explosion was out of reach of the [current_map.station_type]!</b>")
		else if(off_station == 2)
			to_world("<b>A nuclear device was set off, but the device was not on the [current_map.station_type]!</b>")
		else
			to_world("<b>The [current_map.station_type] was destoyed by the nuclear blast!</b>")
