/obj/machinery/mech_charger
	name = "mech charger"
	desc = "A mech charger, built into the floor."
...
/obj/machinery/mech_charger/Crossed(var/mob/living/heavy_vehicle/M)
	. = ..()
	if(istype(M) && charging != M)
		start_charging(M)

/obj/machinery/mech_charger/Uncrossed(var/mob/living/heavy_vehicle/M)
	. = ..()
	if(M == charging)
		stop_charging()

/obj/machinery/mech_charger/RefreshParts()
	..()
	charge = 0
	repair = -5
...
/obj/machinery/mech_charger/process()
	if(!charging)
...
/obj/machinery/mech_charger/power_change()
	..()
...
/obj/machinery/mech_charger/proc/fully_repaired()
	return charging && (charging.health == charging.maxHealth)

/obj/machinery/mech_charger/proc/start_charging(var/mob/living/heavy_vehicle/M)
	var/no_power = FALSE
...
/obj/machinery/mech_charger/proc/stop_charging()
	update_use_power(POWER_USE_IDLE)
	charging = null

/obj/machinery/mech_charger/hephaestus
