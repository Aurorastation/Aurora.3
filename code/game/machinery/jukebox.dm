...
/obj/machinery/media/jukebox/mounted
	name = "\improper mounted jukebox"
	density = FALSE
	anchored = FALSE
	...
	/// For icon updates.
	var/obj/item/mecha_equipment/subwoofers/parent
	/// Fuck yeah.
	tracks = list(
		new/datum/track("Thunderdome", 'sound/music/ingame/ss13/THUNDERDOME.ogg', 3 MINUTES + 22 SECONDS),
		new/datum/track("Weedance", 'sound/music/ingame/europa/weedance.ogg', 7 MINUTES + 35 SECONDS),
		new/datum/track("Phoron Will Make Us Rich", 'sound/music/ingame/scc/PhoronWillMakeUsRich.ogg', 2 MINUTES + 14 SECONDS),
		new/datum/track("Konyang Vibes #1", 'sound/music/ingame/konyang/konyang-1.ogg', 2 MINUTES + 59 SECONDS),
		new/datum/track("Konyang Vibes #3", 'sound/music/ingame/konyang/konyang-3.ogg', 2 MINUTES + 43 SECONDS),
		new/datum/track("Boolean Sisters", 'sound/music/ingame/adhomai/boolean_sisters.ogg', 3 MINUTES + 17 SECONDS),
		new/datum/track("dance させる", 'sound/music/ingame/venus/dance.ogg', 3 MINUTES + 19 SECONDS),
		new/datum/track("Break The System", 'sound/music/ingame/venus/break_the_system.ogg', 1 MINUTES + 23 SECONDS),
		new/datum/track("love sensation", 'sound/music/ingame/venus/love_sensation.ogg', 3 MINUTES + 31 SECONDS),
		new/datum/track("Rise", 'sound/music/ingame/xanu/xanu_rock_1.ogg', 3 MINUTES + 3 SECONDS),
		new/datum/track("Phoron or Death", 'sound/music/phoron_deposit.ogg', 4 MINUTES + 18 SECONDS),
		new/datum/track("You're All Going To Die Out Here", 'sound/music/lobby/dangerous_space/dangerous_space_2.ogg', 4 MINUTES)
	)

/obj/machinery/media/jukebox/mounted/Initialize()
	..()
	music_player = new(src, tracks, 15, 60)

/obj/machinery/media/jukebox/mounted/attack_hand(mob/user as mob)
	if(GLOB.heavy_vehicle_state)
		ui_interact(user)
	else
		..()

/obj/machinery/media/jukebox/mounted/ui_state(mob/user)
