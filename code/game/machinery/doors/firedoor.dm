...
/obj/machinery/door/firedoor/attackby(obj/item/weapon/C as obj, mob/user as mob)
	...
	if(istype(C, /obj/item/weapon/crowbar) || istype(C,/obj/item/weapon/material/twohanded/fireaxe) || (istype(C, /obj/item/weapon/melee/misc/hammer)))
		if(operating)
			return
		...
		if(do_after(user,30))
			if(istype(C, /obj/item/weapon/crowbar) || (istype(C, /obj/item/weapon/melee/misc/hammer)))
