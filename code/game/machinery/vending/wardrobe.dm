...
/obj/machinery/vending/wardrobe/atmos_wardrobe
	...
	products = list(
		...
		/obj/item/storage/backpack/duffel/eng = 4,
		/obj/item/storage/backpack/industrial = 4,
		/obj/item/storage/backpack/cloak/engi = 2,
		// Heph gear
...
/obj/machinery/vending/wardrobe/sec_wardrobe
	...
	icon_state = "secdrobe"
	product_ads = "Beat perps in style!;You have the right to be fashionable!;Now you can be the fashion police you always wanted to be!;Blood on your uniform? Don't wash it out, get a new one!;Feel like more than a mall cop!"
	...
	products = list(
		...
		/obj/item/clothing/suit/storage/security/officer/idris = 4,
		/obj/item/clothing/suit/storage/security/officer/idris/alt = 4,
		...
		/obj/item/clothing/suit/storage/toggle/corp/zavod = 4,
		/obj/item/clothing/suit/storage/toggle/corp/zavod/alt = 4,
