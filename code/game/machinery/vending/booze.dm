...
/obj/machinery/vending/boozeomat/horizoncasino
	name = "\improper High Roller's Reserve"
	desc = "A premium beverage dispenser, stocked exclusively with top-shelf spirits and fine wines for the discerning gambler."
	icon_state = "casinovend"
	density = FALSE
	opacity = FALSE
	vend_id = "casino_bar"
	req_access = list(ACCESS_BAR)
	product_slogans = "Feeling lucky? You will be with a drink!;Winners drink premium, and you're a winner, right?;The house always wins, but at least you'll drink well!"
	product_ads = "Celebrate your wins with premium spirits!;Drown your losses in luxury!;You're on a hot streak, keep it going!;Double down on flavor!;Liquid confidence for your next big bet!;You're due for a win, have a drink while you wait!;Risk it all while responsibly hydrated!;Fortune favors the well-refreshed!;Your luck is about to change we can feel it!;The next hand is yours, stay sharp with a shot!"
	products = list(
		/obj/item/reagent_containers/food/drinks/drinkingglass = 10,
		/obj/item/reagent_containers/food/drinks/drinkingglass/newglass/goblet = 5,
		/obj/item/reagent_containers/food/drinks/drinkingglass/newglass/wine = 5,
		/obj/item/reagent_containers/food/drinks/drinkingglass/newglass/flute = 5,
		/obj/item/reagent_containers/food/drinks/drinkingglass/newglass/cognac = 5,
		/obj/item/reagent_containers/food/drinks/drinkingglass/newglass/rocks = 5,
		/obj/item/reagent_containers/food/drinks/drinkingglass/newglass/cocktail = 5,
		/obj/item/reagent_containers/food/drinks/drinkingglass/newglass/shot = 5,
		/obj/item/tray = 3,
		/obj/item/reagent_containers/food/drinks/bottle/champagne = 2,
		/obj/item/reagent_containers/food/drinks/bottle/cognac = 2,
		/obj/item/reagent_containers/food/drinks/bottle/saintjacques = 2,
		/obj/item/reagent_containers/food/drinks/bottle/absinthe = 2,
		...
		/obj/item/reagent_containers/food/drinks/bottle/valokki_wine = 2,
		/obj/item/reagent_containers/food/drinks/bottle/wine = 2,
		/obj/item/reagent_containers/food/drinks/bottle/rose_wine = 2,
		/obj/item/reagent_containers/food/drinks/bottle/whitewine = 2,
		/obj/item/reagent_containers/food/drinks/bottle/skrellwineylpha = 2,
		/obj/item/reagent_containers/food/drinks/bottle/vodka = 3,
		/obj/item/reagent_containers/food/drinks/bottle/gin = 3,
		/obj/item/reagent_containers/food/drinks/bottle/rum = 3,
		...
		/obj/item/reagent_containers/food/drinks/bottle/triplesec = 2,
		/obj/item/reagent_containers/food/drinks/bottle/limoncello = 2,
		/obj/item/reagent_containers/food/drinks/bottle/drambuie = 2,
		/obj/item/reagent_containers/food/drinks/bottle/chartreusegreen = 2,
		/obj/item/reagent_containers/food/drinks/bottle/chartreuseyellow = 2,
		/obj/item/reagent_containers/food/drinks/bottle/cremewhite = 2,
		/obj/item/reagent_containers/food/drinks/bottle/cremeyvette = 2,
		/obj/item/reagent_containers/food/drinks/bottle/bitters = 2,
		/obj/item/reagent_containers/food/drinks/bottle/grenadine = 2,
		/obj/item/reagent_containers/food/drinks/bottle/mintsyrup = 2
	)

/obj/item/device/vending_refill/horizoncasino
	name = "\improper high roller's reserve resupply canister"
	vend_id = "casino_bar"
	charges = 75
