/**
 * Vending machines: basic template and restocker machine definitions
 * New vending machines should be not be added to this file; create a new category file ONLY if it does not make sense in an existing category file.
 **/

/*
TEMPLATE FOR NEW VENDING MACHINES
/obj/machinery/vending/[vendors name here]
	name = ""
	desc = ""
	icon = ''
	icon_state = ""
