...
/obj/machinery/suit_storage_unit/attack_hand(mob/user as mob)
	...
	if(src.panelopen) //The maintenance panel is open. Time for some shady stuff
		...
		dat+= text("<font color ='black'>A thick old-style button, with 2 grimy LED lights next to it. The [] LED is on.</font><BR><font color ='blue'><A href='?src=\ref[];togglesafeties=1'>Press button</a></font>",(src.safetieson? "<span class='good'><B>GREEN</B></span>" : "<span class='warning'><B>RED</B></span>"),src)
