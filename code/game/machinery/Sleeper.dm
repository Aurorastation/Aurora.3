/obj/machinery/sleeper
	...
	var/list/available_chemicals = list(/datum/reagent/inaprovaline = "Inaprovaline", /datum/reagent/soporific = "Soporific", /datum/reagent/perconol = "Perconol", /datum/reagent/dylovene = "Dylovene", /datum/reagent/dexalin = "Dexalin")
