/obj/machinery/sleeper
	...
	var/list/available_chemicals = list(/datum/reagent/inaprovaline = "Inaprovaline", /datum/reagent/soporific = "Soporific", /datum/reagent/paracetamol = "Perconol", /datum/reagent/dylovene = "Dylovene", /datum/reagent/dexalin = "Dexalin")
