...
/obj/machinery/iv_drip/machinery_process()
	...
	if(src.attached)
		...
		if(!(get_dist(src, src.attached) <= 1 && isturf(src.attached.loc)))
			...
			src.attached.visible_message(SPAN_WARNING("The needle is ripped out of [src.attached]'s [affecting.limb_name == BP_R_ARM ? "right arm" : "left arm"]."), SPAN_DANGER("The needle <B>painfully</B> rips out of your [affecting.limb_name == BP_R_ARM ? "right arm" : "left arm"]."))
