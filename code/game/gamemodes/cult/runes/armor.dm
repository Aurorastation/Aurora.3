...
/obj/effect/rune/armor/do_rune_action(mob/living/user, obj/O = src)
	...
	user.visible_message(SPAN_WARNING("The rune disappears with a flash of red light, and a set of armor appears on [user]..."), SPAN_CULT("You are blinded by the flash of red light! You feel the armor of the Dark One form around you."))
