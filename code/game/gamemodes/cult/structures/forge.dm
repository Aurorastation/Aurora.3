/obj/structure/cult/forge
	...
	desc_antag = "- A forge used in crafting the unholy weapons used by the armies of Nar-Sie.<br>\
	- This is a powerful forge; if you are a Cultist, you can click on this with an item in-hand to 'cultify' it.<br>\
