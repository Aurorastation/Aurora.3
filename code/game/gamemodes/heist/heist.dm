...
/datum/game_mode/heist/pre_setup()
	round_description = "An unidentified bluespace signature has slipped past the Icarus and is approaching the [SSmapping.current_map.station_type]!"
	extended_round_description = "The galaxy is a place full of dangers, even the inner colonies are not free of such scourges. \
	Raiders and pirates are a well-know threat in the inhabited space, and places such as [SSmapping.current_map.station_type]s are easy targets \
