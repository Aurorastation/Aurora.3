...
/datum/game_mode/meteor/post_setup()
	...
	alert_text = "This is an automatic warning. Your facility: [current_map.full_name] is on a collision course with a nearby asteroid belt. Estimated time until impact is: [meteor_grace_period / 1200] MINUTES. Please perform necessary actions to secure your ship or ship from the threat. Have a nice day."
