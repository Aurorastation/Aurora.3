...
/datum/game_mode/conflict/pre_setup()
	round_description = "Two underprepared teams of fools pick the same day to rob a highly valuable [SSmapping.current_map.company_short] [SSmapping.current_map.station_type]."
	. = ..()
