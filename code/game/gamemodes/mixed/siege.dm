...
/datum/game_mode/siege/pre_setup()
	round_description = "Some crewmembers are attempting to start a revolution while a mercenary strike force is approaching the [SSmapping.current_map.station_type]!"
	. = ..()
