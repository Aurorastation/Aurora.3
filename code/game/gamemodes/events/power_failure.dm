...
/proc/power_failure(var/announce = 1, var/severity = 2)
	...
	for(var/obj/structure/machinery/power/smes/buildable/S in SSmachinery.smes_units)
		if(!S.is_critical)
			S.energy_fail(rand(15 * severity,30 * severity))


	for(var/obj/structure/machinery/power/apc/C in SSmachinery.processing)
		if(!C.is_critical)
...
/proc/power_restore(var/announce = 1)
	...
	for(var/obj/structure/machinery/power/smes/S in SSmachinery.smes_units)
