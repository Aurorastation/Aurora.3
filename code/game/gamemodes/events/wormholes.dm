/proc/wormhole_event()
	spawn()
		...
		if(pick_turfs.len)
			...
			command_announcement.Announce("Space-time anomalies detected on the [current_map.station_type]. There is no additional data.", "Anomaly Alert", new_sound = 'sound/AI/spanomalies.ogg')
