...
/datum/game_mode/traitor/pre_setup()
	round_description = "There is a foreign agent or traitor on the [SSmapping.current_map.station_type]. Do not let the traitor succeed!"
	extended_round_description = "The Company's monopolistic control over the phoron supplies of Tau Ceti has marked the \
		[SSmapping.current_map.station_type] to be a highly valuable target for many competing organizations and individuals. The varied pasts \
		and experiences of your coworkers have left them susceptible to the vices and temptations of humanity. \
		Is the [SSmapping.current_map.station_type] the safe self-contained workplace you once thought it was, or has it become a playground \
