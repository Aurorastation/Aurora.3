...
/datum/game_mode/ninja/pre_setup()
	round_description = "An agent of the Spider Clan is onboard the [SSmapping.current_map.station_type]!"
	extended_round_description = "What was that?! Was that a person or did your eyes just play tricks on you? \
		...
		through the defenses of the [SSmapping.current_map.station_type] with technological capabilities eons ahead of your time. They can avoid \
		the omniscience of the AI and rival the most hardened weapons your [SSmapping.current_map.station_type] is capable of. Tread lightly and \
