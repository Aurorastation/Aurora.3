...
/datum/game_mode/changeling/pre_setup()
	round_description = "There are alien changelings on the [SSmapping.current_map.station_type]. Do not let the changelings succeed!"
	extended_round_description = "Life always finds a way. However, life can sometimes take a more disturbing route. \
		...
		the crew of the [SSmapping.current_map.station_type]. Its unique biology allows it to manipulate its own or anyone else's DNA. \
