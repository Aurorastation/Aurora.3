...
/datum/game_mode/proc/send_intercept()
	...
	for(var/mob/living/carbon/human/man in player_list) if(man.client && man.mind)
		...
		if (special_role in disregard_roles)
			...
			var/evil = 0
			if(man.client.prefs.economic_status == ECONOMIC_POOR || man.client.prefs.economic_status == ECONOMIC_UNDERPAID)
				evil = 1
		...
		else if(man.client.prefs.economic_status == ECONOMIC_POOR && prob(25))
			suspects += man
		else if(man.client.prefs.economic_status == ECONOMIC_WEALTHY || man.client.prefs.economic_status == ECONOMIC_WELLOFF)
			loyal_crew += 1
			if(prob(25))
				loyalists += man
		// Antags
...
proc/get_nt_opposed()
	...
	for(var/mob/living/carbon/human/man in player_list)
		if(man.client)
			if(man.client.prefs.economic_status == ECONOMIC_POOR)
				dudes += man
			else if(man.client.prefs.economic_status == ECONOMIC_UNDERPAID && prob(50))
				dudes += man
