/datum/game_mode/commander
	name = "commander"
	round_description = "A shadowy figure is guiding several traitors aboard the station. Do not let them succeed!"
	...
	config_tag = "commander"
	required_players = 0 // 15?
	required_enemies = 1 // should be 4
	end_on_antag_death = 1
	antag_tags = list(MODE_COMMANDER, MODE_OPERATIVE)
