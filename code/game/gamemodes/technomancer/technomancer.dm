...
/datum/game_mode/technomancer/pre_setup()
	...
	extended_round_description = "A powerful entity capable of manipulating space around them, has arrived on the [SSmapping.current_map.station_type]. \
	...
	their powers can be used for good or if their arrival foreshadows the destruction of the entire [SSmapping.current_map.station_type], or worse."
	. = ..()
