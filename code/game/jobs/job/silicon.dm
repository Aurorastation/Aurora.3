...
/datum/job/ai/equip(var/mob/living/carbon/teshari/H, var/alt_title)
		if(!H)	return 0
		return 1
...
/datum/job/ai/equip_preview(mob/living/carbon/teshari/H)
...
/datum/job/cyborg/equip(var/mob/living/carbon/teshari/H, var/alt_title)
		if(!H)	return 0
		return 1

/datum/job/cyborg/equip_preview(mob/living/carbon/teshari/H)
