...
/datum/job/officer/sci
	...
	access = list(access_security, access_brig, access_eva, access_external_airlocks, access_weapons, access_tox, access_research, access_xenoarch)
	minimal_access = list(access_security, access_eva, access_external_airlocks, access_weapons, access_tox, access_research, access_xenoarch)
	minimal_player_age = 7
