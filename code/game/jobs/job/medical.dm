...
/datum/job/officer/med
	...
	access = list (access_security, access_sec_doors, access_eva, access_weapons, access_medical, access_morgue, access_external_airlocks, access_psychiatrist, access_paramedic, access_treatment_areas)
	minimal_access = list(access_security, access_sec_doors, access_eva, access_weapons, access_medical, access_morgue, access_external_airlocks, access_psychiatrist, access_paramedic, access_treatment_areas)
