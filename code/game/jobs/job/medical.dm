...
/datum/job/doctor/equip_backpack(var/mob/living/carbon/human/H, var/alt_title)
	if(has_alt_title(H, alt_title,"Virologist"))
		bag_type = /obj/item/storage/backpack/virology
		satchel_type = /obj/item/storage/backpack/satchel_vir
		duffel_type = /obj/item/storage/backpack/duffel/med
		messenger_bag_type = /obj/item/storage/backpack/messenger/viro
		..()
...
/datum/job/chemist
	...
	bag_type = /obj/item/storage/backpack/chemistry
	satchel_type = /obj/item/storage/backpack/satchel_chem
	duffel_type = /obj/item/storage/backpack/duffel/chem
	messenger_bag_type = /obj/item/storage/backpack/messenger/chem
...
/datum/job/paramedic
	...
	equip(var/mob/living/carbon/human/H, var/alt_title)
		...
		if(has_alt_title(H, alt_title,"Emergency Medical Technician"))
			...
			H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/medical(H), slot_w_uniform)
		H.equip_to_slot_or_del(new /obj/item/storage/firstaid/adv(H), slot_l_hand)
		H.equip_to_slot_or_del(new /obj/item/storage/belt/medical/emt(H), slot_belt)
