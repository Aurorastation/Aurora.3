...
/datum/job/med_tech
	...
	access = list(access_medical, access_medical_equip, access_morgue, access_surgery, access_pharmacy, access_virology, access_eva, access_external_airlocks, access_psychiatrist, access_first_responder)
	minimal_access = list(access_medical, access_medical_equip, access_morgue, access_eva, access_external_airlocks, access_first_responder)
