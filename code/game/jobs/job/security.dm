/datum/job/hos
	...
	blacklisted_species = list(SPECIES_OFFWORLDER_HUMAN, SPECIES_ZHAN_KHAZAN_TAJARA
, SPECIES_AUTAKH_UNATHI, SPECIES_DIONA, SPECIES_HEPHAESTUS_G2_IPC, SPECIES_VAURCA_WORKER, SPECIES_VAURCA_WARRIOR)
