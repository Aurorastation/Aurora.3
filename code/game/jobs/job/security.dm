...
/datum/job/warden
	...
	minimal_access = list(access_maint_tunnels, access_security, access_eva, access_sec_doors, access_brig, access_armory, access_external_airlocks, access_weapons)
...
/datum/job/forensics
	...
	minimal_access = list(access_maint_tunnels, access_security, access_sec_doors, access_forensics_lockers, access_morgue, access_weapons)
...
/datum/job/officer
	...
	minimal_access = list(access_maint_tunnels, access_security, access_eva, access_sec_doors, access_brig, access_external_airlocks, access_weapons)
	minimal_player_age = 7
...
/datum/job/intern_sec
	...
	minimal_access = list(access_maint_tunnels, access_security, access_sec_doors)
