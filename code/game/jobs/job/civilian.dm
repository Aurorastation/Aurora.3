...
/datum/job/hydro
	...
	bag_type = /obj/item/storage/backpack/hydroponics
	satchel_type = /obj/item/storage/backpack/satchel_hyd
	duffel_type = /obj/item/storage/backpack/duffel/hyd
	messenger_bag_type = /obj/item/storage/backpack/messenger/hyd
...
/datum/job/qm
	...
	equip(var/mob/living/carbon/human/H)
		...
		switch(H.backbag)
			...
			if(3) H.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel_norm(H), slot_back)
			if(4) H.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel(H), slot_back)
			if(5) H.equip_to_slot_or_del(new /obj/item/storage/backpack/duffel(H), slot_back)
...
/datum/job/mining
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_cargo (H), slot_l_ear)
		switch(H.backbag)
			if(2) H.equip_to_slot_or_del(new /obj/item/storage/backpack/industrial(H), slot_back)
			if(3) H.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel_eng(H), slot_back)
			if(4) H.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel(H), slot_back)
			if(5) H.equip_to_slot_or_del(new /obj/item/storage/backpack/duffel/eng(H), slot_back)
		H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/miner(H), slot_w_uniform)
		H.equip_to_slot_or_del(new /obj/item/device/pda/shaftminer(H), slot_belt)
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(H), slot_shoes)
//		H.equip_to_slot_or_del(new /obj/item/clothing/gloves/black(H), slot_gloves)
		if(H.backbag == 1)
			H.equip_to_slot_or_del(new /obj/item/crowbar(H), slot_l_hand)
...
/datum/job/librarian
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(H), slot_shoes)
		H.equip_to_slot_or_del(new /obj/item/barcodescanner(H), slot_r_store)
		H.equip_to_slot_or_del(new /obj/item/storage/bag/books(H), slot_l_hand)
		return TRUE
