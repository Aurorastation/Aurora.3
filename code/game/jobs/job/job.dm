/datum/job
	...
	var/list/alt_factions = null		  // List of factions that each alt title can belong to. assoc is alt title to faction list. stays as null if no faction restriction
