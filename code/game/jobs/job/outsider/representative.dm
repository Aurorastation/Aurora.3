...
/datum/job/diplomatic_bodyguard
	...
	alt_titles = list("Civil Service Bodyguard", "National Police Officer", "AJIC Agent", "Imperial Army Trooper")
	alt_citizenships = list(
		...
		"National Police Officer" = list("People's Republic of Adhomai"),
