...
/datum/job/officer/eng
	...
	access = list(access_security, access_eva, access_external_airlocks, access_weapons, access_engine, access_construction)
	minimal_access = list(access_security, access_eva, access_external_airlocks, access_weapons, access_engine, access_construction)
	minimal_player_age = 7
