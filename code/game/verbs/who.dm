...
/client/verb/staffwho()
	...
	if(discord_bot && discord_bot.active)
		to_chat(src, span("info", "Adminhelps are also sent to Discord. If no admins are available in game try anyway and an admin on Discord may see it and respond."))
