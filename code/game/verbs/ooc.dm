...
/client/verb/ooc(msg as text)
	...
	if(!holder)
		...
		if(findtext(msg, "byond://"))
			...
			log_admin(text="[key_name(src)] has attempted to advertise in OOC: [msg]",ckey=key_name(src))
			message_admins("[key_name_admin(src)] has attempted to advertise in OOC: [msg]")
			return

	log_ooc(text="[mob.name]/[key] : [msg]",ckey=key_name(mob))
...
/client/verb/looc(msg as text)
	...
	log_ooc(text="(LOCAL) [mob.name]/[key] : [msg]",ckey=key_name(mob))
