...
/datum/antagonist/loyalists/equip(var/mob/living/carbon/human/player)
	...
	player.equip_to_slot_or_del(new /obj/item/device/announcer(player), slot_in_backpack_str)
	player.equip_to_slot_or_del(new /obj/item/device/special_uplink/rev(player, player.mind), slot_in_backpack_str)
