...
/datum/antagonist/revolutionary/create_antagonist()
	faction_welcome = "You joined a subversive organization in the crew of the [SSmapping.current_map.station_name]. United under a forward-thinking leader, you must achieve their goals."
	welcome_text = "You are a subversive seeking to demolish the current order on the [SSmapping.current_map.station_type] by whatever means possible. Recruit friends and strangers alike to bring [SSmapping.current_map.company_short]'s tyranny to an end! Or whatever your objective is."
