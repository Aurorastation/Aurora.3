...
/datum/antagonist/vampire
	...
	restricted_jobs = list("AI", "Cyborg", "Chaplain", "Chief of Security", "Captain", "Chief Engineer", "Research Director", "Chief Medical Officer", "Executive Officer", "Operations Manager")
