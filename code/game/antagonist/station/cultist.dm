...
/datum/antagonist/cultist
	...
	bantype = "cultist"
	restricted_jobs = list("Chaplain","AI", "Cyborg", "Chief of Security", "Captain", "Chief Engineer", "Research Director", "Chief Medical Officer", "Executive Officer", "Operations Manager")
