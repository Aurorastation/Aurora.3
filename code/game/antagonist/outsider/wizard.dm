...
/datum/antagonist/wizard/equip(var/mob/living/carbon/human/wizard_mob)
	...
	if(wizard_mob.backbag == 2) wizard_mob.equip_to_slot_or_del(new /obj/item/storage/backpack/wizard(wizard_mob), slot_back)
	if(wizard_mob.backbag == 3) wizard_mob.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel_wizard(wizard_mob), slot_back)
	if(wizard_mob.backbag == 4) wizard_mob.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel(wizard_mob), slot_back)
	if(wizard_mob.backbag == 5) wizard_mob.equip_to_slot_or_del(new /obj/item/storage/backpack/duffel/wizard(wizard_mob), slot_back)
	if(wizard_mob.backbag == 6) wizard_mob.equip_to_slot_or_del(new /obj/item/storage/backpack/messenger/wizard(wizard_mob), slot_back)
	...
	var/obj/item/I = new /obj/item/spellbook(get_turf(wizard_mob))
