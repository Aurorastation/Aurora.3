...
/datum/antagonist/burglar
	...
	welcome_text = "You are a Burglar, someone underequipped to deal with the ship. You will probably not survive for the whole round, so don't sweat it if you die!<br>\
