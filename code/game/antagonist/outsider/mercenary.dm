...
/datum/antagonist/mercenary/equip(var/mob/living/carbon/human/player)
	...
	player.equip_to_slot_or_del(new /obj/item/storage/belt/military(player), slot_belt)
	if(player.backbag == 2) player.equip_to_slot_or_del(new /obj/item/storage/backpack/syndie(player), slot_back)
	if(player.backbag == 3) player.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel_syndie(player), slot_back)
	if(player.backbag == 4) player.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel(player), slot_back)
	if(player.backbag == 5) player.equip_to_slot_or_del(new /obj/item/storage/backpack/duffel/syndie(player), slot_back)
	if(player.backbag == 6) player.equip_to_slot_or_del(new /obj/item/storage/backpack/messenger/syndie(player), slot_back)
