...
/datum/antagonist/technomancer
	...
	In your pockets you will find a one-time use teleport device. Use it to leave the base and go to the vessel, when you are ready. Your clothing is holographic, you should change its look before leaving."
