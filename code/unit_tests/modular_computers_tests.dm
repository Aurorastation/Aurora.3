...
/datum/unit_test/modular_computers/communicator_end_to_end/start_test()
	...
	var/obj/structure/communicator_landline/landline = new(test_turf)
	...
	TEST_ASSERT_EQUAL(landline_handpiece.communicator_tier, COMMUNICATOR_TIER_VIDEO, "The department landline has the wrong feature tier.")
