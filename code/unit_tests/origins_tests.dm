...
/datum/unit_test/cultures/start_test()
	var/failures = 0
	var/list/singleton/origin_item/culture/all_cultures = Singletons.GetSubtypeList(/singleton/origin_item/culture)
...
/datum/unit_test/origins/start_test()
	var/failures = 0
	var/list/singleton/origin_item/origin/all_origins = Singletons.GetSubtypeList(/singleton/origin_item/origin)
