...
/obj/item/device/assembly/signaler/receive_signal(datum/signal/signal)
	...
	if(machine)
		machine.visible_message("[icon2html(machine, usr)] [capitalize_first_letters(src.name)] beeps, \"<b>Beep beep!</b>\"")
	else if(!holder)
		visible_message("[icon2html(src, usr)] [capitalize_first_letters(src.name)] beeps, \"<b>Beep beep!</b>\"")
	return
