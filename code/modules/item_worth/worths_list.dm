...
//MACHINERY,
					/obj/structure/machinery/from_beyond = -3000,
					/obj/structure/machinery/mineral/unloading_machine = -50,
					/obj/structure/machinery/mining/brace = -30,
					/obj/structure/machinery/drone_fabricator = -300,
					/obj/structure/machinery/photocopier/faxmachine = -50,
					/obj/structure/machinery/papershredder = -8,
					/obj/structure/machinery/gravity_generator = -1600,
					/obj/structure/machinery/light = 25,
					/obj/structure/machinery/power/smes/buildable = -1500,
					/obj/structure/machinery/chem_master = -600,
					/obj/structure/machinery/chemical_dispenser = -500,
					/obj/structure/machinery/conveyor = 20,
					...
					/obj/structure/machinery/giga_drill = -190,
					/obj/structure/machinery/artifact = -1350,
					/obj/structure/machinery/artifact_analyser = -1190,
					/obj/structure/machinery/artifact_harvester = -1230,
					/obj/structure/machinery/artifact_scanpad = -180,
					/obj/structure/machinery/suspension_gen = -300,
					/obj/structure/machinery/keycard_auth = -10,
					/obj/structure/machinery/power/supermatter/shard = 10000,
					/obj/structure/machinery/power/supermatter = 50000,
					/obj/structure/machinery/atmospherics/pipe/simple/heat_exchanging = -100,
					/obj/structure/machinery/atmospherics/pipe = -10,
					/obj/structure/machinery/atmospherics/portables_connector = -50,
					/obj/structure/machinery/atmospherics/tvalve = -15,
					/obj/structure/machinery/atmospherics/valve = -12,
					/obj/structure/machinery/atmospherics/binary/circulator = -250,
					/obj/structure/machinery/atmospherics/binary/passive_gate = -160,
					/obj/structure/machinery/atmospherics/binary/pump = -190,
					/obj/structure/machinery/atmospherics/binary/pump/high_power = -250,
					/obj/structure/machinery/atmospherics/omni/filter = -400,
					/obj/structure/machinery/atmospherics/omni/mixer = -360,
					/obj/structure/machinery/atmospherics/unary/freezer = -600,
					/obj/structure/machinery/atmospherics/unary/heater = -600,
					/obj/structure/machinery/atmospherics/unary/outlet_injector = -230,
					/obj/structure/machinery/atmospherics/unary/vent_pump = -200,
					/obj/structure/machinery/atmospherics/unary/vent_scrubber = -230,
					/obj/structure/machinery/bodyscanner = -600,
					/obj/structure/machinery/body_scanconsole = -150,
					/obj/structure/machinery/ai_slipper = -50,
					/obj/structure/machinery/alarm = -80,
					/obj/structure/machinery/air_sensor = -80,
					/obj/structure/machinery/fabricator/autolathe = -330,
					/obj/structure/machinery/bluespacerelay = -400,
					/obj/structure/machinery/button = 10,
					/obj/structure/machinery/cablelayer = -170,
					/obj/structure/machinery/cell_charger = -9,
					/obj/structure/machinery/constructable_frame = -50,
					/obj/structure/machinery/cryopod = -300,
					/obj/structure/machinery/deployable/barrier = -50,
					/obj/structure/machinery/floodlight = -20,
					/obj/structure/machinery/floor_light = -10,
					/obj/structure/machinery/floorlayer = -150,
					/obj/structure/machinery/igniter = -30,
					/obj/structure/machinery/sparker = -50,
					/obj/structure/machinery/iv_drip = -10,
					/obj/structure/machinery/media/jukebox = -70,
					/obj/structure/machinery/mass_driver = -50,
					/obj/structure/machinery/navbeacon = -9,
					/obj/structure/machinery/newscaster = -10,
					/obj/structure/machinery/nuclearbomb = -1000,
					/obj/structure/machinery/recharger = -20,
					/obj/structure/machinery/sleeper = -400,
					/obj/structure/machinery/space_heater = -50,
					/obj/structure/machinery/ai_status_display = -60,
					/obj/structure/machinery/teleport = -1500,
					/obj/structure/machinery/camera = -70,
					/obj/structure/machinery/airlock_sensor = -80,
					/obj/structure/machinery/door/airlock = -80,
					/obj/structure/machinery/door/blast/shutters = -30,
					/obj/structure/machinery/door/blast = -100,
					/obj/structure/machinery/door/firedoor = -60,
					/obj/structure/machinery/door = -10,
					/obj/structure/machinery/door_timer = -30,
					/obj/structure/machinery/embedded_controller/radio/airlock = -60,
					/obj/structure/machinery/gibber = -60,
					/obj/structure/machinery/pipedispenser = -10,
					/obj/structure/machinery/telecomms/broadcaster = -1000,
					/obj/structure/machinery/telecomms = -700,
					/obj/structure/machinery/shower = -30,
					/obj/structure/machinery/acting/changer = -300,
					/obj/structure/machinery/computer/artillerycontrol = -140,
					/obj/structure/machinery/dnaforensics = -120,
					/obj/structure/machinery/microscope = -55,
					/obj/structure/machinery/atm = -450,
					/obj/structure/machinery/readybutton = -5,
					/obj/structure/machinery/botany/editor = -1600,
					/obj/structure/machinery/botany = -905,
					/obj/structure/machinery/seed_storage = -50,
					/obj/structure/machinery/beehive = -50,
					/obj/structure/machinery/portable_atmospherics/hydroponics/soil = 1, //its dirt,
					/obj/structure/machinery/portable_atmospherics/hydroponics = -230,
					/obj/structure/machinery/librarypubliccomp = -60,
					/obj/structure/machinery/librarycomp = -100,
					/obj/structure/machinery/libraryscanner = -100,
					/obj/structure/machinery/bookbinder = -120,
					/obj/structure/machinery = -100,
