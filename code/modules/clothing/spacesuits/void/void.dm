...
/obj/item/clothing/head/helmet/space/void
	...
	species_restricted = list("Human", "Machine", "Heavy Machine", "Zeng-Hu Mobility Frame", "Bishop Accessory Frame")
...
/obj/item/clothing/suit/space/void
	...
	species_restricted = list("Human", "Skrell", "Machine", "Heavy Machine", "Zeng-Hu Mobility Frame", "Bishop Accessory Frame")
	sprite_sheets_refit = list(
