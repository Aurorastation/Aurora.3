...
/obj/item/clothing/head/helmet/space/void/einstein
	...
	brightness_on = 6
	light_color = "#7ffbf7"
	desc_lore = "An easily recognized Einstein Engines-made PMC voidsuit piece. It is a telltale mark of corporate espionage and more often than not ends up buried with its user."
	refittable = FALSE
...
/obj/item/clothing/head/helmet/space/void/zenghu
	...
	brightness_on = 6
	light_color = "#7ffbf7"
	desc_lore = "An easily recognized Zeng-Hu Pharmaceuticals biohazard control suit helmet. Its bug-eyed goggle visor design is unique among its class, alongside cutting-edge radiation protection."
	refittable = FALSE
...
/obj/item/clothing/suit/space/void/zenghu
	...
	siemens_coefficient = 0.35
	species_restricted = list(BODYTYPE_HUMAN, BODYTYPE_IPC_INDUSTRIAL, BODYTYPE_IPC_ZENGHU, BODYTYPE_IPC_BISHOP)
	desc_lore = "An easily recognized Zeng-Hu Pharmaceuticals biohazard control suit. It is relatively fragile but has very apparent radiation shielding. Most often seen in the hands of post-disaster cleanup teams and private military contractors."
	refittable = FALSE
...
/obj/item/clothing/head/helmet/space/void/hephaestus
	...
	brightness_on = 6
	light_color = "#ffce01"
	desc_lore = "An easily recognized Hephaestus terraforming suit helmet. Its low, protruding brow and heavy plating is useful in the event you happen to be cutting down things. Mostly trees. Hopefully trees."
	refittable = FALSE
...
/obj/item/clothing/suit/space/void/hephaestus
	...
	siemens_coefficient = 0.35
	species_restricted = list(BODYTYPE_HUMAN)
	desc_lore = "An easily recognized Hephaestus terraforming suit. Used often on jungle worlds to handle local wildlife and safely deforest areas in hostile environments. It found recent popularity due to its combat effectiveness that resulted in its proliferation in the hands of Hephaestus private military."
	refittable = FALSE
...
/obj/item/clothing/head/helmet/space/void/zavodskoi
	...
	brightness_on = 6
	light_color = "#f65858"
	desc_lore = "An ominous helmet of Zavodskoi Interstellar make with its past veiled in mystery, used for high-end corporate backstabbing and secret operations."
...
/obj/item/clothing/suit/space/void/zavodskoi
	...
	siemens_coefficient = 0.35
	species_restricted = list(BODYTYPE_HUMAN)
	desc_lore = "A portable, sleek combat suit utilized in excess by Zavodskoi Interstellar private military contractors. It is known to be utilized by the company's most secretive sectors explicitly for espionage."
...
/obj/item/clothing/head/helmet/space/void/mining/himeo
	...
	desc_lore = "The Type-78A 'Fish Fur' Helmet is a nearly 80 year old design and is part of a long line of homegrown voidsuits dating to when the planet ejected Hephaestus Industries. The main reason for its long service life\
...
/obj/item/clothing/suit/space/void/mining/himeo
	...
	desc_lore = "The Type-78 'Fish Fur' Voidsuit is an aging yet popular design produced only on Himeo. The simple and affordable design means many Himeans are able to own their own spacesuits rather than have one provided to them by their employer.\
