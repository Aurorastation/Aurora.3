...
/obj/item/rig_module/chem_dispenser
	...
	charges = list(
		...
		list("traumadil",		"traumadil",		/datum/reagent/traumadil,			80),
...
/obj/item/rig_module/chem_dispenser/ninja
	...
	charges = list(
		...
		list("traumadil",		"traumadil",		/datum/reagent/traumadil,			20),
...
/obj/item/rig_module/chem_dispenser/combat
	...
	charges = list(
		...
		list("oxycordine",	"oxycordine",	/datum/reagent/oxycordine,			30),
		list("nutrients",	"glucose",		/datum/reagent/nutriment/glucose,	80),
		list("saline",		"saline",		/datum/reagent/saline,				80)
		)
...
/obj/item/rig_module/chem_dispenser/injector/paramedic //downgraded version
	...
	charges = list(
		...
		list("traumadil",		"traumadil",			/datum/reagent/traumadil,		40),
