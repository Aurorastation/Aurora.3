...
/obj/item/rig_module/vision/meson
	...
	construction_cost = list(MATERIAL_GLASS =5000,DEFAULT_WALL_MATERIAL=1500)
...
/obj/item/rig_module/vision/nvg
	...
	construction_cost = list(MATERIAL_GLASS = 5000,DEFAULT_WALL_MATERIAL = 1500, MATERIAL_URANIUM = 5000)
	construction_time = 300
