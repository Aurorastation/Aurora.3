...
/obj/item/clothing/shoes/proc/draw_knife()
	set name = "Draw Concealed Weapon"
	set desc = "Pull out your concealed weapon."
	set category = "Object"
	set src in usr
	...
	if(usr.put_in_hands(holding))
		...
		holding = null
		playsound(get_turf(src), 'sound/items/holster/tactiholsterout.ogg', 25)
	else
...
/obj/item/clothing/shoes/attackby(var/obj/item/I, var/mob/user)
	if(can_hold_knife && is_type_in_list(I, list(/obj/item/weapon/material/shard, /obj/item/weapon/material/butterfly, /obj/item/weapon/material/kitchen/utensil, /obj/item/weapon/material/hatchet/tacknife, /obj/item/weapon/material/sword/trench, /obj/item/weapon/gun/projectile/papadov)))
		if(holding)
