...
/obj/item/clothing/head/headchain
	...
	desc = "A set of luxurious chains intended to be wrapped around one’s head. They don’t seem particularly comfortable. They’re encrusted with cobalt-blue gems."
...
/obj/item/clothing/head/headchain/emerald
	...
	desc = "A set of luxurious chains intended to be wrapped around one’s head. They don’t seem particularly comfortable. They’re encrusted with emerald-green gems."
	icon_state = "emerald_headchains"
	item_state = "emerald_headchains"

/obj/item/clothing/head/headchain/ruby
	name = "ruby head chains"
	desc = "A set of luxurious chains intended to be wrapped around one’s head. They don’t seem particularly comfortable. They’re encrusted with ruby-red gems."
	icon_state = "ruby_headchains"
	item_state = "ruby_headchains"

/obj/item/clothing/head/crest
	name = "cobalt head crest"
	desc = "A solemn crest wrapping around the back of one’s head, seeming to bend in the center on multiple hinges and clip on. It’s encrusted with cobalt-blue gems."
...
/obj/item/clothing/head/crest/emerald
	...
	desc = "A solemn crest wrapping around the back of one’s head, seeming to bend in the center on multiple hinges and clip on. It’s encrusted with emerald-green gems."
	icon_state = "emerald_crest"
	item_state = "emerald_crest"

/obj/item/clothing/head/crest/ruby
	name = "ruby head crest"
	desc = "A solemn crest wrapping around the back of one’s head, seeming to bend in the center on multiple hinges and clip on. It’s encrusted with ruby-red gems."
