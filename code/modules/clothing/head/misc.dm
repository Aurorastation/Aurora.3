...
/obj/item/clothing/head/pin/flower/silversun
	...
	desc = "A Silversun dawnflower pin, named after after the same flower. This particular version is an artificial recreation, and lacks the distinctive bioluminescence of the original."
