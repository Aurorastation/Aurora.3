...
/obj/item/clothing/suit/diona/carp/emporium
	name = "sun bleached carp hide poncho"
	desc = "A poncho made up of carp hide. This one has been bleached nearly white as a result of being in space for so long."
	icon_state = "emporium_poncho"
	item_state = "emporium_poncho"

/obj/item/clothing/suit/diona/rokz
	name = "reinforced bone armor"
	desc = "A set of antiquated armor reinforced with bone."
	icon = 'icons/obj/diona_items.dmi'
	icon_state = "rokz_armor"
	item_state = "rokz_armor"
