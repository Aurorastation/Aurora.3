...
/obj/item/clothing/suit/storage/tajaran/messa
	...
	contained_sprite = TRUE
	no_overheat = TRUE
	desc_lore = "The official religious body of the S'rendarr & Messa religion  is reffered to as \"Parivara\" or roughly translated \"Family\". This branch is further split into \
...
/obj/item/clothing/suit/storage/tajaran/azubarre
	...
	contained_sprite = TRUE
	no_overheat = TRUE
	desc_lore = "The priests of Azubarre are often adored and many aspire to become one, their large flowing robes and beautiful faces often accompany carnivals, marriages, \
...
/obj/item/clothing/suit/storage/tajaran/raskara
	...
	desc_lore =  "Raskariim, commonly known as The Cult of Raskara are a prolific cult on Adhomai. The religion has been created on Adhomai but with the free commerce, a few human \
