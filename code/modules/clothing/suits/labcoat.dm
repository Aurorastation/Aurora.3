...
/obj/item/clothing/suit/storage/toggle/labcoat/nexus
	name = "nexus longcoat"
	desc = "A hybridization between a traditional labcoat and an EMT jacket, designed to be worn in lab environments while still being comfortable in the field."
