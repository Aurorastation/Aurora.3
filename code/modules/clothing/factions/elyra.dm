/obj/item/clothing/under/elyra_holo
	...
	icon = 'icons/mob/clothing/under/human/elyra/elyra_holoclothes.dmi'
...
/obj/item/clothing/under/elyra_holo/Initialize()
	for(var/option in names)
		if(!clothing_mode)
			names[option] = image('icons/mob/clothing/under/human/elyra/elyra_holoclothes.dmi', icon_state)
			clothing_mode = 1
		else
			names[option] = image('icons/mob/clothing/under/human/elyra/elyra_holoclothes.dmi', initial(icon_state) + "_[names.Find(option) - 1]")
	clothing_mode = 0
	.=..()
