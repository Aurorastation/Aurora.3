...
/obj/item/clothing/under/pmc_modsuit
	...
	desc_lore = "The proprietary PMCG Modular Fatigue Jumpsuit, quickly dubbed the modsuit, is an innovation by the recently-formed PMCG to quickly outfit its scores of new \
