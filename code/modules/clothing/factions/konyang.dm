/obj/item/clothing/under/konyang
	...
	desc_lore = "An ancient form of dress carried over from Earth by the initial Konyang colonists; the hanbok has since become a symbol of Konyang and its most iconic formalwear."
...
/obj/item/clothing/head/konyang
	...
	desc_lore = "Although traditionally made from horsehair, many different types of fabrics, including water-resistant fibres from feathers are now used."
...
/obj/item/clothing/under/konyangdress
	...
	desc_lore = "Konyanger clothes are often designed to remain both water-resistant and breathable, made of light fabrics that can \
...
/obj/item/clothing/under/konyangdresstraditional
	...
	desc_lore = "Carried over to Konyang from Earth, this dress was usually worn by shrine maidens of the Shinto faith back on Earth. \
...
/obj/item/clothing/under/konyangdresstraditional/national
	...
	desc_lore = "The colors of the traditional shrine maiden outfit on Earth were designed to evoke the spirit of its host nation. Similarly, as Shinto evolved on Konyang to explain \
