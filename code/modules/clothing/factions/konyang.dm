...
/obj/item/clothing/under/konyangdresstraditional/national
	...
	the equality of IPC and tesharis, many outfits were tailored in these new colors to represent the values of the nation, yellow representing prosperity, and blue representing the waterways \
...
/obj/item/clothing/under/konyangdresstraditional/national/vest
	...
	the colors of the flag of Konyang."
	desc_extended = "The colors of the traditional shrine maiden outfit on Earth were designed to evoke the spirit of its host nation. Similarly, as Shinto evolved on Konyang to explain \
	the equality of IPC and tesharis, many outfits were tailored in these new colors to represent the values of the nation, white representing purity, yellow representing prosperity, and blue representing the waterways \
