/obj/item/clothing/under/goldendeep
	...
	desc_fluff = "The Lux-I Golden Dress was popularised 8 years ago by Lux-Igmatic, one of the first official Golden Deep positronic citizens. Owing to its success outside of the GD fashion scene, it quickly caught on \
...
/obj/item/clothing/under/goldendeep/wrap
	...
	desc_fluff = "The casual blending of modern metallurgical methods and traditional Golden Deep fashion gives the golden wraps a strong appeal. Back when IPCs were a new concept and the designs weren't as refined as they are today, wraps were a popular clothing \
...
/obj/item/clothing/under/goldendeep/vest
	...
	desc_fluff = "With the increasing popularity of gold-effect clothing within Golden Deep society, it was only a matter of time before casual clothing lines got in on the action. Following the leak of Lux-Igmatic's methods, other corporations jumped at the \
...
/obj/item/clothing/under/goldendeep/suit
	...
	desc_fluff = "Two piece suits and skirtsuits have always been a mainstay of Golden Deep culture; representing a certain amount of gravitas inherent with the business-formal aesthetic that they embody. \
...
/obj/item/clothing/under/goldendeep/skirtsuit
	...
	desc_fluff = "Two piece suits and skirtsuits have always been a mainstay of Golden Deep culture; representing a certain amount of gravitas inherent with the business-formal aesthetic that they embody. It wasn't until 2458, however, that the golden suits \
