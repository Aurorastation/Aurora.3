...
/obj/item/clothing/glasses/hud/health/prescription/attack_self(mob/user)
	...
	user.put_in_hands(/obj/item/clothing/glasses/hud/health)
	user.put_in_hands(/obj/item/clothing/glasses/regular)
	user.drop_item(src)
	qdel(src)
...
/obj/item/clothing/glasses/hud/security/prescription/attack_self(mob/user)
	...
	playsound(src.loc, 'sound/weapons/blade_close.ogg', 50, 1)
	new /obj/item/clothing/glasses/hud/security()
	new /obj/item/clothing/glasses/regular()
	user.put_in_hands(/obj/item/clothing/glasses/hud/security)
	user.put_in_hands(/obj/item/clothing/glasses/regular)
	user.drop_item(src)
	qdel(src)
