/obj/item/clothing/under/tajaran
	...
	desc_lore = "Having direct and friendly contact with humanity, The People's Republic of Adhomai has been the most influenced by the spacer fashion. The most known \
...
/obj/item/clothing/under/tajaran/fancy
	...
	desc_lore = "While money and riches are at an all time low, the New Kingdom is symbolized by one thing, hope. While the often attacked, poor and shaggy nation is compared to \
...
/obj/item/clothing/under/tajaran/matake
	...
	desc_lore = "The priesthood of Mata'ke is comprised of only men and strangely enough, hunters. Like their patron, all priests of Mata'ke must prove themselves capable, \
...
/obj/item/clothing/under/tajaran/cosmonaut
	...
	desc_lore = "The People's Republic of Adhomai enjoys having the only militarized spaceships of all the factions on Adhomai. Initially they relied on contracting outside \
...
/obj/item/clothing/under/tajaran/cosmonaut/commissar
	...
	desc_lore = "Party Commissars are high ranking members of the Party of the Free Tajara under the Leadership of Hadii attached to army units, who ensures that soldiers and \
...
/obj/item/clothing/under/tajaran/mechanic
	...
	icon_state = "mechanic"
	item_state = "mechanic"
	desc_lore = "The quality of life for an urban dweller in Nal'tor, or any other major city, can vary considerably according to the Tajara's occupation, education and standing \
...
/obj/item/clothing/under/tajaran/raakti_shariim
	...
	desc_lore = "The Raakti Shariim (Royal Peacekeepers in Ceti Basic) are the New Kingdom of Adhomai's policing and \
...
/obj/item/clothing/under/dress/tajaran
	...
	contained_sprite = TRUE
	no_overheat = TRUE
	desc_lore = "Today the fashion that dominates Adhomai shares few similarities to the clothing of old Furs, linen, hemp, silk and other such fabrics were traded for \
