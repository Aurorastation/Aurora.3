...
/obj/item/clothing/accessory/poncho/maxtlatl
	...
	desc_lore = "The term \" maxtlatl\" was given by humanity upon seeing this due to its resemblance to ancient \
...
/obj/item/clothing/accessory/poncho/unathimantle
	...
	desc_lore = "With the expansion of the Touched Lands, the normal beasts that prowl and stalk the dunes have \
...
/obj/item/clothing/accessory/poncho/unathimantle/forest
	...
	desc_lore = "After the Contact War, the prized horns of the tul quickly vanished from the market. Nobles and \
...
/obj/item/clothing/accessory/poncho/unathimantle/mountain
	...
	desc_lore = "Hunting an arbek is no easy task. Brave Zo'saa looking to prove themselves in battle and be \
...
/obj/item/clothing/accessory/poncho/rockstone
	...
	desc_lore = "A simple drape over the shoulder is done easily; the distinguishing part between the commoners and \
