...
/obj/item/clothing/accessory/holster/utility/custodial/armpit/brown
	...
	desc_lore = "In a universe where various utility firearms and tools have become more common for diverse applications, it is important that there are ways to store them where \
