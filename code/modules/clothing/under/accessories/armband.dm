...
/obj/item/clothing/accessory/armband/tauceti
	...
	desc = "An armband tailored to look like the flag of the Republic of Biesel."
	 = "While initially adopted during the early days of the TCFL to account for a sudden increase in volunteers and a lack of uniforms, during the height of the Republic of Biesel's conflicts with the Sol Alliance,\
