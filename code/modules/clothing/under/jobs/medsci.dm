...
/obj/item/clothing/under/rank/biochemist
	desc = "It's made of a special fiber that gives special protection against biohazards. It has a biochemist rank stripe on it."
