...
/obj/item/deck/cah/black/card_text_list = list(
	...
	"_____ used ____ to create their newest invention, _____! (Pick 3)",
...
/obj/item/deck/cah/var/list/card_text_list = list(
	...
	"Racially-biased law definitions",
	...
	"Glorsh-Omega",
	"Miranda Trasen",
	"Michael 'Mightinator' Frost",
	"Aeson and Lopez-Zhang's lovechild",
	"Liqin Hsiao-Li",
	...
	"The company hiring department",
	"An IRU with an attitude problem and nothing to lose",
	...
	"Angry genetically-modified bees",
