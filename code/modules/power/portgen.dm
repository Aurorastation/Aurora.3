...
/obj/structure/machinery/power/portgen
...
/obj/structure/machinery/power/portgen/upgrade_hints(mob/user, distance, is_adjacent)
	. += ..()
	. += "Upgraded <b>capacitors</b> will increase maximum power output."

/obj/structure/machinery/power/portgen/feedback_hints(mob/user, distance, is_adjacent)
	. += ..()
	if(active)
		. += "The generator is on."
	else
...
/obj/structure/machinery/power/portgen/Initialize()
	. = ..()
	soundloop = new(src, active)

/obj/structure/machinery/power/portgen/Destroy()
	QDEL_NULL(soundloop)
	return ..()

/obj/structure/machinery/power/portgen/proc/IsBroken()
	return (stat & (BROKEN|EMPED))

/obj/structure/machinery/power/portgen/proc/HasFuel() //Placeholder for fuel check.
	return TRUE

/obj/structure/machinery/power/portgen/proc/UseFuel() //Placeholder for fuel use.
	return

/obj/structure/machinery/power/portgen/proc/DropFuel()
	return

/obj/structure/machinery/power/portgen/proc/handleInactive()
	return
...
/obj/structure/machinery/power/portgen/attack_hand(mob/user)
	if(..())
		update_icon()
		return
	if(!anchored)
...
/obj/structure/machinery/power/portgen/update_icon()
	icon_state = "[base_icon]_[active]"
	return ..()

/obj/structure/machinery/power/portgen/emp_act(severity)
	. = ..()
...
/obj/structure/machinery/power/portgen/basic/feedback_hints(mob/user, distance, is_adjacent)
	. += ..()
...
/obj/structure/machinery/power/portgen/basic/Initialize()
...
/obj/structure/machinery/power/portgen/basic/Destroy()
	DropFuel()
	return ..()

/obj/structure/machinery/power/portgen/basic/RefreshParts()
	..()
	var/temp_rating = 0
...
/obj/structure/machinery/power/portgen/basic/HasFuel()
	var/needed_sheets = power_output / time_per_sheet
	if(sheets >= needed_sheets - sheet_left)
		return TRUE

//Removes one stack's worth of material from the generator.
/obj/structure/machinery/power/portgen/basic/DropFuel()
	if(sheets)
...
/obj/structure/machinery/power/portgen/basic/UseFuel()
...
/obj/structure/machinery/power/portgen/basic/handleInactive()
...
/obj/structure/machinery/power/portgen/basic/proc/overheat()
	overheating++
	if (overheating > 60)
		explode()

/obj/structure/machinery/power/portgen/basic/emag_act(var/remaining_charges, var/mob/user)
	if (active && prob(25))
...
/obj/structure/machinery/power/portgen/basic/attackby(obj/item/attacking_item, mob/user)
	if(istype(attacking_item, sheet_path))
		...
		if(attacking_item.tool_behaviour == TOOL_WRENCH)
			...
			var/obj/structure/machinery/constructable_frame/machine_frame/new_frame = new /obj/structure/machinery/constructable_frame/machine_frame(loc)
...
/obj/structure/machinery/power/portgen/basic/attack_hand(mob/user)
	..()
	if (!anchored)
		return
	ui_interact(user)

/obj/structure/machinery/power/portgen/basic/attack_ai(mob/user)
	if(!ai_can_interact(user))
		return
	ui_interact(user)

/obj/structure/machinery/power/portgen/basic/ui_data(var/mob/user)
	var/list/data = list()
...
/obj/structure/machinery/power/portgen/basic/ui_interact(mob/user, var/datum/tgui/ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "PortableGenerator", name, 500, 560)
		ui.open()

/obj/structure/machinery/power/portgen/basic/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
...
// Runs on uranium.
//
/obj/structure/machinery/power/portgen/basic/advanced
...
/obj/structure/machinery/power/portgen/basic/advanced/UseFuel()
	//produces a tiny amount of radiation when in use
	if (prob(2 * power_output))
		SSradiation.radiate(src, 4)
	..()

/obj/structure/machinery/power/portgen/basic/advanced/explode()
...
// Runs on tritium.
//
/obj/structure/machinery/power/portgen/basic/super
...
/obj/structure/machinery/power/portgen/basic/fusion/explode()
	//a nice burst of radiation
...
/obj/structure/machinery/power/portgen/basic/fusion/feedback_hints(mob/user, distance, is_adjacent)
	. += ..()
	. += "The auxiliary tank shows [reagents.total_volume]u of liquid in it."

/obj/structure/machinery/power/portgen/basic/fusion/UseFuel()
...
/obj/structure/machinery/power/portgen/basic/fusion/update_icon()
	if(..())
		return 1
	if(power_output > max_safe_output)
		icon_state = "reactordanger"

/obj/structure/machinery/power/portgen/basic/fusion/attackby(obj/item/attacking_item, mob/user)
