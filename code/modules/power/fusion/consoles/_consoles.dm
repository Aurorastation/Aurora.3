/obj/structure/machinery/computer/fusion
...
/obj/structure/machinery/computer/fusion/Initialize()
	AddComponent(/datum/component/local_network_member, initial_id_tag)
	. = ..()

/obj/structure/machinery/computer/fusion/proc/get_local_network()
...
/obj/structure/machinery/computer/fusion/attackby(obj/item/attacking_item, mob/user)
...
/obj/structure/machinery/computer/fusion/attack_hand(mob/user)
	. = ..()
	if(.)
		return
...
/obj/structure/machinery/computer/fusion/ui_data(mob/user)
	var/datum/component/local_network_member/fusion = GetComponent(/datum/component/local_network_member)
...
/obj/structure/machinery/computer/fusion/ui_interact(mob/user, datum/tgui/ui)
	var/cancelled = FALSE
