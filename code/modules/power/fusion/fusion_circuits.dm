/obj/item/circuitboard/fusion/core_control
	...
	build_path = /obj/structure/machinery/computer/fusion/core_control
	origin_tech = list(TECH_DATA = 4, TECH_ENGINEERING = 4)

/obj/item/circuitboard/kinetic_harvester
	name = T_BOARD("kinetic harvester")
	build_path = /obj/structure/machinery/kinetic_harvester
...
/obj/item/circuitboard/fusion_fuel_compressor
	...
	build_path = /obj/structure/machinery/fusion_fuel_compressor
	board_type = BOARD_MACHINE
...
/obj/item/circuitboard/fusion_fuel_control
	...
	build_path = /obj/structure/machinery/computer/fusion/fuel_control
	origin_tech = list(TECH_DATA = 4, TECH_ENGINEERING = 4)

/obj/item/circuitboard/gyrotron_control
	name = T_BOARD("gyrotron controller")
	build_path = /obj/structure/machinery/computer/fusion/gyrotron
	origin_tech = list(TECH_DATA = 4, TECH_ENGINEERING = 4)

/obj/item/circuitboard/fusion_core
	name = T_BOARD("fusion core")
	build_path = /obj/structure/machinery/power/fusion_core
	board_type = BOARD_MACHINE
...
/obj/item/circuitboard/fusion_injector
	...
	build_path = /obj/structure/machinery/fusion_fuel_injector
	board_type = BOARD_MACHINE
	origin_tech = list(TECH_POWER = 3, TECH_ENGINEERING = 4, TECH_MATERIAL = 4)
	req_components = list(
							"/obj/item/stock_parts/manipulator/pico" = 2,
...
/obj/item/circuitboard/gyrotron
	...
	build_path = /obj/structure/machinery/power/emitter/gyrotron
	board_type = BOARD_MACHINE
