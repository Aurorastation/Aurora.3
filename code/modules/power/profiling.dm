...
/client/proc/toggle_power_update_profiling()
	...
	if(enable_power_update_profiling)
		...
		log_admin(text="[key_name(src)] toggled area power update profiling off.",admin_key=key_name(src))
	else
		...
		log_admin(text="[key_name(src)] toggled area power update profiling on.",admin_key=key_name(src))
