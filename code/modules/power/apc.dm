...
ABSTRACT_TYPE(/obj/machinery/power/apc)
	...
	desc_antag = "- This can be emagged to unlock it; it will cause the APC to have a blue error screen.<br>\
	- Wires can be pulsed remotely with a signaler attached to it.<br>\
