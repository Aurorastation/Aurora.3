	...
	switch(screenstate)
		if(0)
			...
			if(src.arcanecheckout)
				...
				user.visible_message("<b>\The [user]</b> stares at the blank screen for a few moments, \his expression frozen in fear. When \he finally awakens from it, \he looks a lot older.", range = 2)
