/datum/admins/Topic(href, href_list)
	...
	// Are now moved to banjob.dm. For use with the newer system.
		...
		if(istype(M, /mob/living/carbon/human))
			...
			observer.equip_to_slot_or_del(new /obj/item/clothing/shoes/sneakers/black(observer), slot_shoes_str)
		M.Paralyse(5)
		sleep(5)
		...
		H.equip_to_slot_or_del( new /obj/item/reagent_containers/food/snacks/cookie(H), slot_l_hand_str )
		if(!(istype(H.l_hand,/obj/item/reagent_containers/food/snacks/cookie)))
			H.equip_to_slot_or_del( new /obj/item/reagent_containers/food/snacks/cookie(H), slot_r_hand_str )
