/client/proc/hide_most_verbs()//Allows you to keep some functionality while hiding some verbs
	...
	SSadmin_verbs.update_visibility_flag(src, ADMIN_VERB_VISIBLITY_FLAG_HIDEABLE, FALSE)
...
/client/proc/hide_verbs()
	...
	SSadmin_verbs.hide_all_verbs(src)
...
/client/proc/show_verbs()
	...
	SSadmin_verbs.update_visibility_flag(src, ADMIN_VERB_VISIBLITY_FLAG_HIDEABLE, TRUE)
...
/client/proc/check_ai_laws()
	...
	else if(isstoryteller(src.mob))
		output_ai_laws_to_user(src.mob)
