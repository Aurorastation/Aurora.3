...
/client/proc/cmd_admin_dress()
	...
	switch(dresscode)
		...
		if("nanotrasen representative")
			...
			var/obj/item/device/pda/heads/pda = new(M)
			pda.owner = M.real_name
			pda.ownjob = "NanoTarsen Navy Representative"
			pda.name = "PDA-[M.real_name] ([pda.ownjob])"
			...
			W.assignment = "NanoTarsen Navy Representative"
			W.registered_name = M.real_name
			M.equip_to_slot_or_del(W, slot_wear_id)
		...
		if("nanotrasen officer")
			...
			var/obj/item/device/pda/heads/pda = new(M)
			pda.owner = M.real_name
			pda.ownjob = "NanoTarsen Navy Officer"
			pda.name = "PDA-[M.real_name] ([pda.ownjob])"
			...
			W.assignment = "NanoTarsen Navy Officer"
			W.registered_name = M.real_name
			M.equip_to_slot_or_del(W, slot_wear_id)
		...
		if("nanotrasen captain")
			...
			var/obj/item/device/pda/heads/pda = new(M)
			pda.owner = M.real_name
			pda.ownjob = "NanoTarsen Navy Captain"
			pda.name = "PDA-[M.real_name] ([pda.ownjob])"
			...
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "NanoTarsen Navy Captain"
			W.registered_name = M.real_name
			M.equip_to_slot_or_del(W, slot_wear_id)
