...
/client/proc/cmd_admin_dress()
	...
	switch(dresscode)
		...
		if ("tournament standard red","tournament standard green") //we think stunning weapon is too overpowered to use it on tournaments. --rastaf0
			...
			M.equip_to_slot_or_del(new /obj/item/gun/energy/rifle/pulse/destroyer(M), slot_r_hand)
			M.equip_to_slot_or_del(new /obj/item/material/knife(M), slot_l_hand)
		...
		if ("tournament gangster") //gangster are supposed to fight each other. --rastaf0
			...
			M.equip_to_slot_or_del(new /obj/item/cloaking_device(M), slot_r_store)
		...
		if ("tournament chef") //Steven Seagal FTW
			...
			M.equip_to_slot_or_del(new /obj/item/material/knife(M), slot_l_hand)
			M.equip_to_slot_or_del(new /obj/item/material/knife(M), slot_r_store)
			M.equip_to_slot_or_del(new /obj/item/material/knife(M), slot_s_store)
		...
		if("tunnel clown")//Tunnel clowns rule!
			...
			var/obj/item/material/twohanded/fireaxe/fire_axe = new(M)
		...
		if("masked killer")
			...
			M.equip_to_slot_or_del(new /obj/item/material/knife(M), slot_l_store)
		...
		if("nanotrasen officer")
			...
			M.equip_to_slot_or_del(pda, slot_r_store)
			M.equip_to_slot_or_del(new /obj/item/clothing/glasses/sunglasses(M), slot_l_store)
			M.equip_to_slot_or_del(new /obj/item/gun/energy/pistol(M), slot_belt)
		...
		if("protection detail")
			...
			M.equip_to_slot_or_del(new /obj/item/gun/energy/gun(M.back), slot_in_backpack)
			...
			M.equip_to_slot_or_del(new /obj/item/gun/energy/pistol(M.back), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/beret/centcom/officer(M), slot_head)
		...
		if("leading trooper")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/glasses/sunglasses/sechud(M), slot_glasses)
			M.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/gun/energy/gun/nuclear(M.back), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/clothing/accessory/holster/hip(M.back), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/gun/energy/gun(M.back), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/beret/centcom/officer(M), slot_head)
		...
		if("ert commander")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/glasses/sunglasses/sechud(M), slot_glasses)
			M.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/storage/fancy/cigar(M.back), slot_in_backpack)
		...
		if("odin security")
			...
			M.equip_to_slot_or_del(new /obj/item/gun/projectile/automatic/x9(M.back), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/ammo_magazine/c45x(M.back), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/ammo_magazine/c45x(M.back), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/clothing/accessory/holster/hip(M.back), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/gun/energy/gun(M.back), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/handcuffs/ziptie(M), slot_r_store)
			M.equip_to_slot_or_del(new /obj/item/grenade/chem_grenade/gas(M), slot_l_store)
			M.equip_to_slot_or_del(new /obj/item/shield/riot/tact(M), slot_l_hand)
		...
		if("special ops officer")
			...
			M.equip_to_slot_or_del(new /obj/item/gun/energy/pulse/pistol(M), slot_belt)
			M.equip_to_slot_or_del(new /obj/item/flame/lighter/zippo(M), slot_r_store)
			M.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel(M), slot_back)
		...
		if("blue wizard")
			...
			M.equip_to_slot_or_del(new /obj/item/teleportation_scroll(M), slot_r_store)
			M.equip_to_slot_or_del(new /obj/item/spellbook(M), slot_r_hand)
			M.equip_to_slot_or_del(new /obj/item/staff(M), slot_l_hand)
