/client/proc/cmd_admin_say(msg as text)
	...
	log_admin(text="ADMIN: [key_name(src)] : [msg]",admin_key=key_name(src))
...
/client/proc/cmd_mod_say(msg as text)
	...
	msg = sanitize(msg)
	log_admin(text="MOD: [key_name(src)] : [msg]",admin_key=key_name(src))
...
/client/proc/cmd_dev_say(msg as text)
	...
	log_admin(text="DEV: [key_name(src)] : [msg]",admin_key=key_name(src))
...
/client/proc/cmd_cciaa_say(msg as text)
	...
	log_admin(text="CCIASAY: [key_name(src)] : [msg]",admin_key=key_name(src))
