/client/proc/configure_access_control()
	...
	data += "Currently [world.visibility ? "<span class='good'>VISIBLE</span>" : "<span class='warning'>HIDDEN</span>"]. <a href='?_src_=holder;access_control=hub'>Toggle</a><br><hr>"
	...
	data += "<li>New players: [config.access_deny_new_players ? "<span class='warning'>DENIED</span>" : "<span class='good'>ALLOWED</span>"]. <a href='?_src_=holder;access_control=new_players;'>Toggle</a></li>"
	...
	data += "<li>Guests [(config.guests_allowed || config.external_auth) ? "<span class='good'>CAN</span>" : "<span class='warning'>CAN NOT</span>"] join.</li>"
	data += "<li>Guests [config.guests_allowed ? "<span class='good'>CAN</span>" : "<span class='warning'>CAN NOT</span>"] play. <a href='?_src_=holder;access_control=guest;'>Toggle</a></li>"
	data += "<li>External authetification: [config.external_auth ? "<span class='good'>ENABLED</span>" : "<span class='warning'>DISABLED</span>"]. <a href='?_src_=holder;access_control=external_auth;'>Toggle</a></li>"
	data += "</ul>"
