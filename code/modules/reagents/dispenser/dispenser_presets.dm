...
/obj/machinery/chemical_dispenser/bar_soft/full
	spawn_cartridges = list(
			...
			/obj/item/reagent_containers/chem_disp_cartridge/ice_tea,
			/obj/item/reagent_containers/chem_disp_cartridge/comet_cola,
			/obj/item/reagent_containers/chem_disp_cartridge/lemon_twist,
			/obj/item/reagent_containers/chem_disp_cartridge/cherry_blossom,
			/obj/item/reagent_containers/chem_disp_cartridge/stellar_jolt,
			/obj/item/reagent_containers/chem_disp_cartridge/oj_dash,
			/obj/item/reagent_containers/chem_disp_cartridge/tonic_water,
			/obj/item/reagent_containers/chem_disp_cartridge/soda_water,
			/obj/item/reagent_containers/chem_disp_cartridge/sugar,
			...
			/obj/item/reagent_containers/chem_disp_cartridge/getmore_root_beer
		)
