...
/decl/reagent/alcohol/gargleblaster
	...
	glass_desc = "Does... does this mean that Arthur and Ford are on the Crew? Oh joy."
	glass_center_of_mass = list("x"=17, "y"=6)
...
/decl/reagent/alcohol/manhattan_proj
	...
	description = "A scientist's drink of choice, for pondering ways to blow up your lab."
	color = "#ff3300"
	strength = 30
	druggy = 30
	...
	glass_desc = "A scientist's drink of choice, for thinking how to blow up your lab."
	glass_center_of_mass = list("x"=17, "y"=8)
