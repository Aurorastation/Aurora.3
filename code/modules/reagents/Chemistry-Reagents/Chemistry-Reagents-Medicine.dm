...
/decl/reagent/sanasomnum/affect_chem_effect(var/mob/living/carbon/M, var/alien, var/removed, var/datum/reagents/holder)
	...
	if(.)
		...
		M.add_chemical_effect(CE_BLOODRESTORE, 20)
		M.add_chemical_effect(CE_BLOODCLOT, 20)
		M.add_chemical_effect(CE_BRAIN_REGEN, 20)
		M.add_chemical_effect(CE_OXYGENATED, 20)
		M.add_chemical_effect(CE_ANTITOXIN, 20)
