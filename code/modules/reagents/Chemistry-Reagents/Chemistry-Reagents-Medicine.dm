...
/datum/reagent/mental/hextrasenil
	name = "Hextrasenil"
	id = "hextrasenil"
	description = "Hextrasenil is an experimental, super strength antipsychotic medication intended to treat tourettes, split personality disorder, and bipolar disorder. Side effects include pacifism, and withdrawl effects include tourettes."
	reagent_state = LIQUID
	color = "#44FFFF"
