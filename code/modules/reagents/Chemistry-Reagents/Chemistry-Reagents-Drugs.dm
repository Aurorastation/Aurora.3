...
/datum/reagent/guwan_painkillers
	...
	description = "An ancient tribal Unathi narcotic based on the outer gel layer of the seeds of poisonous flower. The chemical itself acts as a very potent omni-healer when consumed, however as the chemical metabolizes, it causes immense and cripling pain."
	reagent_state = LIQUID
	color = "#FFFF44"
