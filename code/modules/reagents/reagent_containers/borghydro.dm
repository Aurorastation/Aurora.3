...
/obj/item/reagent_containers/borghypo/medical
	reagent_ids = list(/datum/reagent/bicaridine, /datum/reagent/kelotane, /datum/reagent/dylovene, /datum/reagent/dexalin, /datum/reagent/norepinephrine, /datum/reagent/traumadil, /datum/reagent/thetamycin)

/obj/item/reagent_containers/borghypo/rescue
	reagent_ids = list(/datum/reagent/tricordrazine, /datum/reagent/norepinephrine, /datum/reagent/traumadil, /datum/reagent/adrenaline)
