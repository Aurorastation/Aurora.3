/obj/item/weapon/reagent_containers/borghypo
	...
	var/list/reagent_ids = list("tricordrazine", "inaprovaline", "thetamivir")
...
/obj/item/weapon/reagent_containers/borghypo/medical
	reagent_ids = list("bicaridine", "kelotane", "anti_toxin", "dexalin", "inaprovaline", "tramadol", "thetamivir", "methicillin")
