...
/obj/item/reagent_containers/pill
	...
	attack(mob/M as mob, mob/user as mob, def_zone)
		...
		if(M == user)
			...
			user.attack_log += "\[[time_stamp()]\] <font color='red'>Fed [name] to [key_name(M)] Reagents: [contained]</font>"
	...
	afterattack(obj/target, mob/user, proximity)
		...
		if(proximity && target.is_open_container() && target.reagents)
			...
			user.attack_log += "\[[time_stamp()]\] <font color='red'>Spiked \a [target] with a pill. Reagents: [reagentlist()]</font>"
