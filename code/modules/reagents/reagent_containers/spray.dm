...
/obj/item/weapon/reagent_containers/spray/afterattack(atom/A as mob|obj, mob/user as mob, proximity)
	...
	if(reagents.has_reagent("sacid"))
		...
		log_game(text="[key_name(user)] fired sulphuric acid from \a [src].",ckey=key_name(user))
	if(reagents.has_reagent("pacid"))
		message_admins("[key_name_admin(user)] fired Polyacid from \a [src].")
		log_game(text="[key_name(user)] fired Polyacid from \a [src].",ckey=key_name(user))
	if(reagents.has_reagent("lube"))
		message_admins("[key_name_admin(user)] fired Space lube from \a [src].")
		log_game(text="[key_name(user)] fired Space lube from \a [src].",ckey=key_name(user))
	return
