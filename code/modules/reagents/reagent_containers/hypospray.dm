...
/obj/item/reagent_containers/hypospray/autoinjector/stimpack
	name = "stimpack"
	desc = "A simple chemical cocktail of hyperzine and traumadil designed to boost efficiency by 6,000% (estimated). Hoo-rah!"
	volume = 20
	amount_per_transfer_from_this = 20

	reagents_to_add = list(/datum/reagent/hyperzine = 12, /datum/reagent/traumadil = 8)
...
/obj/item/reagent_containers/hypospray/autoinjector/survival
	...
	reagents_to_add = list(/datum/reagent/tricordrazine = 15, /datum/reagent/norepinephrine = 5, /datum/reagent/dexalin/plus = 5, /datum/reagent/oxycordine = 5, /datum/reagent/mental/mefylthenidate = 5)
...
/obj/item/reagent_containers/hypospray/combat
	...
	reagents_to_add = list(/datum/reagent/oxycordine = 5, /datum/reagent/synaptizine = 5, /datum/reagent/hyperzine = 5, /datum/reagent/arithrazine = 5)