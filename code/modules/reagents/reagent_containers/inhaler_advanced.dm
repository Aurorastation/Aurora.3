...
/obj/item/weapon/reagent_containers/personal_inhaler_cartridge/bluespace
	...
	desc = "An experimental bluespace inhaler cartridge. It has enough areosal for 60 units of reagents. The container must be activated to mix areosal with reagents inside."
