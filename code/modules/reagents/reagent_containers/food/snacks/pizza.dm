...
/obj/item/reagent_containers/food/snacks/sliceable/pizza/deepdish/mendell
	...
	desc = "If a pizza place anywhere in the universe has a sign reading 'mendell style pizza' and it doesn't have bell peppers and anchovies on it, you need to leave."
