...
/obj/item/reagent_containers/food/snacks/fries/on_reagent_change()
	...
	if(reagents.has_reagent(/singleton/reagent/nutriment/garlicsauce))
	...
	if(reagents.has_reagent(/singleton/reagent/nutriment/barbecue))
	...
	if(reagents.has_reagent(/singleton/reagent/nutriment/sweet_chili))
		name = "fries with sweet chili sauce"
		desc = "A plate of fries giving off those low-end mall food court vibes."
		icon_state = "fries_redsauce"
