...
#define DRINK_LORE_GETMORE  "This drink is made by Getmore Corporation, a subsidiary of NanoTrasen. It mostly specializes in fast food and consumer food products, \
...
#define DRINK_LORE_ZENGHU    "This drink is made by Zeng-Hu Pharmaceuticals, a trans-stellar medical research and pharmaceutical conglomerate that has heavy ties with Skrell. \
							   With a big genetics and xenobiology division, it has also revolutionized the production of some old Terran alcohol."

#define DRINK_LORE_SILVERPORT "This drink is made by Silverport Quality Brand, an Idris subsidiary that focuses on production of expensive, extremely high-quality drinks. \
...
/obj/item/reagent_containers/food/drinks/bottle/victorygin
	...
	center_of_mass = list("x"=16, "y"=4)
	desc_lore = "Considered the official drink of the People's Republic of Adhomai, Victory Gin was created to celebrate the end of the revolution. It is commonly found in NanoTrasen's \
...
/obj/item/reagent_containers/food/drinks/bottle/vodka/mushroom
	...
	desc_lore = "Vodka made from mushrooms is a local favourite on Himeo, due to the ease with which mushrooms can be grown under the planet's surface. This bottle is \
...
/obj/item/reagent_containers/food/drinks/bottle/bitters
	...
	desc_lore= "This drink is made by Nojosuru Foods, a subsidiary of Zeng-Hu Pharmaceuticals, founded on Earth in 2252. \
...
/obj/item/reagent_containers/food/drinks/bottle/messa_mead
	...
	center_of_mass = list("x" = 16,"y" = 5)
	desc_lore = "A fermented alcoholic drink made from earthen-root juice and Messa's tears leaves. It has a relatively low alcohol content and characteristic honey flavor. \
...
/obj/item/reagent_containers/food/drinks/bottle/sake
	...
	desc_lore = "Brewed in Nojosuru's facilities in Akita Prefecture, Japan, Shokyodo Sake is marketed as a premium good reflecting its lineage from Earth. \
...
/obj/item/reagent_containers/food/drinks/bottle/soju
	...
	desc_lore = "While most commonly associated with Konyang, soju can be found throughout the Sol Alliance thanks to the inexpensive cost of producing it and a successful \
...
/obj/item/reagent_containers/food/drinks/bottle/makgeolli
	...
	desc_lore = "Doctor Gyeong Kyung, PhD., is considered to be one of the Point Verdant Terraneus Institute of AI Research's premiere scholars, and is commonly seen at robotics \
...
/obj/item/reagent_containers/food/drinks/bottle/small/khlibnyz
	...
	icon_state = "khlibnyz"
	center_of_mass = list("x" = 16,"y" = 5)
	desc_lore = "A fermented beverage produced from Adhomian bread. Herbs, fruits, and tree sap can be added for flavoring. It is considered a non-alcoholic drink by Adhomian standards \
...
/obj/item/reagent_containers/food/drinks/bottle/shyyrkirrtyr_wine
	...
	center_of_mass = list("x" = 16,"y" = 5)
	desc_lore = "An alcoholic made by infusing a whole Shyyr Kirr'tyr in Dirt Berries or Earthen-Root spirit. The Water Snake Devil's poison is neutralized by ethanol, making the \
...
/obj/item/reagent_containers/food/drinks/bottle/nmshaan_liquor
	...
	center_of_mass = list("x" = 16,"y" = 5)
	desc_lore = "An alcoholic drink manufactured from the fruit of the Nm'shaan plant. It usually has a high level of alcohol by volume. Nm'shaan liquor was once reserved for the \
...
/obj/item/reagent_containers/food/drinks/bottle/small/midynhr_water
	...
	center_of_mass = list("x" = 16,"y" = 5)
	desc_lore = "A soft drink based on Yve'kha's honey and tree syrups. The drink has a creamy consistency and is served cold from the tap of traditional soda fountains. Native to \
...
/obj/item/reagent_containers/food/drinks/bottle/veterans_choice
	...
	center_of_mass = list("x" = 16,"y" = 5)
	desc_lore = "A cocktail consisting of Messa's Mead and gunpowder. Supposedly originated among the ranks of the Liberation Army as an attempt to spice up the mead, the cocktail \
...
/obj/item/reagent_containers/food/drinks/bottle/treebark_firewater
	...
	center_of_mass = list("x" = 16,"y" = 5)
	desc_lore = "High-content alcohol distilled from Earthen-Root or Blizzard Ears. Tree bark is commonly added to the drink to give it a distinct flavor. The firewater's origins can \
...
/obj/item/reagent_containers/food/drinks/bottle/darmadhir_brew
	...
	center_of_mass = list("x" = 16,"y" = 5)
	desc_lore = "A famous variation of the Nm'shaan Liquor; it is described as one of Adhomai's finest spirits. It is produced solely by a small family-owned brewery in Miran'mir. Its \
...
/obj/item/reagent_containers/food/drinks/bottle/pulque
	...
	desc_lore = "Don Augusto's pulqlueria is a famous saloon in Lago de Abundancia, known for its quality pulque. After Idris invested in the city, the family-owned business became part of the \
...
/obj/item/reagent_containers/food/drinks/bottle/vintage_wine //can't make it a child of wine, or else reagents double-fill
	...
	desc_lore = "Small-batch wines produced by local, independent wineries are highly sought-after by those who can afford them. They are considered highly-collectable items \
