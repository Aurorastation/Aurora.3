...
/obj/item/reagent_containers/food/drinks/cans/adhomai_milk
	...
	icon_state = "milk_can"
	center_of_mass = list("x"=16, "y"=10)
	desc_lore = "Fermend fatshouters milk is a drink that originated among the nomadic populations of Rhazar'Hrujmagh, and it has spread to the rest of Adhomai."
...
/obj/item/reagent_containers/food/drinks/cans/hrozamal_soda
	...
	desc_lore = "Hro'zamal Soda is a soft drink made from the seed's powder of a plant native to Hro'zamal, the sole Hadiist colony. While initially consumed as a herbal tea by the \
...
/obj/item/reagent_containers/food/drinks/cans/peach_soda
	...
	desc_lore = "The rehabilitating environment of Xanu has allowed for small-scale agriculture to bloom. Xanu Rush! Is the number one Coalition soda, despite its dull taste."
