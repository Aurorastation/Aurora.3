...
/obj/item/reagent_containers/food/snacks/attackby(obj/item/W, mob/living/user)
	...
	if(istype(W,/obj/item/material/kitchen/utensil))
		...
		if(istype(W,/obj/item/material/kitchen/utensil/fork)&&(is_liquid))
			...
			playsound(user.loc, /decl/sound_category/generic_pour_sound, 10, 1)
			return
		else
			if(U.scoop_food)
				if(!U.reagents)
...
/obj/item/reagent_containers/food/snacks/seaweed
	...
	desc_lore = "Go-Go Gwok! is one of the most unusual brands on Konyang, as it is owned by an IPC rather than a human. Gwok-0783, originally produced by Terraneus Diagnostics as a baseline hydroponicist and now \
...
/obj/item/reagent_containers/food/snacks/clam
	...
	icon_state = "clam"
	bitesize = 2
	desc_lore = "Fishing and shellfish has a part in the diet of the population at the coastal areas, even if the ice can be an obstacle to most experienced fisherman. \
...
/obj/item/reagent_containers/food/snacks/tajaran_bread
	...
	reagents_to_add = list(/decl/reagent/nutriment = 5)
	reagent_data = list(/decl/reagent/nutriment = list("bread" = 2))
	desc_lore = "While the People's republic territory includes several different regional cultures, it is possible to find common culinary traditions among its population. \
...
/obj/item/reagent_containers/food/snacks/soup/earthenroot
	...
	bitesize = 2
	reagents_to_add = list(/decl/reagent/nutriment = 4)
	desc_lore = "The Earth-Root soup is a common sight on the tables, of all social sectors, in the Northern Harr'masir. Prepared traditionally with water, Earth-Root and \
...
/obj/item/reagent_containers/food/snacks/stew/tajaran
	...
	reagent_data = list(/decl/reagent/nutriment = list("sweetness" = 2))
	desc_lore = "Traditional adhomian stews are made with diced vegetables, such as Nif-Berries, and meat, Snow Strider is commonly used by the rural population, while \
...
/obj/item/reagent_containers/food/snacks/dirt_roast
	...
	desc_lore = "A traditional snack consisting of oven-roasted dirtberries covered in a mixture of spice and caramel. These crunchy fruits are usually sold at outdoor festivals and events and are enjoyed for their warming effect and pleasant taste."
	filling_color = "#BD8939"
...
/obj/item/reagent_containers/food/snacks/sliceable/zkahnkowafull
	...
	desc_lore = "A canned variety of the Fatshouter Bloodpudding, known for its low-fat content and lighter color. It was created shortly after the First Revolution to ease the food shortage after the conflict. Its low cost and nutritious value allowed it to become a staple of the Hadiist diet."
	filling_color = "#BD8939"
...
/obj/item/reagent_containers/food/snacks/hardbread
	...
	filling_color = "#BD8939"
	desc_lore = "The adhomian hard bread is type of tajaran bread, made from Blizzard Ears's flour, water and spice, usually basked in the shape of a loaf. \
...
/obj/item/storage/box/fancy/vkrexitaffy
	...
	desc_lore = "V'krexi, while edible, hold no nutritional value, either for humans or Vaurca. The V'krexi meat was mostly neglected until human food-processing techniques were introduced to the Zo'ra Hive."
	icon = 'icons/obj/food.dmi'
