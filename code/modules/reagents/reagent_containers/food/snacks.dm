...
//obj/item/reagent_containers/food/snacks/xenoburger/Initialize()		//Don't mess with this. And always use Full Path Structure
//	. = ..()															//Same here.
...
/obj/item/reagent_containers/food/snacks/goldenegg/Initialize()
	. = ..()
...
/obj/item/reagent_containers/food/snacks/donkpocket/cook()
	..()
	if (!warm)
		heat()
...
/obj/item/reagent_containers/food/snacks/telebacon/Initialize()
	. = ..()
	reagents.add_reagent("nutriment", 4)
	baconbeacon = new /obj/item/device/radio/beacon/bacon(src)

/obj/item/reagent_containers/food/snacks/telebacon/On_Consume()
	if(!reagents.total_volume)
		baconbeacon.loc = usr
...
/obj/item/reagent_containers/food/snacks/monkeycube/attack_self(mob/user as mob)
	...
	On_Consume(var/mob/M)
		...
		if (istype(M, /mob/living/carbon/human))
			...
			var/obj/item/surprise = new/obj/item/weapon(M)
...
/obj/item/reagent_containers/food/snacks/pudding/Initialize()
	. = ..()
	bitesize = 2
...
/obj/item/reagent_containers/food/snacks/tofubreadslice/filled/Initialize()
	. = ..()
	bitesize = 2
...
/obj/item/reagent_containers/food/snacks/carrotcakeslice/filled
	nutriment_desc = list("cake" = 5, "sweetness" = 5, "carrot" = 5)
	nutriment_amt = 5

/obj/item/reagent_containers/food/snacks/carrotcakeslice/filled/Initialize()
	. = ..()
	reagents.add_reagent("imidazoline", 1)
	bitesize = 2
...
/obj/item/reagent_containers/food/snacks/braincakeslice/filled
	nutriment_desc = list("cake" = 2, "sweetness" = 2, "slime" = 3)
	nutriment_amt = 1

/obj/item/reagent_containers/food/snacks/braincakeslice/filled/Initialize()
	. = ..()
	reagents.add_reagent("protein", 5)
...
/obj/item/reagent_containers/food/snacks/cheesecakeslice/filled
	nutriment_desc = list("cake" = 5, "cream" = 5)
	nutriment_amt = 2

/obj/item/reagent_containers/food/snacks/cheesecakeslice/filled/Initialize()
	. = ..()
	reagents.add_reagent("cheese", 3)
	bitesize = 2
...
/obj/item/reagent_containers/food/snacks/sliceable/plaincake/Initialize()
	. = ..()
...
/obj/item/reagent_containers/food/snacks/plaincakeslice/filled
...
/obj/item/reagent_containers/food/snacks/orangecakeslice/filled
...
/obj/item/reagent_containers/food/snacks/limecakeslice/filled
...
/obj/item/reagent_containers/food/snacks/lemoncakeslice/filled
...
/obj/item/reagent_containers/food/snacks/chocolatecakeslice/filled
...
/obj/item/reagent_containers/food/snacks/birthdaycakeslice/filled
	nutriment_desc = list("cake" = 5, "sweetness" = 5)
	nutriment_amt = 4

/obj/item/reagent_containers/food/snacks/birthdaycakeslice/filled/Initialize()
	. = ..()
	reagents.add_reagent("sprinkles", 2)
	bitesize = 3
...
/obj/item/reagent_containers/food/snacks/applecakeslice/filled
...
/obj/item/reagent_containers/food/snacks/koissoup/Initialize()
	. = ..()
