/datum/export/phoron_canister
	...
	export_types = list(/obj/structure/machinery/portable_atmospherics/canister)
...
/datum/export/phoron_canister/applies_to(obj/structure/machinery/portable_atmospherics/canister/O, contr, emag)
	if(!..())
		return FALSE
	if(!istype(O))
		return FALSE
