...
STOCK_ITEM_COMMON(smokes, 2)
	new /obj/item/flame/lighter/random(L)
	if (prob(20))
		new /obj/item/storage/box/fancy/cigarettes/cigar(L)
		new /obj/item/storage/box/fancy/cigarettes/cigar(L)
	else
		new /obj/item/storage/box/fancy/cigarettes/blank(L)
		new /obj/item/storage/box/fancy/cigarettes/blank(L)
		if (prob(50))
			new /obj/item/storage/box/fancy/cigarettes/dromedaryco(L)
			new /obj/item/storage/box/fancy/cigarettes/dromedaryco(L)
			new /obj/item/storage/box/fancy/cigarettes/dromedaryco(L)
			new /obj/item/storage/box/fancy/cigarettes/dromedaryco(L)
		else
			new /obj/item/storage/box/fancy/cigarettes(L)
			new /obj/item/storage/box/fancy/cigarettes(L)
			new /obj/item/storage/box/fancy/cigarettes(L)
			new /obj/item/storage/box/fancy/cigarettes(L)
