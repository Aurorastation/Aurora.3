...
/datum/bounty/item/assistant/donut
	name = "Donuts"
	description = "CentCom's security forces are demoralized. Ship donuts to raise morale."
	reward = 3000
	required_count = 10
...
/datum/bounty/item/assistant/appendix
	name = "Appendix"
	description = "Chef Gibb of Central Command wants to prepare a traditional Unathi meal using a very special delicacy: an appendix. If you ship one, he'll pay."
	reward = 3000
...
/datum/bounty/item/assistant/potted_plants
	name = "Potted Plants"
	description = "Central Command is looking to decorate their civilian sector. You've been ordered to supply the potted plants."
	reward = 2000
	required_count = 8
...
/datum/bounty/item/assistant/handcuffs
	name = "Handcuffs"
	description = "A large influx of escaped convicts have arrived at Central Command. Now is the perfect time to ship out spare handcuffs."
	reward = 1000
	required_count = 5
