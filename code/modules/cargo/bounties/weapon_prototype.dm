...
/datum/bounty/weapon_prototype/New()
	...
	description = "[SSmapping.current_map.company_name] is interested in a laser prototype with a [stat_name] stat [stat_comparison] [stat_value]. [SSmapping.current_map.boss_name] will pay handsomely for such a weapon."
	reward += rand(0, 4) * 500
	..()
