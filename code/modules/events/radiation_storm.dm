...
/datum/event/radiation_storm/announce()
	command_announcement.Announce(SSmapping.current_map.radiation_detected_message, "Radiation Sensor Array Automated Alert", new_sound = 'sound/AI/radiation_detected_message.ogg', zlevels = affecting_z)
...
/datum/event/radiation_storm/tick()
	if(activeFor == enterBelt)
		command_announcement.Announce(SSmapping.current_map.radiation_contact_message, "Radiation Sensor Array Automated Alert", new_sound = 'sound/AI/radiation_contact_message.ogg', zlevels = affecting_z)
		radiate()
	...
	if(postStartTicks == radIntervall)
		...
		command_announcement.Announce(SSmapping.current_map.radiation_end_message, "Radiation Sensor Array Automated Alert", new_sound = 'sound/AI/radiation_end_message.ogg', zlevels = affecting_z)
		lights()
