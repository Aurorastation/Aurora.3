...
/datum/event/carp_migration/announce()
	...
	if(severity == EVENT_LEVEL_MAJOR)
		...
		announcement = "Unknown biological [length(spawned_carp) == 1 ? "entity has" : "entities have"] been detected near [station_name()], please stand-by.[severity == EVENT_LEVEL_MODERATE ? " The NMV Icarus has dispatched combat drones to assist." : ""]"
