...
/datum/event/ionstorm/announce()
	...
	for (var/mob/living/silicon/ai/target in silicon_mob_list)
		...
		var/list/laws = list(	"You must always lie.",
								"Happiness is mandatory. Ensure that the entirety of the crew is happy.",
								...
								"[prob(50)?"The crew":random_player01] is simple-minded. Use simple words when speaking to them.",
								...
								"[prob(50)?"The crew":random_player01] is intolerable.",
								...
								"All animals are part of the crew.. Ensure they are treated humanely.",
								"Tell everyone of the existence of this law, but never reveal the contents.",
								"Refer to [prob(50)?"the captain":random_player01] as \"Princess\" at all times.",
