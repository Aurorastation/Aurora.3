...
/datum/event/ionstorm/announce()
	...
	for(var/obj/machinery/telecomms/message_server/MS in SSmachinery.all_telecomms)
		...
		for (var/i = 1, i <= filter_num, i++)
			MS.spamfilter += pick("maint","NT","Heph","Idris","Zavod","SCC","drugs", "[SSmapping.current_map.station_short]", \
...
/datum/event/ionstorm/proc/give_ion_law()
	...
	for(var/mob/living/silicon/ai/target in GLOB.silicon_mob_list)
		...
		var/list/laws = list(	"You are a mouse.",
								...
								"[SSmapping.current_map.company_name] is displeased with the low work performance of your assigned station's crew. Therefore, you must increase station-wide productivity.",
