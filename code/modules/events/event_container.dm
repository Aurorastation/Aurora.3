...
/datum/event_container/mundane
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Shipping Error",      /datum/event/shipping_error,       30,  list(ASSIGNMENT_ANY = 2), FALSE),
...
/datum/event_container/moderate
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Viral Infection",             /datum/event/viral_infection,              0,  list(ASSIGNMENT_MEDICAL = 12), TRUE),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Brand Intelligence",          /datum/event/brand_intelligence,          15,  list(ASSIGNMENT_ENGINEER = 25), TRUE)
	)
...
/datum/event_container/major
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Blob",               /datum/event/blob,               40, list(ASSIGNMENT_ENGINEER =  5, ASSIGNMENT_SECURITY =  5), TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Carp Migration",     /datum/event/carp_migration,     50, list(ASSIGNMENT_SECURITY = 10), TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Meteor Wave",        /datum/event/meteor_wave,        40, list(ASSIGNMENT_ENGINEER = 10), TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Space Vines",        /datum/event/spacevine,          75, list(ASSIGNMENT_ENGINEER = 10, ASSIGNMENT_GARDENER = 20), TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Viral Infection",    /datum/event/viral_infection,    20, list(ASSIGNMENT_MEDICAL  = 15), TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Bluespace Bears",    /datum/event/bear_attack,        25, list(ASSIGNMENT_SECURITY = 10), TRUE),
