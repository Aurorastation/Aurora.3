...
/datum/event/electrical_storm/announce()
	switch(severity)
		if(EVENT_LEVEL_MUNDANE)
			command_announcement.Announce("Minor network attack detected. Power grids marginally overvoltage. Please watch out for possible electrical discharges.", "[location_name()] Power Monitor Alert", new_sound = 'sound/AI/electrical_storm.ogg', zlevels = affecting_z)
		if(EVENT_LEVEL_MODERATE)
			command_announcement.Announce("Network attack detected. Power grids severely overvoltage. Please watch out for possible electrical discharges.", "[location_name()] Power Monitor Alert", new_sound = 'sound/AI/electrical_storm.ogg', zlevels = affecting_z)
		if(EVENT_LEVEL_MAJOR)
			command_announcement.Announce("Catastrophic network attack detected. Power grids critically overvoltage. Please watch out for possible electrical discharges.", "[location_name()] Power Monitor Alert", new_sound = 'sound/AI/electrical_storm.ogg', zlevels = affecting_z)
...
/datum/event/electrical_storm/announce_end()
	. = ..()
	if(.)
		command_announcement.Announce("All power grid voltages returned to safe limits. Please repair any electrical overloads.", "Power Monitor Alert", zlevels = affecting_z)
