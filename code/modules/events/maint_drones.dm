...
/datum/event/rogue_maint_drones/announce()
	...
	switch(severity)
		...
		if(EVENT_LEVEL_MAJOR)
			naming = "revolution"
	command_announcement.Announce("A maintenance drone [naming] has been detected. Caution is advised when entering maintenance tunnels.", "Drone Behaviour Control")
