...
/datum/category_item/player_setup_item/general/basic/OnTopic(var/href,var/list/href_list, var/mob/user)
	if(href_list["rename"])
		...
		var/current_character = pref.name
		var/raw_name = input(user, "Choose your character's name:", "Character Name")  as text|null
		if(current_character != pref.name) //Without this, you can switch slots while the input menu is up to change your character's name past the grace period
			return
