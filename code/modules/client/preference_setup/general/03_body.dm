...
/datum/category_item/player_setup_item/general/body/proc/SetSpecies(mob/user)
	...
	if(restricted)
		if(restricted == 1)
			...
			dat += "<span class='warning'><b>You cannot play as this species.</br><small>This species is not available for play as a [current_map.station_type] race.</small></b></span></br>"
