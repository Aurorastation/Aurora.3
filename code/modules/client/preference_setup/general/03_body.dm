...
/datum/category_item/player_setup_item/general/body/sanitize_character(var/sql_load = 0)
	...
	pref.r_skin   = sanitize_integer(pref.r_skin, 37, 255, initial(pref.r_skin))
	pref.g_skin   = sanitize_integer(pref.g_skin, 3, 255, initial(pref.g_skin))
	pref.b_skin   = sanitize_integer(pref.b_skin, 2, 255, initial(pref.b_skin))
