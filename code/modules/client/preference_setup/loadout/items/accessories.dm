...
/datum/gear/accessory/holster
	...
	allowed_roles = list("Captain", "Executive Officer", "Steward", "Security Officer", "Warden", "Head of Security","Investigator", "Security Cadet", "Corporate Liaison", "Consular Officer",
