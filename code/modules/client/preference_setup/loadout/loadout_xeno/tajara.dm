...
/datum/gear/suit/tajaran_labcoat
	...
	whitelisted = list(SPECIES_TAJARA, SPECIES_TAJARA_ZHAN, SPECIES_TAJARA_MSAI)
	allowed_roles = list("Chief Medical Officer", "Physician", "Chemist", "First Responder", "Medical Intern")
	sort_category = "Xenowear - Tajara"
...
/datum/gear/suit/tajaran_surgeon
	...
	whitelisted = list(SPECIES_TAJARA, SPECIES_TAJARA_ZHAN, SPECIES_TAJARA_MSAI)
	allowed_roles = list("Chief Medical Officer", "Physician", "Xenobiologist", "Roboticist", "Medical Intern")
	sort_category = "Xenowear - Tajara"
