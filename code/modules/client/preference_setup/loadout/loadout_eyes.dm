...
/datum/gear/eyes/sunglasses
	...
	path = /obj/item/clothing/glasses/sunglasses
	allowed_roles = list("Security Officer", "Head of Security", "Warden", "Captain", "Executive Officer", "Operations Manager", "Internal Affairs Agent", "Investigator", "Bridge Crew")
