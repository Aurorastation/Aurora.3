...
/datum/gear/head/beret/medical
	...
	allowed_roles = list("Physician", "Medical Resident", "Pharmacist", "Paramedic", "Chief Medial Officer", "Psychiatrist")
...
/datum/gear/head/surgical
	...
	allowed_roles = list("Scientist", "Chief Medical Officer", "Physician", "Geneticist", "Pharmacist", "Paramedic", "Medical Resident", "Xenobiologist", "Roboticist", "Research Director", "Forensic Technician")
