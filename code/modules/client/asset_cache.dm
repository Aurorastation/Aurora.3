...
/datum/asset/simple/paper
	assets = list(
		...
		"ocean.png" = 'html/images/scans/exoplanets/ocean.png',
		"ocean_shallow.png" = 'html/images/scans/exoplanets/ocean_shallow.png',
		"desert.png" = 'html/images/scans/exoplanets/desert.png',
		"snow.png" = 'html/images/scans/exoplanets/snow.png',
		"tundra.png" = 'html/images/scans/exoplanets/tundra.png',
