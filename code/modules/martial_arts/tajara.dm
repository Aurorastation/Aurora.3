...
/datum/martial_art/baghrar/proc/eye_rake(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
	...
	if(!D.species.has_limbs[TARGET_HEAD])
		return 0

	var/obj/item/organ/external/affecting = D.get_organ(TARGET_HEAD)
	...
	D.apply_damage(10,BRUTE, TARGET_HEAD, armor, sharp=1, edge=1)
