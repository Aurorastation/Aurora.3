...
/datum/preferences/proc/get_jobs_by_dept(var/department)
	var/list/jobs = list()
	switch(department)
		if(CIVILIAN)
			LAZYADD(jobs, job_civilian_high)
			LAZYADD(jobs, job_civilian_med)
			LAZYADD(jobs, job_civilian_low)
		if(MEDSCI)
			LAZYADD(jobs, job_medsci_high)
			LAZYADD(jobs, job_medsci_med)
			LAZYADD(jobs, job_medsci_low)
		if(ENGSEC)
			LAZYADD(jobs, job_engsec_high)
			LAZYADD(jobs, job_engsec_med)
			LAZYADD(jobs, job_engsec_low)
	return jobs
