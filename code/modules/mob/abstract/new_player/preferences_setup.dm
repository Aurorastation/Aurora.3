...
/datum/preferences/proc/update_preview_icon()
	...
	preview_icon.Scale(32*3, 32)

	mannequin.dir = WEST
	mannequin.update_tail_showing(1)
	var/icon/stamp = getFlatIcon(mannequin)
	preview_icon.Blend(stamp, ICON_OVERLAY, 1, 1)


	mannequin.dir = NORTH
	mannequin.update_tail_showing(1)
	stamp = getFlatIcon(mannequin)
	preview_icon.Blend(stamp, ICON_OVERLAY, 33, 1)

	mannequin.dir = SOUTH
	mannequin.update_tail_showing(1)
	stamp = getFlatIcon(mannequin)
	preview_icon.Blend(stamp, ICON_OVERLAY, 65, 1)
