...
/mob/proc/hear_say(var/message, var/verb = "says", var/datum/language/language = null, var/alt_name = "",var/italics = 0, var/mob/speaker = null, var/sound/speech_sound, var/sound_vol)
	...
	if(isdeaf(src))
		...
		if(language)
			...
			on_hear_say("[track]<span class='game say'><span class='name'>[speaker_name]</span>[alt_name] [verb], <span class='message linkify'><span class='body'>\"[message]\"</span></span></span>")
...
/mob/proc/on_hear_radio(part_a, speaker_name, track, part_b, formatted, accent_icon)
	var/accent_tag
	if(accent_icon)
		var/icon/pre_icon = icon('./icons/accent_tags.dmi', accent_icon)
		accent_tag = icon2html(pre_icon, src, realsize=TRUE, class="text_tag")
