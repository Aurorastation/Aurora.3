...
/mob/living/carbon/human/proc/commune()
	...
	if (target.can_commune())
		...
		to_chat(H,"<span class='alien'>You feel pressure behind your eyes as alien thoughts enter your mind:</span> [text]")
		if(istype(H))
			if (target.can_commune())
				return
...
/mob/living/carbon/human/proc/crush()
	...
	if(ishuman(G.affecting))
		...
		visible_message(SPAN_WARNING("<b>[src]</b> viciously crushes [affected] of [G.affecting] with its metallic arms!"))
		...
		visible_message(SPAN_WARNING("<b>[src]</b> viciously crushes [G.affecting]'s flesh with its metallic arms!"))
