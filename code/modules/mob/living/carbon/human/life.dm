...
#define HUMAN_CRIT_MAX_OXYLOSS ( 1.0 / 6) //The amount of damage you'll get when in critical condition. There are 25HP to get through, so (1/6)*last_tick_duration per second. Breaths however only happen every 4 ticks. last_tick_duration = ~2.0 on average
