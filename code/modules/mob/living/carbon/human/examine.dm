...
/mob/living/carbon/human/examine(mob/user)
	...
	//handcuffed?
	if(legcuffed)
		msg += "<span class='warning'>[get_pronoun("He")] [get_pronoun("is")] \icon[legcuffed] legcuffed!</span>\n"

	//buckled_to
	if(buckled_to)
		msg += "<span class='warning'>[get_pronoun("He")] [get_pronoun("is")] \icon[buckled_to] buckled to [buckled_to]!</span>\n"
	...
	if(wear_mask && !skipmask)
		if(wear_mask.blood_color)
			msg += "<span class='warning'>[get_pronoun("He")] [get_pronoun("has")] \icon[wear_mask] [wear_mask.gender==PLURAL?"some":"a"] [fluid_color_type_map(wear_mask.blood_color)]-stained <a href='?src=\ref[src];lookitem_desc_only=\ref[wear_mask]'>[wear_mask.name]</a> [wear_mask.get_mask_examine_text(src)]!</span>\n"
		else
			msg += "[get_pronoun("He")] [get_pronoun("has")] \icon[wear_mask] <a href='?src=\ref[src];lookitem_desc_only=\ref[wear_mask]'>\a [wear_mask]</a> [wear_mask.get_mask_examine_text(src)].\n"
	...
	//left ear
	if(l_ear && !skipears)
		msg += "[get_pronoun("He")] [get_pronoun("has")] \icon[l_ear] <a href='?src=\ref[src];lookitem_desc_only=\ref[l_ear]'>\a [l_ear]</a> [l_ear.get_ear_examine_text(src, "left")].\n"

	//right ear
	if(r_ear && !skipears)
		msg += "[get_pronoun("He")] [get_pronoun("has")] \icon[r_ear] <a href='?src=\ref[src];lookitem_desc_only=\ref[r_ear]'>\a [r_ear]</a> [r_ear.get_ear_examine_text(src, "right")].\n"
	...
	if(wrists && !skipwrists)
		msg += "[get_pronoun("He")] [get_pronoun("is")] wearing \icon[wrists] <a href='?src=\ref[src];lookitem_desc_only=\ref[wrists]'>\a [wrists]</a> on [get_pronoun("his")] [wrists.gender==PLURAL?"wrists":"wrist"].\n"
