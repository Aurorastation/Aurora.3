...
/mob/living/carbon/human/proc/has_organ_for_slot(slot)
	switch(slot)
		if(slot_back)
			return has_organ(TARGET_CHEST)
		if(slot_wear_mask)
			return has_organ(TARGET_HEAD)
		if(slot_handcuffed)
			return has_organ(TARGET_L_HAND) && has_organ(TARGET_R_HAND)
		if(slot_legcuffed)
			return has_organ(TARGET_L_LEG) && has_organ(TARGET_R_LEG)
		if(slot_l_hand)
			return has_organ(TARGET_L_HAND)
		if(slot_r_hand)
			return has_organ(TARGET_R_HAND)
		if(slot_belt)
			return has_organ(TARGET_CHEST)
		if(slot_wear_id)
		...
		if(slot_head)
			return has_organ(TARGET_HEAD)
		if(slot_shoes)
			return has_organ(TARGET_R_FOOT) || has_organ(TARGET_L_FOOT)
		if(slot_wear_suit)
			return has_organ(TARGET_CHEST)
		if(slot_w_uniform)
			return has_organ(TARGET_CHEST)
