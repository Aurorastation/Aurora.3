/mob/living/carbon/teshari/dummy
	real_name = "Test Dummy"
	status_flags = GODMODE|CANPUSH

/mob/living/carbon/teshari/dummy/mannequin
	mob_thinks = FALSE

INITIALIZE_IMMEDIATE(/mob/living/carbon/teshari/dummy/mannequin)

/mob/living/carbon/teshari/dummy/mannequin/Initialize()
	. = ..()
	mob_list -= src
	living_mob_list -= src
	dead_mob_list -= src
...
/mob/living/carbon/teshari/skrell/Initialize(mapload)
	h_style = "Skrell Average Tentacles"
	. = ..(mapload, SPECIES_SKRELL)

/mob/living/carbon/teshari/tajaran/Initialize(mapload)
	h_style = "Tajaran Ears"
	. = ..(mapload, SPECIES_TAJARA)

/mob/living/carbon/teshari/unathi/Initialize(mapload)
	h_style = "Unathi Horns"
	. = ..(mapload, SPECIES_UNATHI)

/mob/living/carbon/teshari/diona/Initialize(mapload, new_species = null)
	. = ..(mapload, new_species || SPECIES_DIONA)
	src.gender = NEUTER

/mob/living/carbon/teshari/diona/coeus/Initialize(mapload)
	. = ..(mapload, SPECIES_DIONA_COEUS)
	src.gender = NEUTER

/mob/living/carbon/teshari/machine/Initialize(mapload)
	h_style = "blue IPC screen"
	. = ..(mapload, SPECIES_IPC)

/mob/living/carbon/teshari/monkey/Initialize(mapload)
	. = ..(mapload, SPECIES_MONKEY)

/mob/living/carbon/teshari/farwa/Initialize(mapload)
	. = ..(mapload, SPECIES_MONKEY_TAJARA)

/mob/living/carbon/teshari/farwa/adhomai
	faction = "Adhomai"

/mob/living/carbon/teshari/neaera/Initialize(mapload)
	. = ..(mapload, SPECIES_MONKEY_SKRELL)

/mob/living/carbon/teshari/stok/Initialize(mapload)
	. = ..(mapload, SPECIES_MONKEY_UNATHI)

/mob/living/carbon/teshari/bug/Initialize(mapload)
	. = ..(mapload, SPECIES_MONKEY_VAURCA)
	src.gender = FEMALE

/mob/living/carbon/teshari/type_a/Initialize(mapload)
	h_style = "Classic Antennae"
	. = ..(mapload, SPECIES_VAURCA_WORKER)
	src.gender = NEUTER

/mob/living/carbon/teshari/type_a/cargo/Initialize(mapload)
	. = ..()
...
/mob/living/carbon/teshari/type_b/Initialize(mapload)
	h_style = "Classic Antennae"
	. = ..(mapload, SPECIES_VAURCA_WARRIOR)
	src.gender = NEUTER

/mob/living/carbon/teshari/type_c/Initialize(mapload)
	. = ..(mapload, SPECIES_VAURCA_BREEDER)
	src.gender = FEMALE

/mob/living/carbon/teshari/type_c
	layer = 5

/mob/living/carbon/teshari/type_big/Initialize(mapload)
	. = ..(mapload, SPECIES_VAURCA_WARFORM)
	src.gender = NEUTER
	src.mutations |= HULK

/mob/living/carbon/teshari/type_big
	layer = 5

/mob/living/carbon/teshari/type_e/Initialize(mapload)
	. = ..(mapload, SPECIES_VAURCA_BULWARK)

/mob/living/carbon/teshari/type_e/equipped/Initialize(mapload)
	. = ..(mapload, SPECIES_VAURCA_BULWARK)
	species.before_equip(src)
	species.after_equip(src)

/mob/living/carbon/teshari/axiori_skrell/Initialize(mapload)
	h_style = "Skrell Average Tentacles"
	. = ..(mapload, SPECIES_SKRELL_AXIORI)

/mob/living/carbon/teshari/msai_tajara/Initialize(mapload)
	h_style = "Tajaran Ears"
	. = ..(mapload, SPECIES_TAJARA_MSAI)

/mob/living/carbon/teshari/zhankhazan_tajara/Initialize(mapload)
	h_style = "Tajaran Ears"
	. = ..(mapload, SPECIES_TAJARA_ZHAN)

/mob/living/carbon/teshari/tesla_body_tajara/Initialize(mapload)
	h_style = "Tesla Rejuvenation Suit Ears"
	. = ..(mapload, SPECIES_TAJARA_TESLA_BODY)

/mob/living/carbon/teshari/industrial/Initialize(mapload)
	. = ..(mapload, SPECIES_IPC_G1)

/mob/living/carbon/teshari/shell/Initialize(mapload)
	. = ..(mapload, SPECIES_IPC_SHELL)

/mob/living/carbon/teshari/industrial_hephaestus/Initialize(mapload)
	. = ..(mapload, SPECIES_IPC_G2)

/mob/living/carbon/teshari/industrial_xion/Initialize(mapload)
	. = ..(mapload, SPECIES_IPC_XION)

/mob/living/carbon/teshari/industrial_xion_remote/Initialize(mapload)
...
/mob/living/carbon/teshari/industrial_xion_remote_mech/Initialize(mapload)
	. = ..(mapload, SPECIES_IPC_XION_REMOTE)
...
/mob/living/carbon/teshari/industrial_xion_remote_bunker/Initialize(mapload)
	. = ..(mapload, SPECIES_IPC_XION_REMOTE)
...
/mob/living/carbon/teshari/industrial_xion_remote_penal/Initialize(mapload)
...
/mob/living/carbon/teshari/industrial_xion_remote_warden/Initialize(mapload)
	. = ..(mapload, "Remote Xion Industrial Frame")
...
/mob/living/carbon/teshari/industrial_zenghu/Initialize(mapload)
	. = ..(mapload, SPECIES_IPC_ZENGHU)

/mob/living/carbon/teshari/industrial_bishop/Initialize(mapload)
	. = ..(mapload, SPECIES_IPC_BISHOP)

/mob/living/carbon/teshari/unbranded_frame/Initialize(mapload)
	. = ..(mapload, SPECIES_IPC_UNBRANDED)

/mob/living/carbon/teshari/unbranded_frame_remote/Initialize(mapload)
...
/mob/living/carbon/teshari/unbranded_frame_remote_bunker/Initialize(mapload)
	. = ..(mapload, SPECIES_IPC_UNBRANDED_REMOTE)
...
/mob/living/carbon/teshari/terminator/Initialize(mapload)
...
/mob/living/carbon/teshari/terminator
	mob_size = 30

/mob/living/carbon/teshari/golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_COAL)

/mob/living/carbon/teshari/iron_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_IRON)

/mob/living/carbon/teshari/bronze_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_BRONZE)

/mob/living/carbon/teshari/steel_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_STEEL)

/mob/living/carbon/teshari/plasteel_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_PLASTEEL)

/mob/living/carbon/teshari/titanium_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_TITANIUM)

/mob/living/carbon/teshari/cloth_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_CLOTH)

/mob/living/carbon/teshari/cardboard_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_CARDBOARD)

/mob/living/carbon/teshari/glass_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_GLASS)

/mob/living/carbon/teshari/phoron_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_PHORON)

/mob/living/carbon/teshari/mhydrogen_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_HYDROGEN)

/mob/living/carbon/teshari/wood_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_WOOD)

/mob/living/carbon/teshari/diamond_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_DIAMOND)

/mob/living/carbon/teshari/sand_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_SAND)

/mob/living/carbon/teshari/uranium_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_URANIUM)

/mob/living/carbon/teshari/homunculus/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_MEAT)

/mob/living/carbon/teshari/adamantine_golem/Initialize(mapload)
	. = ..(mapload, SPECIES_GOLEM_ADAMANTINE)

/mob/living/carbon/teshari/technomancer_golem/Initialize(mapload)
