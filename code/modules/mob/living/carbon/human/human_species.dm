...
/mob/living/carbon/human/industrial_xion_remote_bunker/Initialize(mapload)
	...
	equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_com(src), slot_l_ear_str)
...
/mob/living/carbon/human/industrial_xion_remote_penal/Initialize(mapload)
	...
	equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_penal(src), slot_l_ear_str)
...
/mob/living/carbon/human/industrial_xion_remote_warden/Initialize(mapload)
	...
	equip_to_slot_or_del(new /obj/item/clothing/shoes/jackboots(src), slot_shoes_str)
	equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_warden(src), slot_l_ear_str)
...
/mob/living/carbon/human/hunter_killer/Initialize(mapload)
	...
	accent = ACCENT_TTS
	src.equip_to_slot_or_del(new /obj/item/gun/energy/scythe(src),slot_l_hand_str)
