...
/datum/medical_effect/headache
	...
	cures = list(/datum/reagent/alkysine, /datum/reagent/traumadil, /datum/reagent/paresetamil, /datum/reagent/oxycordine)
...
/datum/medical_effect/cramps
	name = "Cramps"
	triggers = list(/datum/reagent/dylovene = 30, /datum/reagent/traumadil = 15)
