...
/datum/medical_effect/headache
	...
	cures = list(/datum/reagent/alkysine, /datum/reagent/traumatonin, /datum/reagent/paraphenol, /datum/reagent/oxycorphine)
...
/datum/medical_effect/cramps
	name = "Cramps"
	triggers = list(/datum/reagent/dylovene = 30, /datum/reagent/traumatonin = 15)
