...
/datum/species/bug/before_equip(var/mob/living/carbon/human/H)
	...
	if(HAS_TRAIT(H, TRAIT_ORIGIN_HAS_PSIAUG))
		var/obj/item/organ/A = new /obj/item/organ/internal/augment/psi(H)
		var/obj/item/organ/external/affected = H.get_organ(A.parent_organ)
		A.replaced(H, affected)
	if(HAS_TRAIT(H, TRAIT_ORIGIN_HAS_KLAX_IMPLANT))
		var/obj/item/organ/A = new /obj/item/organ/internal/augment/language/klax(H)
		var/obj/item/organ/external/affected = H.get_organ(A.parent_organ)
		A.replaced(H, affected)
	if(HAS_TRAIT(H, TRAIT_ORIGIN_HAS_CTHUR_IMPLANT))
		var/obj/item/organ/A = new /obj/item/organ/internal/augment/language/cthur(H)
		var/obj/item/organ/external/affected = H.get_organ(A.parent_organ)
		A.replaced(H, affected)
	if(HAS_TRAIT(H, TRAIT_ORIGIN_HAS_MIKUETZ_IMPLANT))
		var/obj/item/organ/A = new /obj/item/organ/internal/augment/language/mikuetz(H)
		var/obj/item/organ/external/affected = H.get_organ(A.parent_organ)
		A.replaced(H, affected)
	if(HAS_TRAIT(H, TRAIT_ORIGIN_HAS_ZINO_IMPLANT))
		var/obj/item/organ/A = new /obj/item/organ/internal/augment/language/zino(H)
		var/obj/item/organ/external/affected = H.get_organ(A.parent_organ)
		A.replaced(H, affected)
