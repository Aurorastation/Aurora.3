/datum/species/unathi/autakh
	...
	blurb = "he Aut'akh are a religious commune of cybernetically-augmented Unathi. They mostly hail from Moghes, and are made up of castoffs, refugees and exiles \
	...
	To this end, they created a cybernetic society made up of average Unathi who fully embrace technology as a supplement to biology. They are managed, but not ruled, by their god Oss, \
	a silent deity who quietly facilitates the Aut'akhs' prosperity behind the scenes. Oss is maintained and improved by a group of Aut'akh known as the Paradigms. Anyone who \
	provides an edit to Oss is a Paradigm, and Paradigms are seen as powerful wizards and priests. They are almost excessively friendly, seeing all the beings of the galaxy as \
