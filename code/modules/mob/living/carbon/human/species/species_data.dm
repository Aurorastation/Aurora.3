...
/datum/species_data/proc/get_eyes(var/mob/living/carbon/human/H)
	return

/datum/species_data/New()
	if(hud_type)
		hud = new hud_type()
	else
		hud = new()
...
/datum/species_data/proc/get_station_variant()
	return name

/datum/species_data/proc/get_bodytype()
	if(!bodytype)
		bodytype = name
	return bodytype

/datum/species_data/proc/get_environment_discomfort(var/mob/living/carbon/human/H, var/msg_type)
...
/datum/species_data/proc/sanitize_name(var/name)
	return sanitizeName(name)

/datum/species_data/proc/get_random_name(var/gender)
	if(!name_language)
		if(gender == FEMALE)
...
/datum/species_data/proc/before_equip(mob/living/carbon/human/H, visualsOnly = FALSE, datum/job/J)
	return

/datum/species_data/proc/after_equip(mob/living/carbon/human/H, visualsOnly = FALSE, datum/job/J)
	return

/datum/species_data/proc/create_organs(var/mob/living/carbon/human/H) //Handles creation of mob organs.
...
/datum/species_data/proc/tap(var/mob/living/carbon/human/H,var/mob/living/target)
	var/t_his = "their"
...
/datum/species_data/proc/remove_inherent_verbs(var/mob/living/carbon/human/H)
	if(inherent_verbs)
...
/datum/species_data/proc/add_inherent_verbs(var/mob/living/carbon/human/H)
	if(inherent_verbs)
		for(var/verb_path in inherent_verbs)
			H.verbs |= verb_path
...
/datum/species_data/proc/handle_post_spawn(var/mob/living/carbon/human/H,var/kpg = 0) //Handles anything not already covered by basic species assignment. Keepgene value should only be used by genetics.
...
/datum/species_data/proc/handle_death(var/mob/living/carbon/human/H, var/gibbed = 0) //Handles any species-specific death events (such as dionaea nymph spawns).
	return

// Only used for alien plasma weeds atm, but could be used for Dionaea later.
/datum/species_data/proc/handle_environment_special(var/mob/living/carbon/human/H)
	return

// Used to update alien icons for aliens.
/datum/species_data/proc/handle_login_special(var/mob/living/carbon/human/H)
	return

// As above.
/datum/species_data/proc/handle_logout_special(var/mob/living/carbon/human/H)
	return

// Builds the HUD using species-specific icons and usable slots.
/datum/species_data/proc/build_hud(var/mob/living/carbon/human/H)
	return

//Used by xenos understanding larvae and dionaea understanding nymphs.
/datum/species_data/proc/can_understand(var/mob/other)
	return

// Called when using the shredding behavior.
/datum/species_data/proc/can_shred(var/mob/living/carbon/human/H, var/ignore_intent)
...
/datum/species_data/proc/handle_npc(var/mob/living/carbon/human/H)
	return

/datum/species_data/proc/get_vision_flags(var/mob/living/carbon/human/H)
	return vision_flags

/datum/species_data/proc/handle_vision(var/mob/living/carbon/human/H)
	H.update_sight()
...
/datum/species_data/proc/handle_sprint_cost(var/mob/living/carbon/human/H, var/cost)
...
/datum/species_data/proc/get_light_color(mob/living/carbon/human/H)
	return

/datum/species_data/proc/can_breathe_water()
	return FALSE

/datum/species_data/proc/get_move_trail(var/mob/living/carbon/human/H)
	if( H.shoes || ( H.wear_suit && (H.wear_suit.body_parts_covered & FEET) ) )
		return /obj/effect/decal/cleanable/blood/tracks/footprints
	else
		return move_trail

/datum/species_data/proc/bullet_act(var/obj/item/projectile/P, var/def_zone, var/mob/living/carbon/human/H)
	return 0

/datum/species_data/proc/handle_speech_problems(mob/living/carbon/human/H, list/current_flags, message, message_verb, message_mode)
	return current_flags

/datum/species_data/proc/handle_speech_sound(mob/living/carbon/human/H, list/current_flags)
	if(speech_sounds && prob(speech_chance))
		current_flags[1] = sound(pick(speech_sounds))
		current_flags[2] = 50
	return current_flags

/datum/species_data/proc/get_vision_organ(mob/living/carbon/human/H)
	return H.internal_organs_by_name[vision_organ]

/datum/species_data/proc/set_default_hair(var/mob/living/carbon/human/H)
	H.h_style = H.species.default_h_style
	H.f_style = H.species.default_f_style
	H.update_hair()

/datum/species_data/proc/get_species_tally(var/mob/living/carbon/human/H)
	return 0

/datum/species_data/proc/equip_later_gear(var/mob/living/carbon/human/H) //this handles anything not covered by survival gear, it is only called after everything else is equiped to the mob
	return

/datum/species_data/proc/get_cloning_variant()
	return name