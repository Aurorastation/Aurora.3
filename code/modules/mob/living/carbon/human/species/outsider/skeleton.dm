...
/datum/species/skeleton //SPOOKY
	...
	has_limbs = list(
		...
		TARGET_GROIN =  list("path" = /obj/item/organ/external/groin/skeleton),
		TARGET_HEAD =   list("path" = /obj/item/organ/external/head/skeleton),
		TARGET_L_ARM =  list("path" = /obj/item/organ/external/arm/skeleton),
		TARGET_R_ARM =  list("path" = /obj/item/organ/external/arm/right/skeleton),
		TARGET_L_LEG =  list("path" = /obj/item/organ/external/leg/skeleton),
		TARGET_R_LEG =  list("path" = /obj/item/organ/external/leg/right/skeleton),
		TARGET_L_HAND = list("path" = /obj/item/organ/external/hand/skeleton),
		TARGET_R_HAND = list("path" = /obj/item/organ/external/hand/right/skeleton),
		TARGET_L_FOOT = list("path" = /obj/item/organ/external/foot/skeleton),
		TARGET_R_FOOT = list("path" = /obj/item/organ/external/foot/right/skeleton)
		)
