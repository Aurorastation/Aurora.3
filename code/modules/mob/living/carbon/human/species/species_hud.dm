/datum/hud_data
	...
	var/list/gear = list(
		...
		"l_wrist" = 	 list("loc" = ui_l_wrist, "name" = "left wrist", "slot" = slot_l_wrist, "state" = "wrists", "toggle" = 1), // Wristwear is split into left and right slots. Paired wristwear can still occupy both slots through an offwrist placeholder.
		"r_wrist" = 	 list("loc" = ui_r_wrist, "name" = "right wrist", "slot" = slot_r_wrist, "state" = "wrists", "toggle" = 1),
...
/datum/hud_data/diona
	...
	gear = list(
		...
		"l_ear" =        list("loc" = ui_l_ear,   	"name" = "left ear",     "slot" = slot_l_ear,     "state" = "l_ear",  "toggle" = 1),
		"r_ear" =        list("loc" = ui_r_ear,		"name" = "right ear",    "slot" = slot_r_ear,     "state" = "r_ear",  "toggle" = 1),
		"l_wrist" = 	 list("loc" = ui_l_wrist, "name" = "left wrist", "slot" = slot_l_wrist, "state" = "wrists", "toggle" = 1),
		"r_wrist" = 	 list("loc" = ui_r_wrist, "name" = "right wrist", "slot" = slot_r_wrist, "state" = "wrists", "toggle" = 1),
		"head" =         list("loc" = ui_head, 		"name" = "hat",          "slot" = slot_head,      "state" = "hair",   "toggle" = 1),
		"pants" =        list("loc" = ui_pants,     "name" = "pants",        "slot" = slot_pants,     "state" = "pants",  "toggle" = 1),
		"suit storage" = list("loc" = ui_sstore1,   "name" = "suit storage", "slot" = slot_s_store,   "state" = "suitstore"),
