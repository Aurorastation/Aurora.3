...
/obj/item/clothing/mask/facehugger/examine(mob/user)
	...
	switch(stat)
		if(DEAD,UNCONSCIOUS)
			user << "<span class='warning'>\b [src] is not moving.</span>"
		if(CONSCIOUS)
			user << "<span class='warning'>\b [src] seems to be active.</span>"
	if (sterile)
		user << "<span class='warning'>\b It looks like the proboscis has been removed.</span>"
	return
