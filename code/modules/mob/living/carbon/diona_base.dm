...
/mob/living/carbon/alien/diona/death()
	if(client)
		to_chat(switch_to_gestalt(), span("warning", "You feel tremendous pain as you loose connection to your detached nymph, there is no way to bring it back anymore."))
	..()
