/obj/machinery/slime_extractinator
	name = "slime core extractinator"
	...
	component_types = list(
		/obj/item/circuitboard/slime_extractinator,
		/obj/item/stock_parts/matter_bin,
		/obj/item/stock_parts/micro_laser,
		/obj/item/stack/cable_coil{amount = 5}
	)

/obj/machinery/slime_extractinator/examine(mob/user)
	. = ..()
...
/obj/machinery/slime_extractinator/update_icon()
	cut_overlays()
	if(panel_open)
...
/obj/machinery/slime_extractinator/RefreshParts()
	..()
...
/obj/machinery/slime_extractinator/attackby(obj/item/O, mob/user)
	if(length(extract_slimes))
...
/obj/machinery/slime_extractinator/MouseDrop_T(atom/dropping, mob/user)
...
/obj/machinery/slime_extractinator/proc/extraction_process(var/slime)
	if(isnull(extract_slimes) || !length(extract_slimes))
		update_icon()
		return
	...
	if(!extracted_slime)
		update_icon()
		return
	for(var/i = 1, i < extracted_slime.cores + 1, i++)
...
/obj/item/circuitboard/slime_extractinator
	name = T_BOARD("slime extractinator")
	build_path = "/obj/machinery/slime_extractinator"
	board_type = "machine"
