/mob/living/carbon/slime/proc/mutation_table(var/slime_color)
	...
	switch(slime_color)
		...
		// Tier 5
			...
			slime_mutation[1] = slime_color
			slime_mutation[2] = slime_color
			slime_mutation[3] = slime_color
			slime_mutation[4] = slime_color
