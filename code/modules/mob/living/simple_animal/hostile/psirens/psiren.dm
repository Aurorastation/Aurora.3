...
/mob/living/simple_animal/hostile/psiren
	...
	psi_pingable = TRUE
	meat_amount = 1
	meat_type = /obj/item/reagent_containers/food/snacks/squidmeat/psiren_body_meat
	butchering_products = list(/obj/item/reagent_containers/food/snacks/squidmeat/psiren_tentacle_meat = 4)
