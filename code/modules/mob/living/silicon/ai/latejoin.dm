...
/mob/living/silicon/ai/verb/wipe_core()
	...
	if(carded)
		to_chat(usr, "<span class='danger'>No connection to facilities' intelligence storage. You must be in an AI Core to store yourself (adminhelp if you need to leave).</span>")
		return
