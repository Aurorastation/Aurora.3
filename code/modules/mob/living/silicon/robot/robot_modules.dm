...
/obj/item/robot_module/engineering/construction/New()
	...
	src.malfAImodule += new /obj/item/rtf(src)
...
/obj/item/robot_module/security/general/New()
	...
	src.modules += new /obj/item/book/manual/security_space_law(src) // book of security space law
...
/obj/item/robot_module/mining_drone/basic/New(var/mob/living/silicon/robot/robot)
	...
	src.emag = new /obj/item/gun/energy/vaurca/mountedthermaldrill(src)
...
/obj/item/robot_module/mining_drone/plasmacutter/New(var/mob/living/silicon/robot/robot)
	src.modules += new /obj/item/device/flash(src)
	src.modules += new /obj/item/borg/sight/material(src)
	src.modules += new /obj/item/storage/bag/ore/drone(src)
	src.modules += new /obj/item/gun/energy/plasmacutter/mounted(src)
	src.modules += new /obj/item/storage/bag/sheetsnatcher/borg(src)
	src.modules += new /obj/item/gripper/miner(src)
	src.modules += new /obj/item/mining_scanner(src)
...
/obj/item/robot_module/mining_drone/drillandplasmacutter/New(var/mob/living/silicon/robot/robot)
	src.modules += new /obj/item/device/flash(src)
	src.modules += new /obj/item/borg/sight/material(src)
	src.modules += new /obj/item/storage/bag/ore/drone(src)
	src.modules += new /obj/item/gun/energy/plasmacutter/mounted(src)
