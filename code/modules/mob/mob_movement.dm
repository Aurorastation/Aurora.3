...
/client/Move(new_loc, direct)
	...
	if(isturf(mob.loc))
		...
		//TODO: Fuck wheelchairs.
		if(istype(mob.pulledby, /obj/structure/bed/stool/chair/office/wheelchair) || istype(mob.pulledby, /obj/structure/janitorialcart) || istype(mob.pulledby, /obj/structure/engineeringcart) || istype(mob.pulledby, /obj/structure/parcelcart))
