/mob
	...
	*/
	...
	var/list/embedded = null            // Embedded items, since simple mobs don't have organs.
...
//Wizard mode, but can be used in other modes thanks to the brand new "Give Spell" badmin button
	...
	var/list/shouldnt_see = null	//typecache of objects that this mob shouldn't see in the stat panel. this silliness is needed because of AI alt+click and cult blood runes
