...
/obj/item/weapon/grab/proc/s_click(obj/screen/S)
	...
	if(state < GRAB_AGGRESSIVE)
		...
		msg_admin_attack(text="[key_name(assailant)] grabbed the neck of [key_name(affecting)]",ckey=key_name(assailant),ckey_target=key_name(affecting))
		hud.icon_state = "kill"
		hud.name = "kill"
		...
		msg_admin_attack(text="[key_name(assailant)] strangled (kill intent) [key_name(affecting)]",ckey=key_name(assailant),ckey_target=key_name(affecting))
