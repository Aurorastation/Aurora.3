...
/datum/special_power/psionic/redaction
	faculty = PSI_REDACTION
	admin_log = FALSE

/datum/special_power/psionic/redaction/proc/check_dead(var/mob/living/target)
	if(!istype(target))
		return FALSE
...
/datum/special_power/psionic/redaction/invoke(var/mob/living/user, var/mob/living/target)
	if(check_dead(target))
		return FALSE
	. = ..()

/datum/special_power/psionic/redaction/skinsight
	name =            "Skinsight"
	cost =            3
	cooldown =        30
	use_grab =        TRUE
...
/datum/special_power/psionic/redaction/skinsight/invoke(var/mob/living/user, var/mob/living/target)
...
/datum/special_power/psionic/redaction/mend
	name =            "Mend"
	cost =            7
	cooldown =        50
	use_melee =       TRUE
...
/datum/special_power/psionic/redaction/mend/invoke(var/mob/living/user, var/mob/living/carbon/human/target)
...
/datum/special_power/psionic/redaction/cleanse
	name =            "Cleanse"
	cost =            9
	cooldown =        60
	use_melee =       TRUE
...
/datum/special_power/psionic/redaction/cleanse/invoke(var/mob/living/user, var/mob/living/carbon/human/target)
	if(!istype(user) || !istype(target))
		return FALSE
	. = ..()
	if(.)
...
/datum/special_power/psionic/revive
	name =            "Revive"
	cost =            25
	cooldown =        80
	use_grab =        TRUE
...
/datum/special_power/psionic/revive/invoke(var/mob/living/user, var/mob/living/target)
