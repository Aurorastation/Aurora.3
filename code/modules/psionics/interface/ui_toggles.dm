...
/obj/screen/psi/armour/Click()
	...
	if(owner.psi.use_psi_armour)
		to_chat(owner, span("notice", "You will now use your psionics to deflect or block incoming attacks."))
	else
		to_chat(owner, span("notice", "You will no longer use your psionics to deflect or block incoming attacks."))
	update_icon()
