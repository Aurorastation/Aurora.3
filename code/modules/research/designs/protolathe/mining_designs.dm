...
/datum/design/item/mining/pick_set
	...
	materials = list(MATERIAL_STEEL = 1700, MATERIAL_GLASS = 200)
...
/datum/design/item/mining/ka_frame03
	...
	materials = list(MATERIAL_STEEL = 5000, MATERIAL_SILVER = 2000)
...
/datum/design/item/mining/ka_frame04
	...
	materials = list(MATERIAL_STEEL = 5000, MATERIAL_SILVER = 2000, MATERIAL_DIAMOND = 1000)
...
/datum/design/item/mining/ka_frame05
	...
	materials = list(MATERIAL_STEEL = 6000, MATERIAL_SILVER = 4000, MATERIAL_DIAMOND = 2000)
	build_path = /obj/item/gun/custom_ka/frame05

/datum/design/item/mining/ka_frameA
	req_tech = list(TECH_MATERIAL = 3,TECH_ENGINEERING = 3)
	materials = list(MATERIAL_STEEL = 6000, MATERIAL_SILVER = 3000, MATERIAL_DIAMOND = 1000)
	build_path = /obj/item/gun/custom_ka/frameA

/datum/design/item/mining/ka_frameB
	req_tech = list(TECH_MATERIAL = 6,TECH_ENGINEERING = 6)
	materials = list(MATERIAL_STEEL = 7000, MATERIAL_SILVER = 4000, MATERIAL_DIAMOND = 3000)
...
/datum/design/item/mining/ka_frameD
	req_tech = list(TECH_MATERIAL = 6,TECH_ENGINEERING = 6)
	materials = list(MATERIAL_STEEL = 7000, MATERIAL_SILVER = 5000, MATERIAL_DIAMOND = 3000)
	build_path = /obj/item/gun/custom_ka/frameD

/datum/design/item/mining/ka_frameE
	req_tech = list(TECH_MATERIAL = 6,TECH_ENGINEERING = 6)
	materials = list(MATERIAL_STEEL = 7000, MATERIAL_SILVER = 5000, MATERIAL_DIAMOND = 4000)
...
/datum/design/item/mining/ka_cell02
	...
	materials = list(MATERIAL_STEEL = 2000, MATERIAL_GLASS = 1000, MATERIAL_SILVER = 1000)
...
/datum/design/item/mining/ka_cell03
	...
	materials = list(MATERIAL_STEEL = 3000, MATERIAL_GLASS = 3000, MATERIAL_SILVER = 3000, MATERIAL_GOLD = 1000)
...
/datum/design/item/mining/ka_cell04
	...
	materials = list(MATERIAL_STEEL = 4000, MATERIAL_GLASS = 3000, MATERIAL_SILVER = 3000, MATERIAL_GOLD = 1000, MATERIAL_URANIUM = 5000)
...
/datum/design/item/mining/ka_cell05
	...
	materials = list(MATERIAL_STEEL = 5000, MATERIAL_GLASS = 3000, MATERIAL_SILVER = 3000, MATERIAL_GOLD = 1000, MATERIAL_URANIUM = 5000)
	build_path = /obj/item/custom_ka_upgrade/cells/cell05

/datum/design/item/mining/ka_cellinertia
	req_tech = list(TECH_MATERIAL = 5, TECH_ENGINEERING = 6, TECH_MAGNET = 5, TECH_POWER = 5, TECH_PHORON = 5)
	materials = list(MATERIAL_STEEL = 6000, MATERIAL_GLASS = 4000, MATERIAL_SILVER = 4000, MATERIAL_GOLD = 4000, MATERIAL_URANIUM = 5000)
	build_path = /obj/item/custom_ka_upgrade/cells/inertia_charging

/datum/design/item/mining/ka_cellphoron
	req_tech = list(TECH_MATERIAL = 5, TECH_ENGINEERING = 6, TECH_MAGNET = 5, TECH_POWER = 5, TECH_PHORON = 5)
	materials = list(MATERIAL_STEEL = 6000, MATERIAL_GLASS = 4000, MATERIAL_SILVER = 5000, MATERIAL_GOLD = 5000, MATERIAL_PHORON = 4000)
	build_path = /obj/item/custom_ka_upgrade/cells/loader

/datum/design/item/mining/ka_celluranium
	req_tech = list(TECH_MATERIAL = 5, TECH_ENGINEERING = 6, TECH_MAGNET = 5, TECH_POWER = 5, TECH_PHORON = 5)
	materials = list(MATERIAL_STEEL = 6000, MATERIAL_GLASS = 4000, MATERIAL_SILVER = 7000, MATERIAL_GOLD = 7000, MATERIAL_URANIUM = 3000)
	build_path = /obj/item/custom_ka_upgrade/cells/loader/uranium

/datum/design/item/mining/ka_cellhydrogen
	req_tech = list(TECH_MATERIAL = 5, TECH_ENGINEERING = 6, TECH_MAGNET = 5, TECH_POWER = 5, TECH_PHORON = 5)
	materials = list(MATERIAL_STEEL = 6000, MATERIAL_GLASS = 4000, MATERIAL_SILVER = 4000, MATERIAL_GOLD = 4000, MATERIAL_URANIUM = 2000)
...
/datum/design/item/mining/ka_barrel01
	...
	materials = list(MATERIAL_STEEL = 2000, MATERIAL_GLASS = 2000, MATERIAL_URANIUM = 500)
...
/datum/design/item/mining/ka_barrel02
	...
	materials = list(MATERIAL_STEEL = 3000, MATERIAL_GLASS = 2000, MATERIAL_URANIUM = 500)
...
/datum/design/item/mining/ka_barrel03
	...
	materials = list(MATERIAL_STEEL = 4000, MATERIAL_GLASS = 2000, MATERIAL_GOLD = 2000, MATERIAL_URANIUM = 1000)
...
/datum/design/item/mining/ka_barrel04
	...
	materials = list(MATERIAL_STEEL = 5000, MATERIAL_GLASS = 3000, MATERIAL_GOLD = 3000, MATERIAL_URANIUM = 3000, MATERIAL_DIAMOND = 1000)
...
/datum/design/item/mining/ka_barrel05
	...
	materials = list(MATERIAL_STEEL = 6000, MATERIAL_GLASS = 4000, MATERIAL_GOLD = 4000, MATERIAL_URANIUM = 4000, MATERIAL_DIAMOND = 2000)
	build_path = /obj/item/custom_ka_upgrade/barrels/barrel05

/datum/design/item/mining/ka_barrel02_alt
	req_tech = list(TECH_MATERIAL = 1,TECH_ENGINEERING = 1,TECH_MAGNET = 3, TECH_PHORON = 2)
	materials = list(MATERIAL_STEEL = 4000, MATERIAL_GLASS = 3000, MATERIAL_URANIUM = 600)
	build_path = /obj/item/custom_ka_upgrade/barrels/barrel02_alt

/datum/design/item/mining/ka_barrelphoron
	req_tech = list(TECH_MATERIAL = 6, TECH_ENGINEERING = 5, TECH_MAGNET = 6, TECH_PHORON = 5)
	materials = list(MATERIAL_STEEL = 8000, MATERIAL_GLASS = 6000, MATERIAL_GOLD = 6000, MATERIAL_PHORON= 6000, MATERIAL_DIAMOND = 3000)
...
/datum/design/item/mining/ka_upgrade01
	...
	materials = list(MATERIAL_STEEL = 1000, MATERIAL_GLASS = 2000, MATERIAL_GOLD = 1000)
