...
/datum/design/item/mining/ka_frame02
	req_tech = list('materials':1,'engineering':3)
...
/datum/design/item/mining/ka_frame05
	req_tech = list('materials':6,'engineering':6)
...
/datum/design/item/mining/ka_cell01
	req_tech = list('materials':1,'engineering':1,'magnets':1,'powerstorage':1)
...
/datum/design/item/mining/ka_cell02
	req_tech = list('materials':3,'engineering':1,'magnets':1,'powerstorage':3)
...
/datum/design/item/mining/ka_cell03
	req_tech = list('materials':4,'engineering':3,'magnets':2,'powerstorage':3)
...
/datum/design/item/mining/ka_cell04
	req_tech = list('materials':5,'engineering':4,'magnets':3,'powerstorage':5)
...
/datum/design/item/mining/ka_cell05
	req_tech = list('materials':5,'engineering':6,'magnets':5,'powerstorage':5,'phorontech':5)
...
/datum/design/item/mining/ka_barrel01
	req_tech = list('materials':1,'engineering':1,'magnets':1,'phorontech':2)
...
/datum/design/item/mining/ka_barrel02
	req_tech = list('materials':1,'engineering':1,'magnets':3,'phorontech':2)
...
/datum/design/item/mining/ka_barrel03
	req_tech = list('materials':4,'engineering':3,'magnets':3,'phorontech':3)
...
/datum/design/item/mining/ka_barrel04
	req_tech = list('materials':6,'engineering':3,'magnets':5,'phorontech':4)
...
/datum/design/item/mining/ka_barrel05
	req_tech = list('materials':6,'engineering':5,'magnets':6,'phorontech':5)
...
/datum/design/item/mining/ka_upgrade01
	req_tech = list('powerstorage':4,'magnets':4,'programming':4)
