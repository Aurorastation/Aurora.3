...
/datum/design/item/weapon/stunshell/tracking
	materials = list(MATERIAL_STEEL = 3500, MATERIAL_URANIUM = 250)
...
/datum/design/item/weapon/eglaive
	...
	materials = list(MATERIAL_STEEL = 10000, MATERIAL_GLASS = 18750, MATERIAL_PHORON = 3000, MATERIAL_SILVER = 7500)
...
/datum/design/item/weapon/eshield
	...
	materials = list(MATERIAL_STEEL = 1000, MATERIAL_GLASS = 3000, MATERIAL_PHORON = 1000)
...
/datum/design/item/weapon/gravity_gun //Hello, Gordon!
	...
	materials = list(MATERIAL_STEEL = 5000, MATERIAL_GLASS = 5000, MATERIAL_SILVER = 3000, MATERIAL_GOLD = 3000, MATERIAL_PHORON = 500)
