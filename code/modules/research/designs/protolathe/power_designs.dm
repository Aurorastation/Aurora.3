...
/datum/design/item/powercell/device/high
	...
	req_tech = list(TECH_POWER = 2)
	materials = list(MATERIAL_STEEL = 150, MATERIAL_GLASS = 10)
...
/datum/design/item/powercell/mecha/nuclear
	...
	materials = list(MATERIAL_STEEL = 20000, MATERIAL_GLASS = 10000, MATERIAL_URANIUM = 10000)
...
/datum/design/item/powercell/mecha/phoron
	...
	materials = list(MATERIAL_STEEL = 20000, MATERIAL_GLASS = 10000, MATERIAL_PHORON = 5000)
