...
/datum/design/hardsuitmodules/iss_module
	...
	materials = list(MATERIAL_GLASS = 7500, DEFAULT_WALL_MATERIAL = 5000)
...
/datum/design/hardsuitmodules/meson_module
	...
	materials = list(MATERIAL_GLASS = 5000, DEFAULT_WALL_MATERIAL= 1500)
...
/datum/design/hardsuitmodules/nvg_module
	...
	materials = list(MATERIAL_GLASS = 5000, DEFAULT_WALL_MATERIAL = 1500, MATERIAL_URANIUM = 5000)
...
/datum/design/hardsuitmodules/healthscanner_module
	...
	materials = list(MATERIAL_GLASS = 5250, DEFAULT_WALL_MATERIAL = 2500)
...
/datum/design/hardsuitmodules/chem_module
	...
	materials = list(MATERIAL_GLASS = 9250, DEFAULT_WALL_MATERIAL = 10000, MATERIAL_GOLD = 2500, MATERIAL_SILVER = 4250, MATERIAL_PHORON = 5500)
...
/datum/design/hardsuitmodules/plasmacutter_module
	...
	materials = list(MATERIAL_GLASS = 5250, DEFAULT_WALL_MATERIAL = 30000, MATERIAL_SILVER = 5250, MATERIAL_PHORON = 7250)
...
/datum/design/hardsuitmodules/drill_module
	...
	materials = list(MATERIAL_GLASS = 2250, DEFAULT_WALL_MATERIAL = 55000, MATERIAL_SILVER = 5250, MATERIAL_DIAMOND = 3750)
