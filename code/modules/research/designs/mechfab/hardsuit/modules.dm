...
/datum/design/hardsuitmodules/sink_module
	...
	req_tech = list('powerstorage':4,'materials':3,'engineering':4,'syndicate':3)
...
/datum/design/hardsuitmodules/chem_module
	...
	req_tech = list('biotech':5,'materials':4,'programming':3,'phorontech':2)
...
/datum/design/hardsuitmodules/jet_module
	...
	req_tech = list('engineering':4,'materials':3,'powerstorage':2)
...
/datum/design/hardsuitmodules/drill_module
	...
	req_tech = list('engineering':5,'materials':5,'powerstorage':4,'magnets':4)
...
/datum/design/hardsuitmodules/rfd_c_module
	...
	req_tech = list('engineering':6,'materials':5,'powerstorage':5,'bluespace':4)
...
/datum/design/hardsuitmodules/actuators_module
	...
	req_tech = list('engineering':4,'materials':4,'powerstorage':3)
...
/datum/design/hardsuitmodules/taser_module
	...
	req_tech = list('materials':2,'powerstorage':3,'combat':3,'magnets':2)
...
/datum/design/hardsuitmodules/egun_module
	...
	req_tech = list('materials':3,'powerstorage':4,'combat':4,'magnets':3)
...
/datum/design/hardsuitmodules/cooling_module
	...
	req_tech = list('materials':2,'powerstorage':3,'engineering':3)
