...
/datum/design/hardsuitmodules/storage
	...
	materials = list(MATERIAL_STEEL = 30000, MATERIAL_GLASS = 20000)
...
/datum/design/hardsuitmodules/iss_module
	...
	materials = list(MATERIAL_STEEL = 5000, MATERIAL_GLASS = 7500)
...
/datum/design/hardsuitmodules/sechud_module
	...
	materials = list(MATERIAL_STEEL = 1500, MATERIAL_GLASS = 5000)
...
/datum/design/hardsuitmodules/nvg_module
	...
	materials = list(MATERIAL_STEEL = 1500, MATERIAL_GLASS = 5000, MATERIAL_URANIUM = 5000)
...
/datum/design/hardsuitmodules/healthscanner_module
	...
	materials = list(MATERIAL_STEEL = 2500, MATERIAL_GLASS = 5250)
...
/datum/design/hardsuitmodules/chem_module
	...
	materials = list(MATERIAL_STEEL = 10000, MATERIAL_GLASS = 9250, MATERIAL_GOLD = 2500, MATERIAL_SILVER = 4250, MATERIAL_PHORON = 5500)
...
/datum/design/hardsuitmodules/plasmacutter_module
	...
	materials = list(MATERIAL_STEEL = 30000, MATERIAL_GLASS = 5250, MATERIAL_SILVER = 5250, MATERIAL_PHORON = 7250)
...
/datum/design/hardsuitmodules/jet_module
	...
	materials = list(MATERIAL_STEEL = 15000, MATERIAL_GLASS = 4250, MATERIAL_SILVER = 4250, MATERIAL_URANIUM = 5250)
...
/datum/design/hardsuitmodules/drill_module
	...
	materials = list(MATERIAL_STEEL = 55000, MATERIAL_GLASS = 2250, MATERIAL_SILVER = 5250, MATERIAL_DIAMOND = 3750)
...
/datum/design/hardsuitmodules/rfd_c_module
	...
	materials = list(MATERIAL_STEEL = 30000, MATERIAL_PHORON = 12500, MATERIAL_SILVER = 10000, MATERIAL_GOLD = 10000)
...
/datum/design/hardsuitmodules/actuators_module
	...
	materials = list(MATERIAL_STEEL = 85000, MATERIAL_GLASS = 1250)
...
/datum/design/hardsuitmodules/taser_module
	...
	materials = list(MATERIAL_STEEL = 7000, MATERIAL_GLASS = 5250)
...
/datum/design/hardsuitmodules/cooling_module
	...
	materials = list(MATERIAL_STEEL = 7000, MATERIAL_GLASS = 5500)
...
/datum/design/hardsuitmodules/foam_sprayer
	...
	materials = list(MATERIAL_STEEL = 15000, MATERIAL_GLASS = 6000)
