...
/datum/design/item/mechfab/exosuit_equipment/plasma
	...
	materials = list(MATERIAL_STEEL = 2000, MATERIAL_GLASS = 1000, MATERIAL_GOLD = 1000, MATERIAL_PHORON = 1000)
...
/datum/design/item/mechfab/exosuit_equipment/ion
	...
	materials = list(MATERIAL_STEEL = 10000,  MATERIAL_GOLD = 3000, MATERIAL_URANIUM = 3000, MATERIAL_PHORON = 3000)
...
/datum/design/item/mechfab/exosuit_equipment/rcd
	name = "Mounted RFD-C"
	time = 90 SECONDS
	materials = list(MATERIAL_STEEL = 30000, MATERIAL_PHORON = 8000, MATERIAL_STEEL = 15000, MATERIAL_GOLD = 10000)
...
/datum/design/item/mechfab/exosuit_equipment/xray
	...
	materials = list(MATERIAL_STEEL = 20000, MATERIAL_GOLD = 6000, MATERIAL_PHORON = 6000)
...
/datum/design/item/mechfab/exosuit_equipment/flashbang
	...
	materials = list(MATERIAL_STEEL = 20000, MATERIAL_GOLD = 3000, MATERIAL_SILVER = 3000)
...
/datum/design/item/mechfab/exosuit_equipment/crisisdrone
	...
	materials = list(MATERIAL_STEEL = 10000, MATERIAL_GLASS = 5000, MATERIAL_GOLD = 1000, MATERIAL_SILVER = 2000)
...
/datum/design/item/mechfab/exosuit_equipment/autolathe
	...
	materials = list(MATERIAL_STEEL = 10000, MATERIAL_SILVER = 1000)
