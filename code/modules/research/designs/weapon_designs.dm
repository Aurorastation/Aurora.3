...
/datum/design/item/gun/Fabricate()
	var/obj/item/gun/C = ..()
...
/datum/design/item/modular_small
	id = "stock_small"
...
/datum/design/item/modular_medium
	id = "stock_medium"
	req_tech = list(TECH_MATERIAL = 1)
	materials = list(DEFAULT_WALL_MATERIAL = 4000)
...
/datum/design/item/modular_large
	id = "stock_large"
...
/datum/design/item/modular_starch
	id = "stock_starch"
...
/datum/design/item/modular_capacitor_reinforced
...
/datum/design/item/modular_nuke
	id = "stock_nuke_cap"
...
/datum/design/item/modular_teranium
	id = "stock_teranium"
...
/datum/design/item/modular_phoron
	id = "stock_phoron"
...
/datum/design/item/modular_lens
	id = "stock_lens"
...
/datum/design/item/modular_splitter
	id = "stock_splitter"
...
/datum/design/item/modular_sniper
	id = "stock_sniper"
	req_tech = list(TECH_MATERIAL = 2, TECH_ENGINEERING = 1)
	materials = list(DEFAULT_WALL_MATERIAL = 750, "glass" = 2000)
...
/datum/design/item/modular_reinforced
	id = "stock_strong"
	req_tech = list(TECH_MATERIAL = 2, TECH_ENGINEERING = 1)
...
/datum/design/item/modular_silent
	id = "stock_silence"
...
/datum/design/item/modular_surge
	id = "stock_surge"
...
/datum/design/item/modular_repeater
	id = "stock_repeater"
...
/datum/design/item/modular_overcharge
	id = "stock_repeater"
...
/datum/design/item/modular_gatling
	id = "stock_gat"
...
/datum/design/item/modular_scope
	id = "stock_scope"
...
/datum/design/item/modular_barrel
	id = "stock_barrel"
	req_tech = list(TECH_COMBAT = 2, TECH_MATERIAL = 2)
	materials = list(DEFAULT_WALL_MATERIAL = 3000)
...
/datum/design/item/modular_vents
	id = "stock_vents"
	req_tech = list(TECH_COMBAT = 2, TECH_MATERIAL = 2)
	materials = list(DEFAULT_WALL_MATERIAL = 3000)
...
/datum/design/item/modular_stock
	id = "stock_stock"
	req_tech = list(TECH_COMBAT = 2, TECH_MATERIAL = 2)
	materials = list(DEFAULT_WALL_MATERIAL = 3000)
...
/datum/design/item/modular_bayonet
	id = "stock_bayonet"
	req_tech = list(TECH_COMBAT = 2, TECH_MATERIAL = 2)
	materials = list(DEFAULT_WALL_MATERIAL = 3000)
...
/datum/design/item/modular_ebayonet
	id = "stock_ebayonet"
...
/datum/design/item/modular_grip
	id = "stock_grip"
	req_tech = list(TECH_COMBAT = 2, TECH_MATERIAL = 2)
	materials = list(DEFAULT_WALL_MATERIAL = 3000)
...
/datum/design/item/modular_taser
	id = "stock_taser"
...
/datum/design/item/modular_tesla
	id = "stock_supertaser"
...
/datum/design/item/modular_soma
	id = "stock_soma"
	req_tech = list(TECH_MATERIAL = 2, TECH_BIO = 3, TECH_POWER = 3)
...
/datum/design/item/modular_beta
	id = "stock_beta"
	req_tech = list(TECH_MATERIAL = 2, TECH_BIO = 3, TECH_POWER = 3)
	materials = list(DEFAULT_WALL_MATERIAL = 1000, "glass" = 250, "uranium" = 250)
...
/datum/design/item/modular_pest
	id = "stock_pest"
...
/datum/design/item/modular_tag1
	id = "stock_tag1"
...
/datum/design/item/modular_tag2
	id = "stock_tag2"
	req_tech = list(TECH_COMBAT = 1, TECH_MATERIAL = 1)
	materials = list(DEFAULT_WALL_MATERIAL = 2000)
...
/datum/design/item/modular_tag3
	id = "stock_tag3"
...
/datum/design/item/modular_practice
	id = "stock_practice"
	req_tech = list(TECH_MATERIAL = 1)
	materials = list(DEFAULT_WALL_MATERIAL = 2000)
...
/datum/design/item/modular_decloner
	id = "stock_declone"
...
/datum/design/item/modular_ebow
	id = "stock_ebow"
...
/datum/design/item/modular_blaster
	id = "stock_blaster"
...
/datum/design/item/modular_laser
	id = "stock_laser"
...
//Upgrades
/datum/design/item/ka_upgrade01
	id = "ka_upgrade01"
...
/datum/design/item/ka_upgrade02
	id = "ka_upgrade02"
	req_tech = list(TECH_POWER = 4,TECH_MAGNET = 4, TECH_DATA = 4)
	materials = list(DEFAULT_WALL_MATERIAL = 1000, "glass" = 2000, "gold" = 1000)
...
/datum/design/item/ka_upgrade03
	id = "ka_upgrade03"
	req_tech = list(TECH_POWER = 4,TECH_MAGNET = 4, TECH_DATA = 4)
	materials = list(DEFAULT_WALL_MATERIAL = 1000, "glass" = 2000, "gold" = 1000)
...
/datum/design/item/ka_upgrade04
	id = "ka_upgrade04"
	req_tech = list(TECH_POWER = 4,TECH_MAGNET = 4, TECH_DATA = 4)
	materials = list(DEFAULT_WALL_MATERIAL = 1000, "glass" = 2000, "gold" = 1000)
...
/datum/design/item/ka_upgrade05
	id = "ka_upgrade05"
	req_tech = list(TECH_POWER = 4,TECH_MAGNET = 4, TECH_DATA = 4)
	materials = list(DEFAULT_WALL_MATERIAL = 1000, "glass" = 2000, "gold" = 1000)
...
/datum/design/item/ka_upgrade06
	id = "ka_upgrade06"
	req_tech = list(TECH_POWER = 4,TECH_MAGNET = 4, TECH_DATA = 4)
	materials = list(DEFAULT_WALL_MATERIAL = 1000, "glass" = 2000, "gold" = 1000)
...
/datum/design/item/ka_upgrade07
	id = "ka_upgrade07"
	req_tech = list(TECH_POWER = 4,TECH_MAGNET = 4, TECH_DATA = 4)
	materials = list(DEFAULT_WALL_MATERIAL = 1000, "glass" = 2000, "gold" = 1000)
