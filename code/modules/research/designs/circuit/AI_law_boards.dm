...
/datum/design/circuit/aimodule/quarantine
	name = "Quarantine"
	req_tech = "{'programming':3,'biotech':2,'materials':4}"
...
/datum/design/circuit/aimodule/core/tyrant
	name = "T.Y.R.A.N.T."
	req_tech = "{'programming':4,'syndicate':2,'materials':6}"
