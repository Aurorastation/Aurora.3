...
/datum/design/circuit/machine/mech_recharger
	name = "Mech Recharger"
	req_tech = list('programming':2,'powerstorage':2,'engineering':2)
...
/datum/design/circuit/machine/crusher_base
	...
	req_tech = list('engineering':3,'programming':1,'magnets':1,'materials':3)
...
/datum/design/circuit/machine/rtg
	...
	req_tech = list('engineering':2,'programming':1,'powerstorage':3,'materials':2)
...
/datum/design/circuit/machine/advanced_rtg
	...
	req_tech = list('engineering':3,'programming':3,'powerstorage':3,'materials':4,'phorontech':2)
...
/datum/design/circuit/machine/weapons_analyzer
	...
	req_tech = list('programming':2,'engineering':3,'combat':2)
