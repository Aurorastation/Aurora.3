	...
	if (istype(W, /obj/item/reagent_containers/))
		if(W.reagents.has_reagent(/datum/reagent/hydrazine, 1) || W.reagents.has_reagent(/datum/reagent/water, 1))
			...
			if(secondary_effect?.trigger == TRIGGER_VOLATILE)
				secondary_effect.ToggleActivate()
		else if(W.reagents.has_reagent(/datum/reagent/toxin, 1) || W.reagents.has_reagent(/datum/reagent/toxin/cyanide, 1) || W.reagents.has_reagent(/datum/reagent/toxin/amanitin, 1) || W.reagents.has_reagent(/datum/reagent/toxin/neurotoxin, 1))
