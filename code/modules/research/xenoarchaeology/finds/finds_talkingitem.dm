...
/datum/talking_atom/proc/catchMessage(var/msg, var/mob/source)
	...
	if(prob(30))
		...
		holder_atom.loc.visible_message("<span class='notice'>[hicon(holder_atom)] [pick(options)]</span>")
...
/datum/talking_atom/proc/SaySomething(var/word = null)
	...
	for(var/mob/M in listening)
		to_chat(M, "[hicon(holder_atom)] <b>[holder_atom]</b> reverberates, <span class='notice'>\"[msg]\"</span>")
