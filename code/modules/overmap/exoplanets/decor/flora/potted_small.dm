/obj/structure/flora/pottedplant_small
	name = "potted plant"
	desc = "A potted plant."
...
/obj/structure/flora/pottedplant_small/proc/death()
	if(!dead)
...
/obj/structure/flora/pottedplant_small/ex_act(var/severity = 2.0)
	death()
	return ..()

/obj/structure/flora/pottedplant_small/fire_act()
	death()
	return ..()

/obj/structure/flora/pottedplant_small/bullet_act(var/obj/item/projectile/Proj)
...
/obj/structure/flora/pottedplant_small/crystal
	name = "crystalline potted plant"
	desc = "A ropey, aquatic plant. Odd crystal formations grow on the end."
	icon_state = "plant-15"

/obj/structure/flora/pottedplant_small/subterranean
