...
/obj/effect/overmap/visitable/sector/temporary/New(var/nx, var/ny, var/nz)
	loc = locate(nx, ny, SSmapping.current_map.overmap_z)
	x = nx
	y = ny
	map_z += nz
...
/proc/get_deepspace(x,y)
	var/obj/effect/overmap/visitable/sector/temporary/res = locate(x, y, SSmapping.current_map.overmap_z)
	if(istype(res))
		return res
		...
		return new /obj/effect/overmap/visitable/sector/temporary(x, y, SSmapping.current_map.get_empty_zlevel())
...
/proc/overmap_spacetravel(var/turf/space/T, var/atom/movable/A)
	...
	var/turf/map = locate(M.x,M.y,SSmapping.current_map.overmap_z)
