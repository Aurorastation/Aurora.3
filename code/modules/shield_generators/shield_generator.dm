/obj/machinery/power/shield_generator
	...
	density = TRUE
	var/datum/wires/shield_generator
...
/obj/machinery/power/shield_generator/RefreshParts()
	...
	mitigation_max = MAX_MITIGATION_BASE + MAX_MITIGATION_RESEARCH * capacitor_rating
...
/obj/machinery/power/shield_generator/Topic(user, href_list, datum/topic_state/state)
