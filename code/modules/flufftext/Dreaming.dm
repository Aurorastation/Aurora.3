...
var/list/dreams = list(
	...
	"the quartermaster","a cargo technician","the botanist","a shaft miner","the psychologist","the chemist","a beaker of strange liquid",
	...
	"a unathi","a tajaran","the ai core","the mining station","the research station",
	)
