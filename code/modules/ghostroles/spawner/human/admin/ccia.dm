...
/datum/ghostspawner/human/admin/corporate/ccia_agent/New()
	desc = "Board the [SSmapping.current_map.station_name], annoy crew with your interviews and get squashed by your own shuttle."
	..()
...
/datum/ghostspawner/human/admin/corporate/scc_agent/New()
	desc = "Board the [SSmapping.current_map.station_name], annoy crew with your interviews and get squashed by your own shuttle. But this time you're blue."
	..()
