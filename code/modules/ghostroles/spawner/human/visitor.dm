...
/datum/ghostspawner/human/visitor/New()
	desc = "You are a random visitor that boarded the [SSmapping.current_map.station_name], visiting for any reason you can think of. You do not have any records, as you are not an employee of [SSmapping.current_map.company_short]."
	..()

/datum/ghostspawner/human/visitor/select_spawnlocation(var/use = TRUE)
	if(SSmapping.current_map.force_spawnpoint)
