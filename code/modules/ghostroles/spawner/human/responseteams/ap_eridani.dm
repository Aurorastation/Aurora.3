/datum/ghostspawner/teshari/ert/ap_eridani
...
/datum/ghostspawner/teshari/ert/ap_eridani/lead
...
/datum/ghostspawner/teshari/ert/ap_eridani/doctor
	...
	possible_species = list(SPECIES_teshari, SPECIES_teshari_OFFWORLD, SPECIES_SKRELL, SPECIES_SKRELL_AXIORI, SPECIES_IPC_SHELL)

/datum/ghostspawner/teshari/ert/ap_eridani/corpsman
	...
	possible_species = list(SPECIES_teshari, SPECIES_teshari_OFFWORLD, SPECIES_TAJARA, SPECIES_TAJARA_MSAI, SPECIES_TAJARA_ZHAN, SPECIES_SKRELL, SPECIES_SKRELL_AXIORI, SPECIES_UNATHI, SPECIES_VAURCA_WARRIOR, SPECIES_VAURCA_WORKER, SPECIES_IPC, SPECIES_IPC_ZENGHU, SPECIES_IPC_BISHOP, SPECIES_IPC_SHELL)
