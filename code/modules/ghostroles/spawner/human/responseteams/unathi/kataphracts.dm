...
/datum/ghostspawner/human/ert/kataphract/New()
	welcome_message = "You're part of the local Kataphract guild, a knight-like organization of Unathi who roam the galaxy to do good. You've picked up a distress signal coming from the [SSmapping.current_map.station_name], owned by the SCC. You prefer to use melee weaponry, but will pull out your emergency pistol in a pinch. <span class='danger'>Remember to roleplay like an Unathi, even if you aren't whitelisted for it! Set auto-hiss in the OOC tab to basic or full.</span>"
	..()
...
/datum/ghostspawner/human/ert/kataphract/klax/New()
	welcome_message = "You're part of the local Kataphract guild, a knight-like organization of Unathi who roam the galaxy to do good. You've picked up a distress signal coming from the [SSmapping.current_map.station_name], owned by the SCC. You prefer to use melee weaponry, but will pull out your emergency pistol in a pinch. Let the Unathi teach you how to become an honourable Knight, follow their lead. Achieve glory for the Hive!"
	..()
