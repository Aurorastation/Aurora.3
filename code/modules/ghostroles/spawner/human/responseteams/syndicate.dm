...
/datum/ghostspawner/human/ert/commando/New()
	..()
	welcome_message = "The order has been given - the [SSmapping.current_map.station_name] and its crew are to be wiped off the star-charts, by any means necessary."
