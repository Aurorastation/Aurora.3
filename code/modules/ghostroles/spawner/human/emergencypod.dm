...
/datum/ghostspawner/human/rescuepodsurv/New()
	...
	if(t == "star")
		...
		possible_species = list(SPECIES_HUMAN, SPECIES_HUMAN_OFFWORLD, SPECIES_TAJARA, SPECIES_TAJARA_MSAI, SPECIES_TAJARA_ZHAN, SPECIES_SKRELL, SPECIES_SKRELL_AXIORI, SPECIES_UNATHI, SPECIES_VAURCA_WARRIOR, SPECIES_VAURCA_WORKER, SPECIES_IPC, SPECIES_IPC_SHELL, SPECIES_DIONA) // TCFL accepts everyone. Heavy frames have been excluded because they can't wear the hardsuit, which has the suit cooler.
	else if(t == "fsf")
