	...
	switch(rand(1,15))
		...
		if(10 to 15)    //Announcements that would be made by a player instead of random event
			var/list/body = list(
						...
						"This is your directive 11. [pick("Gremorian have killed several crew.", "Boarders have taken a hostage.", "[holder] is armed and dangerous. Avoid them at all costs.", "Two black-suited individuals have taken items from the armory.")]",
