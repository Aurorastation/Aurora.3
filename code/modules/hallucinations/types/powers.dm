...
/datum/hallucination/mindread/start()
	...
	switch(rand(1, 3))
		if(1)
			...
			to_chat(holder, SPAN_ALERT("It has come to our attention that the [current_map.station_type] has passed through an unusual ion storm. Several crewmembers are exhibiting unusual abilities."))
		if(2)
