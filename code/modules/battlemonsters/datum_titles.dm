...
datum/battle_monsters/title/wise
	...
	special_effects = "Elemental Defense: %NAME temporarily gains <b>1000</b> bonus defense points when defending against another %ELEMENT_OR type monster."
	rarity = 0.5
...
datum/battle_monsters/title/elemental
	...
	special_effects = "Elemental Offense: %NAME gains <b>1000</b> attack points when attacking against another %ELEMENT_OR type monster."
	rarity = 0.5
