...
/// power thingy: Base type for integrated power circuits.
...
/// Implements `make_energy` behavior for this integrated electronics type.
/obj/item/integrated_circuit/passive/power/proc/make_energy()
	return

// For calculators.
/// tiny photovoltaic cell: A very small solar cell for low-power assemblies. The cell generates up to 100 W of energy in optimal lighting conditions. Less light will result in less power being generated.
/// Wire inputs, pulse activators, and route outputs according to the pin definitions below.
...
/obj/item/integrated_circuit/passive/power/solar_cell/make_energy()
	...
	// Stores `light_amount` state used by this integrated electronics object.
	var/light_amount = T ? T.get_lumcount() : 0
	// Stores `adjusted_power` state used by this integrated electronics object.
...
/// tesla power relay: Connects to nearby APCs wirelessly and draws power from them.
/// Wire inputs, pulse activators, and route outputs according to the pin definitions below.
/obj/item/integrated_circuit/passive/power/relay
	...
	// Stores `power_amount` state used by this integrated electronics object.
	var/power_amount = 1000

// For really fat machines.
/// large tesla power relay: Connects to nearby APCs wirelessly and draws a larger amount of power from them..
/// Wire inputs, pulse activators, and route outputs according to the pin definitions below.
...
// For implants.
/// metabolic siphon: Converts a host's nutrients into electricity, or uses electricity to supply nutrients.
/// Wire inputs, pulse activators, and route outputs according to the pin definitions below.
/obj/item/integrated_circuit/passive/power/metabolic_siphon
	...
	// Stores `inefficiency` state used by this integrated electronics object.
	var/inefficiency = 1.2

/// Implements `test_validity` behavior for this integrated electronics type.
...
/obj/item/integrated_circuit/passive/power/metabolic_siphon/make_energy()
	// Stores `host` state used by this integrated electronics object.
...
/// internal energy siphon: A small circuit designed to be connected to an internal power wire inside a synthetic entity.
/// Wire inputs, pulse activators, and route outputs according to the pin definitions below.
...
/// fuel cell: Produces electricity from chemicals.
/// Wire inputs, pulse activators, and route outputs according to the pin definitions below.
/obj/item/integrated_circuit/passive/power/chemical_cell
	...
	var/volume = 60
	// Stores `fuel` state used by this integrated electronics object.
...
/// power network interface: Gives or takes power from a wire underneath the machine.
/// Wire inputs, pulse activators, and route outputs according to the pin definitions below.
