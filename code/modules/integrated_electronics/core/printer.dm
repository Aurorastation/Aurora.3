...
/obj/item/integrated_circuit_printer/ui_data(mob/user)
	...
	data["assembly_to_clone"] = assembly_to_clone ? assembly_to_clone.name : clone_blueprint_name ? clone_blueprint_name : "None"
