GLOBAL_LIST_EMPTY_TYPED(escape_pods, /datum/shuttle/ferry/escape_pod)
...
/datum/shuttle/ferry/escape_pod/Destroy()
	GLOB.escape_pods -= src
...
/datum/shuttle/ferry/escape_pod/can_force()
	if(arming_controller.emagged && next_location && moving_status == SHUTTLE_IDLE)
		return TRUE
...
/datum/shuttle/ferry/escape_pod/pod/escape_pod##NUMBER { \
...
/datum/shuttle/ferry/escape_pod/pod
	category = /datum/shuttle/ferry/escape_pod/pod
...
/datum/shuttle/ferry/emergency/aurora
	name = "Escape Shuttle"
	location = 1
	warmup_time = 10 SECONDS
...
/datum/shuttle/ferry/arrival/aurora
...
/datum/shuttle/ferry/supply/aurora
	name = "Supply Shuttle"
	location = 1
...
/datum/shuttle/multi/antag/burglar_aurora
	name = "Water Bear"
...
/datum/shuttle/multi/antag/skipjack_aurora/New()
	name = "Skipjack"
...
/datum/shuttle/multi/antag/merc_aurora/New()
...
/datum/shuttle/multi/merc_aurora_elite
	name = "Merc Elite"
...
/datum/shuttle/multi/legion
	...
	warmup_time = 10 SECONDS
	move_time = 75
	ceiling_baseturf = /turf/simulated/shuttle_roof/legion
