...
/obj/machinery/computer/shuttle_control/multi/lift/ui_interact(mob/user, datum/tgui/ui)
	var/datum/shuttle/multi/lift/shuttle = SSshuttle.shuttles[shuttle_tag]
	if(!istype(shuttle))
...
/obj/machinery/computer/shuttle_control/multi/lift/handle_topic_href(var/mob/user, var/datum/shuttle/multi/lift/shuttle, var/action, var/list/params)
	if(action == "pick")
