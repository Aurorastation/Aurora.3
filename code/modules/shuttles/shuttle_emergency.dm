...
/datum/shuttle/ferry/emergency/launch(var/user)
	...
	if(usr)
		log_admin(text="[key_name(usr)] has overridden the shuttle autopilot and activated launch sequence",ckey=key_name(usr))
...
/datum/shuttle/ferry/emergency/force_launch(var/user)
	...
	if(usr)
		log_admin(text="[key_name(usr)] has overridden the shuttle autopilot and forced immediate launch",ckey=key_name(usr))
...
/datum/shuttle/ferry/emergency/cancel_launch(var/user)
	...
	if(usr)
		log_admin(text="[key_name(usr)] has overridden the shuttle autopilot and cancelled launch sequence",ckey=key_name(usr))
...
/obj/machinery/computer/shuttle_control/emergency/proc/read_authorization(var/obj/item/ident)
	...
	if(usr)
		log_admin(text="[key_name(usr)] has inserted [ID] into the shuttle control computer - [req_authorizations - authorized.len] authorisation\s needed",ckey=key_name(usr))
