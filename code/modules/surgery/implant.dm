...
/singleton/surgery_step/cavity/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/cavity/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
...
/singleton/surgery_step/cavity/make_space/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	return affected && !affected.cavity

/singleton/surgery_step/cavity/make_space/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/cavity/make_space/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/chest/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/cavity/close_space/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	return affected && affected.cavity

/singleton/surgery_step/cavity/close_space/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/cavity/close_space/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/chest/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/cavity/place_item/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/cavity/place_item/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/cavity/place_item/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/chest/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/cavity/implant_removal/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/cavity/implant_removal/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/cavity/implant_removal/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/chest/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/cavity/implant_removal/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	..()
	var/obj/item/organ/external/chest/affected = target.get_organ(target_zone)
