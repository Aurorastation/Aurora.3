...
/singleton/surgery_step/glue_bone/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/glue_bone/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/glue_bone/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/glue_bone/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/set_bone/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/set_bone/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/set_bone/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/set_bone/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/mend_skull/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	return affected && affected.name == BP_HEAD && !BP_IS_ROBOTIC(affected) && affected.open >= ORGAN_OPEN_RETRACTED && affected.stage == BONE_GLUED

/singleton/surgery_step/mend_skull/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
...
/singleton/surgery_step/mend_skull/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/mend_skull/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/finish_bone/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/finish_bone/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/finish_bone/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/finish_bone/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
