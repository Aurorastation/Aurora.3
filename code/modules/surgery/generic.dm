...
/singleton/surgery_step/generic/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(isslime(target))
		return FALSE
...
/singleton/surgery_step/generic/cut_with_laser/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	return affected && affected.open == ORGAN_CLOSED && target_zone != BP_MOUTH

/singleton/surgery_step/generic/cut_with_laser/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/cut_with_laser/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/cut_with_laser/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/incision_manager/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	return affected && affected.open == ORGAN_CLOSED && target_zone != BP_MOUTH

/singleton/surgery_step/generic/incision_manager/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/incision_manager/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/incision_manager/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/cut_open/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
	if(isvaurca(target))
		return FALSE
...
/singleton/surgery_step/generic/cut_open/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/cut_open/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/cut_open/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/cut_open_vaurca/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
	if(!(isvaurca(target)))
		return FALSE
...
/singleton/surgery_step/generic/cut_open_vaurca/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/cut_open_vaurca/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/cut_open_vaurca/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/clamp_bleeders/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/generic/clamp_bleeders/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/clamp_bleeders/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/clamp_bleeders/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/retract_skin/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/generic/retract_skin/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/retract_skin/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/retract_skin/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/cauterize/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/generic/cauterize/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/cauterize/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/generic/cauterize/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
