...
/singleton/surgery_step/robotics/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
	if(isslime(target))
		return FALSE
...
/singleton/surgery_step/robotics/unscrew_hatch/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/robotics/unscrew_hatch/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/unscrew_hatch/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/unscrew_hatch/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/screw_hatch/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/robotics/screw_hatch/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/screw_hatch/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/screw_hatch/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/open_hatch/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/robotics/open_hatch/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/open_hatch/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/open_hatch/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/close_hatch/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/robotics/close_hatch/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/close_hatch/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/close_hatch/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/repair_brute/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/robotics/repair_brute/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/repair_brute/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(tool.iswelder())
		var/obj/item/weldingtool/welder = tool
		if(!welder.isOn())
...
/singleton/surgery_step/robotics/repair_brute/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/repair_burn/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/robotics/repair_burn/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/repair_burn/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/repair_burn/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/detach_organ_robotic/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/robotics/detach_organ_robotic/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
...
/singleton/surgery_step/robotics/detach_organ_robotic/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
...
/singleton/surgery_step/robotics/detach_organ_robotic/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
...
/singleton/surgery_step/robotics/attach_organ_robotic/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/robotics/attach_organ_robotic/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
...
/singleton/surgery_step/robotics/attach_organ_robotic/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
...
/singleton/surgery_step/robotics/attach_organ_robotic/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	user.visible_message(SPAN_WARNING("[user]'s hand slips, disconnecting \the [tool]."), \
		SPAN_WARNING("Your hand slips, disconnecting \the [tool]."))
...
/singleton/surgery_step/robotics/install_mmi/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/robotics/install_mmi/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/install_mmi/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/robotics/install_mmi/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
