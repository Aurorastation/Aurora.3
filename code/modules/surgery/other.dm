...
/singleton/surgery_step/fix_vein/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/fix_vein/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/fix_vein/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	...
	if(isteshari(user) && prob(40))
		user:bloody_hands(target, 0)

/singleton/surgery_step/fix_vein/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/internal/fix_dead_tissue/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/internal/fix_dead_tissue/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	var/obj/item/organ/internal/organ
	for(var/obj/item/organ/internal/I in affected.internal_organs)
		if((I.status & ORGAN_DEAD) && !BP_IS_ROBOTIC(I))
...
/singleton/surgery_step/internal/fix_dead_tissue/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
...
/singleton/surgery_step/internal/fix_dead_tissue/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/treat_necrosis/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/treat_necrosis/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/treat_necrosis/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	if (!istype(tool, /obj/item/reagent_containers))
		return
...
/singleton/surgery_step/treat_necrosis/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	if (!istype(tool, /obj/item/reagent_containers))
		return
...
/singleton/surgery_step/fix_tendon/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/fix_tendon/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/fix_tendon/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/fix_tendon/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	user.visible_message(SPAN_WARNING("[user]'s hand slips, smearing [tool] in the incision in [target]'s [affected.name]!") , \
		SPAN_WARNING("Your hand slips, smearing [tool] in the incision in [target]'s [affected.name]!"))
...
/singleton/surgery_step/hardsuit/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/hardsuit/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	user.visible_message("[user] starts cutting through the support systems of [target]'s [target.back] with \the [tool]." , \
		"You start cutting through the support systems of [target]'s [target.back] with \the [tool].")
	..()

/singleton/surgery_step/hardsuit/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
...
/singleton/surgery_step/amputate/can_use(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	if(!..())
		return FALSE
...
/singleton/surgery_step/amputate/begin_step(mob/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/amputate/end_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/singleton/surgery_step/amputate/fail_step(mob/living/user, mob/living/carbon/teshari/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
