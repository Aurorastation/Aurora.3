...
/datum/codex_entry/rcd
	associated_paths = list(/obj/item/rfd)
	...
	lore_text = "Advents in material printing and synthesis technology have produced everyday miracles, such as the RFD, which in certain industries has single-handedly put entire construction crews out of a job."
	antag_text = "RFDs can be incredibly dangerous in the wrong hands. Use them to swiftly block off corridors, or instantly breach the ship wherever you want."
