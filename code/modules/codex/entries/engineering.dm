/datum/codex_entry/supermatter
	...
	antag_text = "ALWAYS AHELP BEFORE TOUCHING THE SM! Exposing the supermatter to oxygen or vaccuum will cause it to start rapidly heating up.  Sabotaging the supermatter and making it explode will \
