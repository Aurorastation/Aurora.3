...
/obj/machinery/beehive/attackby(var/obj/item/I, var/mob/user)
	if(I.iscrowbar())
		...
		if(do_after(user, 150/I.toolspeed - 150/I.toolspeed * (skill_time_reduction("construction", 0.15, user) + skill_time_reduction("botany", 0.05, user))))
...
/obj/machinery/beehive/attack_hand(var/mob/user)
	if(!closed)
		...
		while(honeycombs >= 100 && do_after(user, 30 - 30 * skill_time_reduction("botany", 0.1, user)))
...
/obj/item/beehive_assembly/attack_self(var/mob/user)
	...
	if(do_after(user, 30 - 30 * (skill_time_reduction("construction", 0.1, user) + skill_time_reduction("botany", 0.05, user))))
