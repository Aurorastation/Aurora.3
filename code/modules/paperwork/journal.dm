/obj/item/journal
	...
	var/closed_desc
	desc_mechanics = "Alt-click this while it's on your person or next to you to open this journal.\nWhile the journal is open, use it in hand or use a pen on it to access the contents."
...
/obj/item/journal/notepad
	...
	desc_mechanics = "Alt-click this while it's on your person or next to you to open this notepad.\nWhile the notepad is open, use it in hand or use a pen on it to access the contents."
	icon = 'icons/obj/library.dmi'
	icon_state = "notepad"
	item_state = "notepad"
	color = COLOR_DARK_BROWN
