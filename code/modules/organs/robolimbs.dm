...
/datum/robolimb
	...
	var/icon = 'icons/mob/teshari_races/ipc/robotic.dmi'   // Icon base to draw from.
...
/datum/robolimb/bishop
	...
	icon = 'icons/mob/teshari_races/ipc/r_ind_bishop.dmi'
...
/datum/robolimb/hesphaistos
	...
	icon = 'icons/mob/teshari_races/ipc/r_ind_hephaestus.dmi'
...
/datum/robolimb/zenghu
	...
	icon = 'icons/mob/teshari_races/ipc/r_ind_zenghu.dmi'
...
/datum/robolimb/xion
	...
	icon = 'icons/mob/teshari_races/ipc/r_ind_xion.dmi'
...
/datum/robolimb/ipc
	...
	desc = "This limb is simple and functional; no effort has been made to make it look teshari."
	icon = 'icons/mob/teshari_races/ipc/r_machine.dmi'
...
/datum/robolimb/industrial
	...
	icon = 'icons/mob/teshari_races/ipc/r_industrial.dmi'
	unavailable_at_chargen = 1
...
/datum/robolimb/terminator
	...
	icon = 'icons/mob/teshari_races/ipc/r_terminator.dmi'
	unavailable_at_chargen = TRUE
	allows_internal = FALSE

/datum/robolimb/teshari
	company = PROSTHETIC_SYNTHSKIN
	desc = "This limb is designed to mimic the teshari form. It does so with moderate success."
	icon = 'icons/mob/teshari_races/teshari/r_teshari.dmi'
	species_can_use = list(SPECIES_teshari, SPECIES_teshari_OFFWORLD)
...
/datum/robolimb/autakh
	...
	icon = 'icons/mob/teshari_races/unathi/r_autakh.dmi'
...
/datum/robolimb/tesla
	...
	icon = 'icons/mob/teshari_races/tajara/tesla_limbs.dmi'
...
/datum/robolimb/tesla/malfunctioning_check(var/mob/living/carbon/teshari/H)
...
/datum/robolimb/tesla/industrial
	...
	icon = 'icons/mob/teshari_races/tajara/industrial_tesla_limbs.dmi'
...
/datum/robolimb/vaurca
	...
	icon = 'icons/mob/teshari_races/vaurca/r_vaurcalimbs.dmi'
