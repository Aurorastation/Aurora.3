...
/obj/item/organ/external/hand/right/autakh/medical/can_activate()
	if(owner.last_special > world.time)
		to_chat(owner, SPAN_DANGER("\The [src] is still recharging!"))
		return FALSE
...
/obj/item/organ/external/hand/right/autakh/security/can_activate()
	if(owner.last_special > world.time)
		to_chat(owner, SPAN_DANGER("\The [src] is still recharging!"))
		return FALSE
...
/obj/item/organ/external/hand/right/autakh/security/activate(atom/target)
	if(!ishuman(target))
		return FALSE
