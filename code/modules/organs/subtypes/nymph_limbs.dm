...
/decl/nymph_limb
    var/list/valid_species = list("Unathi", "Aut'akh Unathi")
    ...
    // Child limbs
    var/list/nymph_extremity_types = list(
        /obj/item/organ/external/hand/nymph,
        /obj/item/organ/external/hand/right/nymph,
        /obj/item/organ/external/foot/nymph,
        /obj/item/organ/external/foot/right/nymph
...
/obj/item/organ/external/proc/detach_nymph_limb()
    ...
    to_chat(nymph_owner, span("warning", "The nymph attached to you as \a [name] unlatches its tendrils from your body and drops to \the [get_turf(src)]."))
    to_chat(nymph, span("notice", "You tear your tendrils free of your host and drop to \the [get_turf(src)]."))
