...
/obj/item/organ/internal/augment/bioaug/auxiliary_heart/proc/stabilize_circulation(implantee, obj/item/organ/internal/heart/heart, blood_volume, recent_pump, pulse_mod, min_efficiency)
	SIGNAL_HANDLER
	*min_efficiency = *min_efficiency * 1.5
	*blood_volume = *blood_volume + 2.5 // This doesn't affect actual blood volume, only the "effective" volume used for calculating thresholds.
