...
/obj/item/organ/stack/vox/removed(var/mob/living/user)
	if(owner && ishuman(owner))
		...
		if(prob(80))
			...
			owner << "<span class='warning'> Your mind breaks apart when your cortical stack is removed! Your memories and personality are nothing but echoes lost in the numbness of your toughts....</span>"
