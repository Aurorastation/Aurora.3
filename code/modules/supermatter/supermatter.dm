...
/obj/machinery/power/supermatter
	...
	After integrity falls to zero percent, it will delaminate, causing a massive explosion, ship-wide radiation spikes, and hallucinations. \
	...
	Sabotaging the supermatter and making it explode will cause a period of lag as the explosion is processed by the server, as well as irradiating the entire ship and causing hallucinations to happen.  \
