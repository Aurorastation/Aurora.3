/obj/item/weapon/gun/projectile/revolver
	name = "revolver"
	desc = "The revised Mark II Necropolis Industries revolver, chambering .357 rounds and utilizing a robust firing mechanism to deliver deadly rounds downrange. This is a monster of a hand cannon with a beautiful cedar grip, with a transparent plastic cover so as to not splinter your hands while firing."
	icon_state = "revolver"
	item_state = "revolver"
	accuracy = 1
	caliber = "357"
