...
/obj/item/gun/projectile/automatic/rifle/can_wield()
	return 1

/obj/item/gun/projectile/automatic/rifle/ui_action_click()
	if(src in usr)
		toggle_wield(usr)

/obj/item/gun/projectile/automatic/rifle/verb/wield_rifle()
...
/obj/item/gun/projectile/automatic/terminator/can_wield()
	return 1

/obj/item/gun/projectile/automatic/terminator/ui_action_click()
	if(src in usr)
		toggle_wield(usr)

/obj/item/gun/projectile/automatic/terminator/verb/wield_rifle()
	set name = "Wield rifle"
	set category = "Object"
	set src in usr
