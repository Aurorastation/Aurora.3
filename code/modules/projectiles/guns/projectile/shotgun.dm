...
/obj/item/gun/projectile/shotgun/doublebarrel/nitro
	...
	icon = 'icons/obj/guns/galatea-nitro.dmi'
...
/obj/item/gun/projectile/shotgun/doublebarrel/nitro/AltClick(mob/user)
	if(Adjacent(user))
		to_chat(user, SPAN_NOTICE("\The [src] produces a dissonant humming sound."))
