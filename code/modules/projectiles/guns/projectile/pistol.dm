...
/obj/item/gun/projectile/pistol/super_heavy/Initialize()
	. = ..()
	desc_mechanics = "This is an extremely powerful ballistic weapon, using .599 Kumar Super ammunition. If you aren't an Unathi or a G2 IPC, firing without wielding (clicking in-hand) could lead to serious injury or death; Unathi and G2s may fire it unwielded \
