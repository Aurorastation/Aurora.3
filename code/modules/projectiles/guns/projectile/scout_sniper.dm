/obj/item/weapon/gun/projectile/automatic/rifle/w556
	name = "scout rifle"
	desc = "A lightweight Neyland 556mi 'Ranger' used within the Sol Navy and Nanotarsen Emergency Response Teams. Equipped with a scope and designed for medium to long range combat, with moderate stopping power. Chambered in 5.56 rounds."
