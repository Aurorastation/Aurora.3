...
/obj/item/gun/projectile/shotgun/improvised //similar to the double barrel, but without the option to fire both barrels
	...
	icon = 'icons/obj/guns/manufacturer/improvised/ishotgun.dmi'
	icon_state = "ishotgun"
	item_state = "ishotgun"
	max_shells = 2
...
/obj/item/gun/projectile/improvised_handgun
	...
	icon = 'icons/obj/guns/manufacturer/improvised/ipistol.dmi'
	icon_state = "ipistol"
	item_state = "ipistol"
	caliber = ".45"
...
/obj/item/gun/projectile/automatic/improvised
	...
	icon = 'icons/obj/guns/manufacturer/improvised/ismg.dmi'
	icon_state = "ismg"
	item_state = "ismg"
	load_method = MAGAZINE
