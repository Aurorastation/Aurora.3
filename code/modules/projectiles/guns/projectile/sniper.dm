...
/obj/item/gun/projectile/heavysniper/can_wield()
	return 1
...
/obj/item/gun/projectile/heavysniper/verb/wield_rifle()
...
/obj/item/gun/projectile/dragunov/can_wield()
	return 1

/obj/item/gun/projectile/dragunov/ui_action_click()
	if(src in usr)
		toggle_wield(usr)

/obj/item/gun/projectile/dragunov/verb/wield_rifle()
	set name = "Wield rifle"
	set category = "Object"
	set src in usr
