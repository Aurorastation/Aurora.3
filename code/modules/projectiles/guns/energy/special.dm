...
/obj/item/gun/energy/vaurca/blaster
	...
	The result is an incendiary blaster capable of tearing through any would-be interloper, though the phoron-powered battery is held back by an unremarkable capacity. \
