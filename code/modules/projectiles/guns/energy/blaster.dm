...
/obj/item/weapon/gun/energy/blaster/rifle
	name = "bolt slinger"
	desc = "A long blaster rifle which seems to work by accelerating particles to an absurd speed and flinging them out in destructive bolts. It has a tiny scope with a laser sight attached. It’s covered in the colors of the Tau Ceti Foreign Legion."
