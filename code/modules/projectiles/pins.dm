...
/obj/item/device/firing_pin/away_site
	...
	desc = "This access locked firing pin allows weapons to be fired only when the user is not on-facility."
	fail_message = "<span class='warning'>USER ON VESSEL LEVEL.</span>"
