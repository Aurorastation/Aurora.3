...
/obj/structure/machinery/atmospherics/portables_connector/supply
	icon_state = "map_connector-supply"
	icon_connect_type = "-supply"
	connect_types = CONNECT_TYPE_SUPPLY

/obj/structure/machinery/atmospherics/portables_connector/scrubber
...
/obj/structure/machinery/atmospherics/portables_connector/LateInitialize()
	. = ..()
	toggle_process()
...
/obj/structure/machinery/atmospherics/portables_connector/Destroy()
	loc = null
...
/obj/structure/machinery/atmospherics/portables_connector/atmos_init()
	if(node) return
...
/obj/structure/machinery/atmospherics/portables_connector/attackby(obj/item/attacking_item, mob/user)
	if (attacking_item.tool_behaviour != TOOL_WRENCH)
		return ..()
	if (connected_device)
		to_chat(user, SPAN_WARNING("You cannot unwrench \the [src], dettach \the [connected_device] first."))
		return TRUE
	if (locate(/obj/structure/machinery/portable_atmospherics, src.loc))
		return TRUE
