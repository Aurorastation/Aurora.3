...
/obj/effect/overmap/visitable/sector/exoplanet/adhomai/pre_ruin_preparation()
	...
	switch(landing_faction)
		...
		if("dpra")
			...
			/datum/map_template/ruin/exoplanet/adhomai_amohdan, /datum/map_template/ruin/exoplanet/ala_cell, /datum/map_template/ruin/exoplanet/adhomai_chemical_testing, /datum/map_template/ruin/exoplanet/adhomai_president_hadii_statue_toppled)
