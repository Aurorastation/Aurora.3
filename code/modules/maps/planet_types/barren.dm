...
/datum/random_map/noise/exoplanet/barren/asteroid
	...
	fauna_prob = 1
	fauna_types = list(/mob/living/simple_animal/carp/asteroid, /mob/living/simple_animal/hostile/retaliate/cavern_dweller, /mob/living/simple_animal/hostile/carp/bloater,
