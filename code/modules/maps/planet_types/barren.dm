...
/datum/random_map/noise/exoplanet/barren/asteroid
	...
	fauna_prob = 1
	fauna_types = list(/mob/living/simple_animal/carp, /mob/living/simple_animal/hostile/retaliate/cavern_dweller, /mob/living/simple_animal/hostile/carp/bloater,
						/mob/living/simple_animal/hostile/carp/shark, /mob/living/simple_animal/hostile/gnat)
