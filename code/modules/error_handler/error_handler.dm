...
/world/Error(exception/E, datum/e_src)
	...
	var/configured_error_cooldown = 600 //CHANGED FROM TG, THAT DO NOT SET THE VARS HERE, SEE BELOW
	var/configured_error_limit = 50 //CHANGED FROM TG, THAT DO NOT SET THE VARS HERE, SEE BELOW
	var/configured_error_silence_time = 6000 //CHANGED FROM TG, THAT DO NOT SET THE VARS HERE, SEE BELOW
	//THIS WILL MATTER WHEN WE PORT THE NEW CONFIG SYSTEM
	// if(config?.entries)
...
// We might want to use this one day, but until it is that day, in `code\unit_tests\ss_test.dm` there is a shadowing of the /Error proc
// #ifdef UNIT_TESTS
