...
/obj/machinery/shieldgen/attack_hand(mob/user as mob)
	...
	if (src.active)
		user.visible_message("<span class='notice'>[icon2html(src, usr)] [user] deactivated the shield generator.</span>", \
			"<span class='notice'>[icon2html(src, usr)] You deactivate the shield generator.</span>", \
			"You hear heavy droning fade out.")
		src.shields_down()
	else
		if(anchored)
			user.visible_message("<span class='notice'>[icon2html(src, usr)] [user] activated the shield generator.</span>", \
				"<span class='notice'>[icon2html(src, usr)] You activate the shield generator.</span>", \
