...
/datum/computer_file/program/camera_monitor
	...
	extended_desc = "This program allows remote access to vessel's camera system. Some camera networks may have additional access requirements."
	size = 12
...
/datum/computer_file/program/camera_monitor/ert
	...
	extended_desc = "This program allows remote access to vessel's camera system. Some camera networks may have additional access requirements. This version has an integrated database with additional encrypted keys."
	size = 14
