...
/datum/computer_file/program/power_monitor
	...
	extended_desc = "This program connects to sensors around the facility to provide information about electrical systems"
...
/datum/computer_file/program/alarm_monitor
	...
	extended_desc = "This program provides visual interface for a facilities alarm system."
	requires_ntnet = TRUE
...
/datum/computer_file/program/atmos_control
	...
	program_key_icon_state = "cyan_key"
	extended_desc = "This program allows remote control of air alarms around the facility. This program can not be run on tablet computers."
...
/datum/computer_file/program/rcon_console
	...
	program_icon_state = "power_monitor"
	program_key_icon_state = "yellow_key"
	extended_desc = "This program allows remote control of power distribution systems around the facility. This program can not be run on tablet computers."
	required_access_run = access_engine
	required_access_download = access_ce
	requires_ntnet = TRUE
