...
/singleton/recipe/imperialpot
	...
	reagent_mix = RECIPE_REAGENT_REPLACE
	result = /obj/item/reagent_containers/food/snacks/imperialpot
...
/singleton/recipe/imperialscallops
	appliance = SAUCEPAN | POT
	...
	result = /obj/item/reagent_containers/food/snacks/imperialscallops
...
/singleton/recipe/clamscasino
	...
	result = /obj/item/reagent_containers/food/snacks/clamscasino
	reagent_mix = RECIPE_REAGENT_REPLACE //Simplify and replace

/singleton/recipe/ladylulaine
	appliance = MIX
	...
	result = /obj/item/reagent_containers/food/snacks/sliceable/ladylulaine
	reagent_mix = RECIPE_REAGENT_REPLACE //Simplify and replace
