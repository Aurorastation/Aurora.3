...
/datum/citizenship/proc/get_objectives(mission_level, var/mob/living/carbon/human/H)
	...
	switch(mission_level)
		if(REPRESENTATIVE_MISSION_HIGH)
			rep_objectives = pick("Collect evidence of the Stellar Corporate Conglomerate being unfair or oppressive against employees from [name], to be used as leverage in future diplomatic talks",
