...
/singleton/origin_item/origin/core_worlds
	...
	possible_accents = list(ACCENT_DOMINIA_VULGAR, ACCENT_ZHURONG)
	possible_citizenships = CITIZENSHIPS_DOMINIA
	possible_religions = list(RELIGION_MOROZ)
...
/singleton/origin_item/origin/dominian_exile
	...
	possible_accents = list(ACCENT_DOMINIA_VULGAR, ACCENT_DOMINIA_NOVIJADRAN, ACCENT_DOMINIA_FRONTIER, ACCENT_DOMINIA_LYODII, ACCENT_DOMINIA_SUNREACH, ACCENT_ZHURONG)
