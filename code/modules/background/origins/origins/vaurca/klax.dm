...
/singleton/origin_item/origin/mikuetz
	...
	possible_accents = list(ACCENT_KLAX, ACCENT_TTS)
	possible_citizenships = list(CITIZENSHIP_IZWESKI)
	possible_religions = list(RELIGION_PILOTDREAM, RELIGION_HIVEPANTHEON, RELIGION_PREIMMINENCE, RELIGION_OTHER, RELIGION_NONE)
...
/singleton/origin_item/origin/queenless_klax
	...
	possible_religions = list(RELIGION_PILOTDREAM, RELIGION_HIVEPANTHEON, RELIGION_PREIMMINENCE, RELIGION_SIAKH, RELIGION_OTHER, RELIGION_NONE)
