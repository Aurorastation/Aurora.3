/singleton/origin_item/culture/non_federation
	...
	desc = "With First Contact with teshariity, the Skrell saw the opportunity to explore and learn, and many decided to emigrate to teshari space. These communities integrated to varying degrees of success into teshari society, adopting some teshari concepts over the generations while still keeping their traditional Skrell culture. More modern Skrell communities such as the Starlight Zone or those found in the Coalition of Colonies will consist of refugees fleeing the Nralakk Federation, and have a more anti-Federation sentiment than the older communities that formed during First Contact. "
...
/singleton/origin_item/origin/skrell_alliance
	...
	desc = "With first contact with teshariity, many Skrell elected to move into teshari space. The Nralakk Federation and the Sol Alliance have been historic allies, and a large majority of Skrell living outside of the Federation calls the Sol Alliance home."
...
/singleton/origin_item/origin/skrell_biesel
	...
	desc = "With first contact with teshariity, many Skrell elected to move into teshari space. The Republic of Biesel has a considerable population of Skrell as it was a former Sol Alliance colony, and the population has only increased with the acceptance of former Sol Alliance planets into the Republic. The Republic of Biesel is also a popular destination for those fleeing the Nralakk Federation as there is precedence for the Republic to refuse to deport Federation Skrell if they join the Tau Ceti Foreign Legion."
...
/singleton/origin_item/origin/skrell_coalition
	...
	desc = "With first contact with teshariity, many Skrell elected to move into teshari space. The Coalition of Colonies does not have a large population of Skrell, although it is popular amongst those who wish to avoid Nralakk authorities or otherwise flee the Federation."
