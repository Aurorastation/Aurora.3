...
/singleton/origin_item/origin/nralakk_core
	name = "Inner Systems"
	desc = "The Inner Systems are locations within the inner sphere of the Nralakk Federation. The Inner Systems consist of Nralakk, the birthplace of the Skrell, as well as the first colonies founded by the species in the 1st and 2nd wave. High quality of life and pro-Nralakk Federation views are common for those who live here."
