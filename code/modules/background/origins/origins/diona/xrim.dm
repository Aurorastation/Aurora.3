...
/singleton/origin_item/origin/scorned
	...
	or the Orion Spur, due to low Social Compatability Index - a request by the Arch-Consul that those not in compliance with the Triumvirate's decrees be sanctioned for their conduct."
