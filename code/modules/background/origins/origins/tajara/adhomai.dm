/singleton/origin_item/culture/adhomian
	...
	important_information = "Tajara with Republic of Biesel citizenship would have immigrated later in life and would have had to serve in the TCFL to gain Biesel citizenship. Tajara with Republic of Biesel citizenship must still hold citizenship of one of the Adhomian nations as well. Failure to abide by this is a whitelist issue."
