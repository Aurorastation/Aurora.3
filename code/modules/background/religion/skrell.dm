...
/datum/religion/skrell/kirgul
	...
	entity, whether that be artificial or biological. This belief system enforces the Ya'Qu, or 'the right to live', a saying that is similar to the teshari 'live in the moment'. As \
