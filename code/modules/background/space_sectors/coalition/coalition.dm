...
//	cargo_price_coef = TBD
	...
	lore_radio_stations = list(
		"73.2 Navy Broadcasting Service" = "code/modules/background/space_sectors/coalition/radio/73.2_Navy_Broadcasting_Service.txt",
		"122 Great Blue Dot" = "code/modules/background/space_sectors/coalition/radio/122_Great_Blue_Dot.txt",
		"75.4 PBA" = "code/modules/background/space_sectors/coalition/radio/75.4_PBA.txt",
		"77.7 SoulFM" = "code/modules/background/space_sectors/coalition/radio/77.7_SoulFM.txt",
		"78.1 RealFM" = "code/modules/background/space_sectors/coalition/radio/78.1_RealFM.txt"
	)
