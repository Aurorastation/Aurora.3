...
/datum/accent/dominia_unathi
	...
	elegant tones of High Morozi's novaparla and lighter pitch sounds of Vulgar Morozi's Sol Common, resulting an accent sounding deep and droning but otherwise surprisingly dignified."
