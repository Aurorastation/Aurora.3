...
/obj/structure/ore_box
	...
	desc_mechanics = "You can attach a warp extraction beacon signaller to this, then click on it with an ore satchel that has a warp extraction pack attached, to link them."
