/mob/living/silicon/robot/drone/mining
	...
	idcard_type = /obj/item/card/id/synthetic/minedrone
	speed = -1
	range_limit = 0
	var/health_upgrade
	var/ranged_upgrade
...
/obj/item/device/mine_bot_ugprade/proc/upgrade_bot(var/mob/living/silicon/robot/drone/mining/M, mob/user)
	...
	M.module = null
	if(M.ranged_upgrade)
		new /obj/item/robot_module/mining_drone/drillandplasmacutter(M)
	else
...
/obj/item/device/mine_bot_ugprade/plasma/upgrade_bot(var/mob/living/silicon/robot/drone/mining/M, mob/user)
	...
	if(M.melee_upgrade)
		...
		new /obj/item/robot_module/mining_drone/plasmacutter(M)
	M.ranged_upgrade = 1
	M.module.rebuild()
	M.recalculate_synth_capacities()
	if(!M.jetpack)
