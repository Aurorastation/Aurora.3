...
/obj/machinery/mineral/processing_unit_console/interact(mob/user)
	...
	dat += "The ore processor is currently <A href='?src=\ref[src];toggle_power=1'>[(machine.active ? "<span class='good'>processing</span>" : "<span class='warning'>disabled</span>")]</a>."
