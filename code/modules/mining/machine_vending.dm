...
var/global/list/minevendor_list = list( //keep in order of price
	...
	new /datum/data/mining_equipment("Autoinjector",				/obj/item/weapon/reagent_containers/hypospray/autoinjector,	25,					50),
	...
	new /datum/data/mining_equipment("Brute First-Aid Kit",			/obj/item/weapon/storage/firstaid/brute,					30,					300),
	...
	new /datum/data/mining_equipment("Explorer's Webbing",			/obj/item/clothing/accessory/storage/brown_vest/explorer,	6,					400),
	new /datum/data/mining_equipment("Explorer's Helmet",			/obj/item/clothing/head/helmet/space/explorer,				6,					400),
	new /datum/data/mining_equipment("Explorer's Suit",				/obj/item/clothing/suit/space/explorer,						6,					500),
