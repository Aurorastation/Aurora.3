...
GLOBAL_LIST_INIT(minevendor_list, list(
	...
	*/
	new /datum/data/mining_equipment(/obj/item/reagent_containers/food/snacks/liquidfood,		5,					5),
	new /datum/data/mining_equipment(/obj/item/contraband/poster,								5,					20),
	new /datum/data/mining_equipment(/obj/item/ore_radar,										5,					50),
	new /datum/data/mining_equipment(/obj/item/stack/flag/red,									5,					50),
	new /datum/data/mining_equipment(/obj/item/stack/flag/green,								5,					50),
	new /datum/data/mining_equipment(/obj/item/stack/flag/yellow,								5,					50),
	new /datum/data/mining_equipment(/obj/item/stack/flag/purple,								5,					50),
	new /datum/data/mining_equipment(/obj/item/storage/bag/ore,									10,					50),
	new /datum/data/mining_equipment(pick(subtypesof(/obj/item/pizzabox)), 									10,					50),
	new /datum/data/mining_equipment(/obj/item/device/flashlight/lantern,						5,					75),
	new /datum/data/mining_equipment(/obj/item/shovel,											8,					100),
	new /datum/data/mining_equipment(/obj/item/pickaxe,											5,					100),
	new /datum/data/mining_equipment(/obj/item/rfd_ammo,										25,					100),
	new /datum/data/mining_equipment(/obj/item/gun/custom_ka/frame01/prebuilt,					6,					200),
	...
	new /datum/data/mining_equipment(/obj/item/clothing/mask/smokable/cigarette/cigar/havana, 	15,					150),
	new /datum/data/mining_equipment(/obj/item/plastique/seismic,								12,					150),
	new /datum/data/mining_equipment(/obj/item/ladder_mobile,									3,					200),
	new /datum/data/mining_equipment(/obj/item/hoist_kit,										3,					200),
	new /datum/data/mining_equipment(/obj/item/pickaxe/drill,									5,					200),
	new /datum/data/mining_equipment(/obj/item/mining_scanner,									5,					250),
	new /datum/data/mining_equipment(/obj/item/clothing/shoes/magboots,							5,					300),
	new /datum/data/mining_equipment(/obj/item/gun/custom_ka/frame02/prebuilt,					6,					400),
	new /datum/data/mining_equipment(/obj/item/autochisel,										5,					400),
	new /datum/data/mining_equipment(/obj/item/tank/jetpack,									5,					400),
	new /datum/data/mining_equipment(/obj/item/device/mine_bot_upgrade,							5,					400),
	...
	new /datum/data/mining_equipment(/obj/item/storage/belt/mining,								5,					500),
	new /datum/data/mining_equipment(/obj/item/warp_core,										12,					500),
	new /datum/data/mining_equipment(/obj/item/extraction_pack,									12,					600),
	new /datum/data/mining_equipment(/obj/item/device/mine_bot_upgrade/health,					10,					600),
	new /datum/data/mining_equipment(/obj/item/storage/firstaid/trauma,							15,					600),
	new /datum/data/mining_equipment(/obj/item/oremagnet,										5,					600),
	new /datum/data/mining_equipment(/obj/item/resonator,										5,					700),
	new /datum/data/mining_equipment(/obj/item/device/wormhole_jaunter,							10,					750),
	new /datum/data/mining_equipment(/obj/item/rig/industrial,									3,					1000),
	new /datum/data/mining_equipment(/obj/item/mass_driver_diy,									3,					800),
	new /datum/data/mining_equipment(/mob/living/silicon/robot/drone/mining,					8,					800),
	new /datum/data/mining_equipment(/obj/item/device/mine_bot_upgrade/ka,						5,					800),
	new /datum/data/mining_equipment(/obj/item/oreportal,										15,					800),
	new /datum/data/mining_equipment(/obj/item/device/spaceflare,								3,					800),
	new /datum/data/mining_equipment(/obj/item/lazarus_injector,								12,					1000),
	new /datum/data/mining_equipment(/obj/item/storage/backpack/cell,							3,					1000),
	new /datum/data/mining_equipment(/obj/machinery/mining/drill,								-1,					1000,	1),
	new /datum/data/mining_equipment(/obj/item/resonator/upgraded,								5,					1250),
	new /datum/data/mining_equipment(/obj/item/pickaxe/diamond,									5,					1500),
	new /datum/data/mining_equipment(/obj/item/gun/energy/vaurca/thermaldrill,					3,					1750),
	new /datum/data/mining_equipment(/obj/item/device/orbital_dropper/minecart,					3,					2000),
	new /datum/data/mining_equipment(/obj/item/device/orbital_dropper/drill,					5,					3250),
	new /datum/data/mining_equipment(/obj/item/device/orbital_dropper/mecha/miner,				1,					3500)
	))
