...
var/global/list/minevendor_list = list( //keep in order of price
	...
	new /datum/data/mining_equipment("Compressed rail cartridge",	/obj/item/rrf_ammo,	50,													100),
	...
	new /datum/data/mining_equipment("Rapid-Railway-Fabricator",	/obj/item/rrf,	10,												600),
	...
	new /datum/data/mining_equipment("Mining RIG",					/obj/item/rig/industrial,	5,										750),
	...
	new /datum/data/mining_equipment("100 credits",					/obj/item/spacecash/c100,	-1,									1000),
