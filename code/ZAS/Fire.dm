...
/mob/living/carbon/human/FireBurn(var/firelevel, var/last_temperature, var/pressure)
	...
	apply_damage(2.5*mx*head_exposure, BURN, TARGET_HEAD, 0, 0, "Fire")
	apply_damage(2.5*mx*chest_exposure, BURN, TARGET_CHEST, 0, 0, "Fire")
	apply_damage(2.0*mx*groin_exposure, BURN, TARGET_GROIN, 0, 0, "Fire")
	apply_damage(0.6*mx*legs_exposure, BURN, TARGET_L_LEG, 0, 0, "Fire")
	apply_damage(0.6*mx*legs_exposure, BURN, TARGET_R_LEG, 0, 0, "Fire")
	apply_damage(0.4*mx*arms_exposure, BURN, TARGET_L_ARM, 0, 0, "Fire")
	apply_damage(0.4*mx*arms_exposure, BURN, TARGET_R_ARM, 0, 0, "Fire")
