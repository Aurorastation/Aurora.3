...
/obj/fire/process()
	...
	for(var/mob/living/L in loc)
		...
		L.fire_act() // AND GIVE THEM MORE BURNING.
...
/mob/living/carbon/human/FireBurn(var/firelevel, var/last_temperature, var/pressure)
	...
	var/mx = 5 * firelevel/vsc.fire_firelevel_multiplier * min(pressure / ONE_ATMOSPHERE, 1) * src.fire_stacks/10
	...
	apply_damage(.6*mx*legs_exposure, BURN, "l_leg", 0, 0, "Fire")
	apply_damage(.6*mx*legs_exposure, BURN, "r_leg", 0, 0, "Fire")
	apply_damage(.4*mx*arms_exposure, BURN, "l_arm", 0, 0, "Fire")
	apply_damage(.4*mx*arms_exposure, BURN, "r_arm", 0, 0, "Fire")
