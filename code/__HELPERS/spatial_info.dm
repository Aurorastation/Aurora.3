...
/proc/get_open_turf_in_dir(atom/center, dir)
	...
	if(istype(get_turf) && !get_turf.density) //This differs from how TG does it, they have a dedicated turf type for open turf. Thanks Aurora, always be special.
		return get_turf
...
/proc/alone_in_area(area/the_area, mob/must_be_alone, check_type = /mob/living/carbon)
	...
	for(var/carbon in GLOB.mob_list)
