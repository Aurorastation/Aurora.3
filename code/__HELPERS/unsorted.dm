 ...
 *
 */
/proc/do_after(mob/user, delay, atom/target, do_flags = DO_DEFAULT, incapacitation_flags = INCAPACITATION_DEFAULT, datum/callback/extra_checks, looping_sound_type, atom/looping_sound_source)
	return !do_after_detailed(user, delay, target, do_flags, incapacitation_flags, extra_checks, looping_sound_type, looping_sound_source)
 ...
 */
/proc/do_after_detailed(mob/user, delay, atom/target, do_flags = DO_DEFAULT, incapacitation_flags = INCAPACITATION_DEFAULT, datum/callback/extra_checks, looping_sound_type, atom/looping_sound_source)
	if(!delay)
		return FALSE
