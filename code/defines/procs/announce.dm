...
/proc/AnnounceArrivalSimple(var/name, var/rank = "visitor", var/join_message = "has arrived on the [SSmapping.current_map.station_type]", var/new_sound = 'sound/misc/announcements/notice.ogg')
