...
/datum/announcement/priority/New(var/do_log = 1, var/new_sound = 'sound/misc/announcements/security_level.ogg', var/do_newscast = 0, var/do_print = 0)
	..(do_log, new_sound, do_newscast, do_print)
	title = "Priority Announcement"
	announcement_type = "Priority Announcement"

/datum/announcement/priority/command/New(var/do_log = 1, var/new_sound = 'sound/misc/announcements/security_level.ogg', var/do_newscast = 0, var/do_print = 0)
	..(do_log, new_sound, do_newscast, do_print)
	title = "[current_map.boss_name] Update"
	announcement_type = "[current_map.boss_name] Update"

/datum/announcement/priority/security/New(var/do_log = 1, var/new_sound = 'sound/misc/announcements/security_level.ogg', var/do_newscast = 0, var/do_print = 0)
	..(do_log, new_sound, do_newscast, do_print)
