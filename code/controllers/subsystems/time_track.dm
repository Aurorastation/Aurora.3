var/datum/controller/subsystem/time_track/SStimetrack
...
/datum/controller/subsystem/time_track/New()
	NEW_SS_GLOBAL(SStimetrack)

/datum/controller/subsystem/time_track/Initialize()
	return SS_INITSTATE_DONE
...
/datum/controller/subsystem/time_track/fire()
	...
	if (!first_run)
		...
		glide_size_multiplier = (current_byondtime - last_tick_byond_time) / (current_realtime - last_tick_realtime)
	else
		first_run = FALSE
