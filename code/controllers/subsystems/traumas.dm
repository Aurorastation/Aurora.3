...
/datum/controller/subsystem/traumas/Initialize()
	...
	phobia_objs = list("spiders"   = typecacheof(list(/obj/effect/spider,/obj/item/toy/plushie/spider, /obj/effect/decal/cleanable/spiderling_remains)),
					   ...
					   "security"  = typecacheof(list(/obj/item/clothing/under/rank/security, /obj/item/clothing/under/rank/warden, /obj/item/clothing/head/beret/security,
												 ...
												 /obj/item/clothing/head/softcap/security, /obj/item/clothing/suit/storage/security, /obj/item/clothing/suit/bio_suit/security,
												 /obj/item/clothing/suit/bomb_suit/security, /obj/item/clothing/suit/storage/security/officer, /obj/item/clothing/suit/space/void/security,
					   ...
					   "nanotrasen" = typecacheof(list(/obj/item/toy/balloon/nanotrasen, /obj/item/soap/nanotrasen, /obj/structure/sign/flag/nanotrasen,
												 ...
												 /obj/item/gun/energy/captain, /obj/item/stamp/captain, /obj/item/storage/backpack/captain, /obj/item/clothing/suit/storage/security)),
