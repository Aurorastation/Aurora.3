var/datum/subsystem/scheduler/scheduler

/************
* Scheduler *
************/

/datum/subsystem/scheduler
	name = "Scheduler"
	wait = 2 SECONDS
	flags = SS_NO_INIT
...
/datum/subsystem/scheduler/proc/schedule(var/datum/scheduled_task/st)
	scheduled_tasks += st
	destroyed_event.register(st, src, /datum/subsystem/scheduler/proc/unschedule)

/datum/subsystem/scheduler/proc/unschedule(var/datum/scheduled_task/st)
