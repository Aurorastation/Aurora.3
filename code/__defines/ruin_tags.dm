...
#define PLANET_OCEAN		BITFLAG(9)

#define ALL_PLANET_TYPES	PLANET_BARREN|PLANET_ASTEROID|PLANET_DESERT|PLANET_GROVE|PLANET_GRASS|PLANET_LAVA|PLANET_SNOW|PLANET_MARSH|PLANET_CRYSTAL|PLANET_OCEAN
