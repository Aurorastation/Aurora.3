...
#define PSI_FLAG_FOUNDATIONAL	4	/// An ability automatically given to Psionically Sensitive users.
#define PSI_FLAG_APEX			8	/// An ability automatically given to Psionic Apex users.
