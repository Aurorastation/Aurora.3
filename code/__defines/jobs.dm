...
// Singular Roles
#define OFF_DUTY_CREW_ROLE /datum/job/visitor
...
#define SCC_ROLES list(COMMAND_ROLES, COMMAND_SUPPORT_ROLES, EQUIPMENT_ROLES, OFF_DUTY_CREW_ROLE)
...
#define INDEP_ROLES list(NON_CREW_CIVILIAN_ROLES, CONSULAR_ROLE, JOURNALIST_ROLE, CHAPLAIN_ROLE, OFF_DUTY_CREW_ROLE)