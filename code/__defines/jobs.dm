...
#define COMMAND_SUPPORT_ROLES list(\
	/datum/job/hra,\
	/datum/job/representative,\
	/datum/job/bridge_crew
) // Consular intentionally not included as they are independent.
...
#define EQUIPMENT_ROLES list(\
	/datum/job/ai,\
	/datum/job/cyborg
)

// Role Groups Miscellaneous
#define ALL_FACTION_ROLES list(\
	/datum/job/assistant,\
	/datum/job/visitor,\
	/datum/job/representative
)

#define ALL_JOBS list(\
	COMMAND_ROLES,\
	COMMAND_SUPPORT_ROLES,\
	ENGINEERING_ROLES,\
	SERVICE_ROLES,\
	CIVILIAN_ROLES,\
	OPERATIONS_ROLES,\
...
#define IDRIS_ROLES list(\
	SECURITY_ROLES,\
	SERVICE_ROLES,\
	ALL_FACTION_ROLES
)

#define ZAVOD_ROLES list(\
	SECURITY_ROLES,\
	SCIENCE_ROLES,\
	ENGINEERING_ROLES,\
	ALL_FACTION_ROLES
...
#define PMC_ROLES list(\
	SECURITY_ROLES,\
	MEDICAL_ROLES,\
	ALL_FACTION_ROLES
)

#define NT_ROLES list(\
	SCIENCE_ROLES,\
	MEDICAL_ROLES,\
	SERVICE_ROLES,\
	ALL_FACTION_ROLES
...
#define ZENG_ROLES list(\
	SCIENCE_ROLES,\
	MEDICAL_ROLES,\
	ALL_FACTION_ROLES
)

#define HEPH_ROLES list(\
	OPERATIONS_ROLES,\
	ENGINEERING_ROLES,\
	ALL_FACTION_ROLES
)

#define ORION_ROLES list(\
	OPERATIONS_ROLES,\
	ALL_FACTION_ROLES
)

#define SCC_ROLES list(\
	COMMAND_ROLES,\
	COMMAND_SUPPORT_ROLES,\
	EQUIPMENT_ROLES,\
	ALL_FACTION_ROLES
