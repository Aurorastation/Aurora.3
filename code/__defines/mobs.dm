...
#define APPEARANCE_PLASTICSURGERY (APPEARANCE_HAIR|APPEARANCE_HAIR_COLOR|APPEARANCE_FACIAL_HAIR|APPEARANCE_FACIAL_HAIR_COLOR|APPEARANCE_GENDER|APPEARANCE_SKIN|APPEARANCE_EYE_COLOR) & ~APPEARANCE_RACE
