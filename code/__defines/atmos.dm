...
#define HYDROGEN_MINIMUM_BURN_TEMPERATURE    (T0C +  250) //323 K - autoignite temperature in tanks and canisters - enclosed environments I guess
#define HYDROGEN_FLASHPOINT                  (T0C +  500) //773 K - autoignite temperature in air if that ever gets implemented.
...
#define ATMOSTANK_HYDROGEN      25000 // H2 is not critically important for the station, only for an alternative coolant and maybe toxins.
