...
#define FIRE_MAX_STACKS           105
#define FIRE_MAX_FIRESUIT_STACKS  100 // If the number of stacks goes above this firesuits won't protect you anymore. If not, you can walk around while on fire like a badass.
