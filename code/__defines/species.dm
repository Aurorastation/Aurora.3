...
#define SPECIES_PASSIVE_TEMP_GAIN			"passive_temp_gain"
...
#define SPECIES_SPRINT_TEMPERATURE_FACTOR	"sprint_temperature_factor"
#define SPECIES_EXHAUST_THRESHOLD			"exhaust_threshold"
#define SPECIES_MOVE_CHARGE_FACTOR			"move_charge_factor"
