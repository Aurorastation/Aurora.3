...
#define SPECIES_teshari_OFFWORLD		"Off-Worlder teshari"
...
#define ALL_SPECIES list(SPECIES_teshari, SPECIES_teshari_OFFWORLD, SPECIES_IPC, SPECIES_IPC_BISHOP, SPECIES_IPC_G1, \
