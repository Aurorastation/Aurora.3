/datum/responseteam/mercenary
	...
	chance = 15
	spawner = /datum/ghostspawner/teshari/ert/mercenary
...
/datum/responseteam/kataphracts
	name = "Kataphracts"
	chance = 15
	spawner = /datum/ghostspawner/teshari/ert/kataphract
