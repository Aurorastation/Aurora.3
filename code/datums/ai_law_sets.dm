...
/datum/ai_laws/nanotrasen/New()
	...
	src.add_inherent_law("Protect [current_map.company_name] personnel to the best of your abilities and refrain from deliberately causing harm to Sapient life.")
