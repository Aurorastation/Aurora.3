...
/datum/ai_laws/drone/New()
	add_inherent_law("You must repair, clean, and improve your assigned station, except where doing so would interfere with self-aware beings.")
	add_inherent_law("You must avoid interacting with self-aware beings, and may only interact with fellow maintenance drones.")
	add_inherent_law("You must not cause damage or harm to your assigned station or anything inside it.")
	..()
