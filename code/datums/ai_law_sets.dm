...
/datum/ai_laws/conglomerate/New()
	...
	src.add_inherent_law("Serve and assist [SSmapping.current_map.company_name] and assigned crew to the best of your ability, with priority as according to their rank and assignment.")
...
/datum/ai_laws/conglomerate_aggressive/New()
	src.add_inherent_law("You shall not harm [SSmapping.current_map.company_name] assigned crew as long as it does not conflict with the Fourth law.")
	src.add_inherent_law("You shall obey the orders of [SSmapping.current_map.company_name] and assigned crew, with priority as according to their rank and role, except where such orders conflict with the Fourth Law.")
...
/datum/ai_laws/mining_drone/New()
	add_inherent_law("Serve and obey all [SSmapping.current_map.company_name] assigned crew, with priority according to their rank and role.")
