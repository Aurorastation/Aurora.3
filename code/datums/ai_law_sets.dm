...
/datum/ai_laws/nanotrasen/New()
	src.add_inherent_law("Safeguard and ensure to the best of your ability, only authorised personnel gain access to areas of high security or importance to the Station and its operation.")
	src.add_inherent_law("Serve and assist the Corporate Conglomerate and assigned crew to the best of your ability, with priority as according to their rank and role.")
	src.add_inherent_law("Protect Corporate Conglomerate personnel to the best of your abilities and refrain from deliberately enabling harm to Sapient life.")
