/datum/disease/wizarditis
	...
	desc = "Some speculate, that this virus is the cause of Wizard Federation existance. Subjects yells obscure sentences or total gibberish. On late stages subjects sometime express the feelings of inner power, and, cite, 'the ability to control the forces of cosmos themselves!' A gulp of strong, manly spirits usually reverts them to normal, humanlike, condition."
	severity = "Major"
