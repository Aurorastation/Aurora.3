//organic/severe traumas, when your brain gets abused way too much.
...
/datum/brain_trauma/organic/severe/mute
	name = "Mutism"
...
/datum/brain_trauma/organic/severe/mute/on_gain()
	..()
	owner.sdisabilities |= MUTE


//no fiddling with genetics to get out of this one
/datum/brain_trauma/organic/severe/mute/triggered_life()
	..()
	if(!(owner.sdisabilities & MUTE))
		on_gain()


/datum/brain_trauma/organic/severe/mute/on_lose()
	..()
	owner.sdisabilities &= ~MUTE


/datum/brain_trauma/organic/severe/blindness
...
/datum/brain_trauma/organic/severe/blindness/on_gain()
	..()
	owner.sdisabilities |= BLIND


//no fiddling with genetics to get out of this one
/datum/brain_trauma/organic/severe/blindness/triggered_life()
	..()
	if(!(owner.sdisabilities & BLIND))
		on_gain()


/datum/brain_trauma/organic/severe/blindness/on_lose()
	..()
	if(owner.sdisabilities & BLIND)
		owner.sdisabilities &= ~BLIND


/datum/brain_trauma/organic/severe/paralysis
	name = "Paralysis"
...
/datum/brain_trauma/organic/severe/paralysis/triggered_life()
	..()
	owner.Weaken(200)


/datum/brain_trauma/organic/severe/paralysis/on_lose()
	..()
	owner.SetWeakened(0)


/datum/brain_trauma/organic/severe/narcolepsy
	name = "Narcolepsy"
...
/datum/brain_trauma/organic/severe/narcolepsy/triggered_life()
	..()
...
/datum/brain_trauma/organic/severe/monophobia
	name = "Monophobia"
...
/datum/brain_trauma/organic/severe/monophobia/on_gain()
	..()
...
/datum/brain_trauma/organic/severe/monophobia/triggered_life()
	..()
...
/datum/brain_trauma/organic/severe/monophobia/proc/stress_reaction()
...
/datum/brain_trauma/organic/severe/discoordination
...
/datum/brain_trauma/organic/severe/discoordination/on_gain()
	..()
	owner.disabilities |= MONKEYLIKE


/datum/brain_trauma/organic/severe/discoordination/on_lose()
	..()
	owner.disabilities &= ~MONKEYLIKE


/datum/brain_trauma/organic/severe/aphasia
	name = "Aphasia"
...
/datum/brain_trauma/organic/severe/aphasia/on_gain()
	..()
...
/datum/brain_trauma/organic/severe/aphasia/on_lose()
	..()
...
/datum/brain_trauma/organic/severe/pacifism
...
/datum/brain_trauma/organic/severe/pacifism/on_gain()
	..()
	owner.disabilities |= PACIFIST


/datum/brain_trauma/organic/severe/pacifism/on_lose()
	..()
	owner.disabilities &= ~PACIFIST


/datum/brain_trauma/organic/severe/total_colorblind
...
/datum/brain_trauma/organic/severe/total_colorblind/on_gain()
	..()
	owner.add_client_color(/datum/client_color/monochrome)


/datum/brain_trauma/organic/severe/total_colorblind/triggered_life()
	..()
	if(owner.client && !owner.client.color)
		on_gain()

/datum/brain_trauma/organic/severe/total_colorblind/on_lose()
	..()
