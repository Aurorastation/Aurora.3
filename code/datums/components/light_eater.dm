/**
 * Makes anything it attaches to capable of removing something's ability to produce light until this component is destroyed.
 *
 * The permanent behavior provider is [/datum/element/light_eater].
 */
