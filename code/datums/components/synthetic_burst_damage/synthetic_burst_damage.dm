/datum/component/synthetic_burst_damage
	...
	/// After this amount of time, the burst damage counter resets to 0 automatically.
	var/burst_damage_cooldown = 0
	...
	var/burst_damage_hit_grace_period = 10 SECONDS
