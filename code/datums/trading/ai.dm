...
/datum/trader/trading_beacon
	...
	possible_trading_items = list(
		...
		/obj/item/storage/bag/cash                    = TRADER_BLACKLIST,
		...
		/obj/item/storage/backpack/satchel/withwallet = TRADER_BLACKLIST,
		/obj/item/storage/backpack/chameleon          = TRADER_BLACKLIST,
		/obj/item/storage/backpack/chameleon          = TRADER_BLACKLIST,
		/obj/item/storage/backpack/typec              = TRADER_BLACKLIST_ALL,
