...
/datum/trader/ship/unique/wizard
	...
	possible_wanted_items = list(
		...
		/obj/item/scrying                         = TRADER_THIS_TYPE,
		/obj/item/melee/energy/wizard             = TRADER_THIS_TYPE,
		/obj/item/phylactery                             = TRADER_THIS_TYPE,
		/obj/item/gun/energy/staff                = TRADER_ALL,
		/obj/item/gun/energy/wand                 = TRADER_ALL,
		/obj/item/gun/energy/wand/toy             = TRADER_BLACKLIST,
		/obj/item/device/soulstone                       = TRADER_THIS_TYPE
	)

	possible_trading_items = list(
		/obj/item/contract/wizard/tk              = TRADER_THIS_TYPE,
		/obj/item/contract/boon/wizard/smoke      = TRADER_THIS_TYPE,
		/obj/item/contract/boon/wizard/horsemask  = TRADER_THIS_TYPE,
		/obj/item/contract/boon/wizard/gestalt    = TRADER_THIS_TYPE,
		/obj/item/contract/boon/wizard/fireball   = TRADER_THIS_TYPE,
		/obj/item/contract/boon/wizard/forcewall  = TRADER_THIS_TYPE,
		/obj/item/contract/boon/wizard/charge     = TRADER_THIS_TYPE,
...
/datum/trader/ship/unique/vaurca
	...
	possible_trading_items = list(
		...
		/obj/item/gun/energy/vaurca/gatlinglaser  = TRADER_THIS_TYPE
	)
