/datum/trader
	...
	var/list/allowed_space_sectors = list(ALL_TAU_CETI_SECTORS, ALL_BADLAND_SECTORS)	//which sector this merchant can show up                                                            //Things they will automatically refuse
