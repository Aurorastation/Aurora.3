...
/datum/trader/ship/robots
	...
	possible_trading_items = list(
		/obj/item/secbot_assembly/ed209_assembly = TRADER_THIS_TYPE,
...
/datum/trader/ship/mining
	...
	possible_wanted_items  = list(
		...
		/obj/item/coin                     = TRADER_SUBTYPES_ONLY
	)
	...
	possible_trading_items = list(
		...
		/obj/item/rrf_ammo                        = TRADER_THIS_TYPE,
		/obj/item/rrf                             = TRADER_THIS_TYPE,
		...
		/obj/item/gun/energy/kinetic_accelerator  = TRADER_THIS_TYPE,
