...
/datum/wires/robot/GetInteractWindow()
	...
	. += "<p>[R.law_update ? "The LawSync light is on." : "The LawSync light is off."]\
	<p>[R.connected_ai ? "The AI link light is on." : "The AI link light is off."]</p>\
	<p>[(!isnull(R.camera) && R.camera.status == 1) ? "The Camera light is on." : "The Camera light is off."]</p>\
	<p>[R.lock_charge ? "The lockdown light is on." : "The lockdown light is off."]"
	return .
