...
/datum/wires/alarm/GetInteractWindow()
	var/obj/machinery/alarm/A = holder
	. += ..()
	. += "<p>[A.locked ? "The Air Alarm is locked." : "The Air Alarm is unlocked."]</p>\
	<p>[(A.shorted || (A.stat & (NOPOWER|BROKEN))) ? "The Air Alarm is offline." : "The Air Alarm is working properly!"]</p>\
