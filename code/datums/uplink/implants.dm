...
/datum/uplink_item/item/implants/auxiliary_heart
	name = "Galateam Auxiliary Heart Implanter"
	bluecrystal_cost = 3
...
/datum/uplink_item/item/implants/mind_blanker
	name = "Galateam Mind Blanker Implanter"
	bluecrystal_cost = 2
...
/datum/uplink_item/item/implants/mind_blanker_lethal
	name = "Galateam Mind Blanker (Lethal) Implanter"
	bluecrystal_cost = 4
...
/datum/uplink_item/item/implants/platelet_factories
	name = "Galateam Platelet Factories Implanter"
	bluecrystal_cost = 3
...
/datum/uplink_item/item/implants/subdermal_carapace
	name = "Galateam Subdermal Carapace Implanter"
	bluecrystal_cost = 5
