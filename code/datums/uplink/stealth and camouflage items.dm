...
/datum/uplink_item/item/stealth_items/chameleonarmor_kit
	...
	desc = "Comes with a plate-carrier and a helmet that are both capable of mimicking other clothing items, offers slightly worse protection than heavy armor."
	telecrystal_cost = 2
	bluecrystal_cost = 2
