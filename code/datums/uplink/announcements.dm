...
/datum/uplink_item/abstract/announcements/fake_ion_storm
	...
	desc = "Interferes with any vessel's ion sensors. Triggers immediately upon investment."
	item_cost = 2
...
/datum/uplink_item/abstract/announcements/fake_radiation
	...
	desc = "Interferes with any vessel's radiation sensors. Triggers immediately upon investment."
	item_cost = 3
