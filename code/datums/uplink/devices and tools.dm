...
/datum/uplink_item/item/tools/space_suit/necropolis
	name = "Revenant Combat Suit"
	item_cost = 14
	path = /obj/structure/closet/crate/secure/gear_loadout/necropolis
	desc = "A full spaceworthy kit of a Necropolis Industries Revenant-type combat suit. Heavily resistant against fast projectiles and backpack-portable."

/datum/uplink_item/item/tools/space_suit/zenghu
	name = "Dragon Biohazard Control Suit"
	item_cost = 12
	path = /obj/structure/closet/crate/secure/gear_loadout/zenghu
	desc = "A full spaceworthy kit of a Zeng-Hu Pharmaceuticals Dragon-type biohazard containment suit. Entirely resistant against radiation in most circumstances."

/datum/uplink_item/item/tools/space_suit/hephaestus
	name = "Caiman Drop Suit"
	item_cost = 16
	path = /obj/structure/closet/crate/secure/gear_loadout/hephaestus
	desc = "A full spaceworthy kit of a Hephaestus Industries Caiman-type terraforming suit. Very resistant against slow-moving blunt force, but heavy."

/datum/uplink_item/item/tools/space_suit/einstein
	name = "Banshee Combat Suit"
	item_cost = 14
	path = /obj/structure/closet/crate/secure/gear_loadout/einstein
	desc = "A full spaceworthy kit of an Einstein Engines Banshee-type infiltration suit. Resistant against lasers, but made of paper against anything else."