...
/*
 * Guns - I'm making these specifically so that I dont spawn a pile of fully loadeds on the map.
 */
...
/obj/item/gun/energy/laser/practice/sc_laser
	name = "Old laser"
	desc = "A once potent, years of dust have collected in the chamber and lens of this, weakening the beam significantly."
	clumsy_check = 0
...
/obj/item/paper/sc_safehint_paper_shuttle
	info = {"<b>Target:</b> Research-station Epsilon<br>
			<b>Objective:</b> Prototypery. The captain likely keeps them locked in her safe.<br>
			<br>
